...
public:
    ...
    void DefineFunction(const char *funcName, napi_callback callback);
    void DefineClass(const char *className, napi_callback constructorFunc, std::map<const char *, std::map<const char *, napi_callback>> &valueList, std::map<const char *, napi_callback> &funcList);
