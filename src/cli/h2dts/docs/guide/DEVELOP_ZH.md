...
1.1 安装typescript：在napi_generator/src/cli/h2dts/src目录下执行命令：

	npm i typescript

1.2 安装stdio：在napi_generator/src/cli/h2dts目录下执行命令：

	npm i stdio

1.3 安装pkg : 在napi_generator/src/cli/h2dts目录下执行命令：
...
执行以上步骤后，即可在napi_generator/src/cli/h2dts目录下生成Windows、linux、mac系统下的可执行程序:
...
进入 napi_generator/src/cli/h2dts/src/tsGen 目录后执行如下命令：
...
1.1 安装typescript：使用管理员身份在napi_generator/src/cli/h2dts/src目录下执行命令：

	npm i typescript

1.2 安装stdio：使用管理员身份在napi_generator/src/cli/h2dts目录下执行命令：

	npm i stdio

1.3 安装pkg : 使用管理员身份在napi_generator/src/cli/h2dts目录下执行命令：
...
[IntelliJ插件开发说明](https://gitee.com/openharmony/napi_generator/blob/master/src/intellij_plugin/h2dts/ts_IntelliJ_plugin/docs/guide/DEVELOP_ZH.md)