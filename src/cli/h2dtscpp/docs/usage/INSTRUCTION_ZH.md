...
下载  native_gen-win.exe 可执行程序和 header_parser.exe 可执行程序：[下载生成工具 ](https://gitee.com/openharmony/napi_generator/releases/tag/生成工具) ；选择 tool.rar下载并解压，将解压后的文件拷贝到nativetoolGen目录下
