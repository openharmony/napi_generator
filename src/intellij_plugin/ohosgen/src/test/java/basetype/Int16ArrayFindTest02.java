...
public class Int16ArrayFindTest02 extends BasTest {
    ...
    Integer result = arr.find(
    (value, index, array) -> value > 5 && index > 1
    );
    ...
    Integer result = arr.find(
    (value, index, array) -> value == array.length() * 3
    );
    assertEqual(15, result);
    }
