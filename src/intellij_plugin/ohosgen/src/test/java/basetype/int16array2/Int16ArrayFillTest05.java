...
public class Int16ArrayFillTest05 extends BasTest {
    ...
    assertEqualInt(42, actual2);
    Integer actual3 = arr.get(5);
    assertEqualInt(42, actual3);
    }
    ...
    arr.fill(-32770);
    Integer actual1 = arr.get(0);
    assertEqualInt(32766, actual1);
    Integer actual2 = arr.get(2);
    assertEqualInt(32766, actual2);
    }
    ...
    assertEqualInt(-1, firstResult);
    Integer secondResult = arr.get(1);
    assertEqualInt(-1, secondResult);
    }
    ...
    assertEqualInt(16960, firstValue);
    Integer secondValue = arr.get(1);
    assertEqualInt(16960, secondValue);
    }
    ...
    assertEqualInt(-16960, result);
    Integer actual1 = arr.get(1);
    assertEqualInt(-16960, actual1);
    }
    ...
    assertEqualInt(expected3, actual3);
    }
    ...
    assertEqualInt(20, actual3);
    Integer actual4 = arr.get(2);
    assertEqualInt(30, actual4);
    }
    ...
    assertEqualInt(65535, actual1);
    Integer actual2 = arrU16.get(1);
    assertEqualInt(65535, actual2);
    }
    ...
    assertEqualInt(2, actual2);
    Integer actual3 = arr.get(5);
    assertEqualInt(2, actual3);
    Integer actual4 = arr.get(6);
    assertEqualInt(3, actual4);
    Integer actual5 = arr.get(8);
    assertEqualInt(3, actual5);
    Integer actual6 = arr.get(9);
    assertEqualInt(0, actual6);
    }
    ...
    assertEqualInt(128, actual1);
    Integer actual2 = copy.get(2);
    assertEqualInt(128, actual2);
    Integer actual3 = copy.get(4);
    assertEqualInt(128, actual3);
    }
