...
public class Int16ArrayFindTest04 extends BasTest {
    ...
    Int16Array arr = Int16Array.of(10, 20, 30);
    Integer result = arr.find((value, index, array) -> {
        if (index == 0) { array.copyWithin(0, 1, 2);
        } return value == 30;
    });
    assertEqual(30, result);
    }
