...
public class Int16ArrayWithTest03 extends BasTest {
    ...
    assertEqualInt(11, actual3);
    Integer actual4 = r1.get(1);
    assertEqualInt(20, actual4);
    Integer actual5 = arr.get(0);
    assertEqualInt(10, actual5);
    }
