...
public class Uint16ArrayFillFour extends BasTest {
    ...
    view.fill(9);
    assertEqualInt(1, all.at(0));
    assertEqualInt(9, all.at(1));
    assertEqualInt(9, all.at(2));
    assertEqualInt(4, all.at(3));
    }
    ...
    arr.fill(8, 1, 3);
    assertEqualInt(1, arr.at(0));
    assertEqualInt(8, arr.at(1));
    assertEqualInt(8, arr.at(2));
    ...
    assertEqualInt(11, backing.at(0));
    assertEqualInt(44, backing.at(3));
    }
    ...
    Uint16Array view = new Uint16Array(all.buffer(), 2, 2);
    view.fill(99, 0, 1);
    assertEqualInt(99, view.at(0));
    assertEqualInt(30, view.at(1));
    assertEqualInt(10, all.at(0));
    assertEqualInt(99, all.at(1));
    assertEqualInt(30, all.at(2));
    assertEqualInt(40, all.at(3));
    }
    ...
    second.fill(222);
    first.fill(333);
    assertEqualInt(333, first.at(0));
    assertEqualInt(333, first.at(1));
    assertEqualInt(222, second.at(0));
    assertEqualInt(222, second.at(1));
    }
    ...
    assertEqualInt(11, backing.at(0));
    assertEqualInt(22, backing.at(1));
    assertEqualInt(33, backing.at(2));
    assertEqualInt(44, backing.at(3));
    }
}
