...
public class Uint16ArrayFindLastIndexTwo extends BasTest {
    ...
    try { Uint16Array.of(1).findLastIndex((value) -> { throw new RangeError("findLastIndex range");}); fail();} catch (RangeError e) { assertEqual("RangeError", e.getClass().getSimpleName());}
    }
