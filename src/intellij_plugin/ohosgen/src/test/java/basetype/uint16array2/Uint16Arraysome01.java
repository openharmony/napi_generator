...
public class Uint16Arraysome01 extends BasTest {
    ...
    Uint16Array arr = new Uint16Array(new int[] {10, 20, 30});
    int[] callCount = {0};
    boolean result = arr.some((e, i, a) -> { callCount[0]++; assertEqual(10, e); assertEqual(0, i); assertEqual(arr, a); return true;});
    assertTrue(result);
    ...
    int[] callCount = {0};
    int[] matchedIndex = {-1};
    boolean result = arr.some((e, i, a) -> { callCount[0]++; if (e == 15 && i == 1 && a == arr) { matchedIndex[0] = i; return true;} return false;});
    assertTrue(result);
    ...
    boolean result = arr.some((e, i, a) -> { if (i == 0) { isSame[0] = a == arr;} return false;});
    assertTrue(isSame[0]);
    assertFalse(result);}
    }
    ...
    int[] callCount = {0};
    boolean result = arr.some((e) -> { callCount[0]++; return e == 30;});
    assertTrue(result);
    assertEqual(3, callCount[0]);}
    }
    ...
    Uint16Array arr = new Uint16Array(new int[] {1, 2, 3, 4, 5});
    int[] callCount = {0};
    boolean result = arr.some((e) -> { callCount[0]++; return e == 5;});
    assertTrue(result);
    ...
    Uint16Array arr = new Uint16Array(new int[] {1, 2, 3});
    int[] callCount = {0};
    boolean result = arr.some((e) -> { callCount[0]++; return false;});
    assertFalse(result);
    assertEqual(3, callCount[0]);}
    }
    ...
    arr.set(4999, 99);
    int[] callCount = {0};
    boolean result = arr.some((e) -> { callCount[0]++; return e == 99;});
    assertTrue(result);
    ...
    boolean result = arr.some((e, i) -> { indices.add(i); return e == 1;});
    assertTrue(result);
    ...
    int[] calls = {0};
    boolean r = a.some((v) -> { calls[0]++; return v == 9;});
    assertTrue(r);
    ...
    int[] calls = {0};
    boolean r = a.some((v) -> { calls[0]++; return v == 5;});
    assertFalse(r);
    ...
    int[] last = {-1};
    boolean r = a.some((v, i) -> { last[0] = i; return v > 0;});
    assertTrue(r);
    ...
    int[] index = {-1};
    boolean r = a.some((v, i) -> { if (v == 8) { index[0] = i;} return v == 8;});
    assertTrue(r);
    ...
    int[] order = {0};
    boolean r = a.some((v, i) -> { order[0] = order[0] * 10 + i; return false;});
    assertFalse(r);
    ...
    int[] same = {0};
    boolean r = a.some((v, i, x) -> { if (x == a) { same[0]++;} return v == 3;});
    assertTrue(r);
    ...
    int[] calls = {0};
    boolean r = a.some((v) -> { calls[0]++; return v == 65535;});
    assertTrue(r);
    ...
    int[] calls = {0};
    boolean r = a.some((v) -> { calls[0]++; return true;});
    assertFalse(r);
    ...
    Uint16Array a = Uint16Array.of(1, 2, 3);
    int[] last = {-1};
    boolean r = a.some((v, i) -> { last[0] = i; return false;});
    assertFalse(r);
    ...
    int[] last = {-1};
    boolean r = a.some((v, i) -> { last[0] = i; return v == 2;});
    assertTrue(r);
