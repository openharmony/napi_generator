...
public class Uint8ArrayGetTest extends BasTest {
    ...
    assertEqualInt(55, reader.get(0));
    }
    ...
    assertEqualInt(77, reader.get(0));
    }
    ...
    assertEqualInt(88, reader.get(2));
    }
    ...
    assertEqualInt(3, child.get(0));
    assertEqualInt(4, child.get(1));
    }
}
