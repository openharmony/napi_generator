...
public class Uint8ArrayOf02Test extends BasTest {
    ...
    assertEqualInt(222, arr.get(0));
    assertEqualInt(173, arr.get(1));
    }
    ...
    assertEqual(expected[idx], val.doubleValue());
    idx++;
    }
    assertEqual(3, idx);
    }
