...
public class Uint8ArrayToSortedTest extends BasTest {
    ...
    assertEqual(r1.get(0).intValue(), r2.get(0).intValue());
    assertEqual(r1.get(1).intValue(), r2.get(1).intValue());
    assertEqual(r1.get(2).intValue(), r2.get(2).intValue());
    }
