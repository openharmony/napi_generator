...
public class Uint8ArrayConstructor01Test extends BasTest {
    ...
    Uint8Array u = new Uint8Array(src);
    assertEqualInt(1, u.get(0));
    assertEqualInt(2, u.get(1));
    assertEqualInt(3, u.get(2));
    }
    ...
    Uint8Array u = new Uint8Array(src);
    assertEqualInt(0, u.get(0));
    assertEqualInt(127, u.get(1));
    assertEqualInt(255, u.get(2));
    }
    ...
    Uint8Array u = new Uint8Array(src);
    assertEqualInt(0, u.get(0));
    assertEqualInt(255, u.get(1));
    assertEqualInt(1, u.get(2));
    }
    ...
    Uint8Array u = new Uint8Array(src);
    assertEqualInt(0, u.get(0));
    assertEqualInt(0, u.get(1));
    assertEqualInt(0, u.get(2));
    assertEqualInt(0, u.get(3));
    assertEqualInt(0, u.get(4));
    }
    ...
    Uint8Array u = new Uint8Array(src);
    assertEqualInt(128, u.get(0));
    assertEqualInt(128, u.get(1));
    assertEqualInt(128, u.get(2));
    }
    ...
    Uint8Array u = new Uint8Array(src);
    assertEqualInt(0, u.get(0));
    assertEqualInt(1, u.get(1));
    assertEqualInt(254, u.get(2));
    assertEqualInt(255, u.get(3));
    }
