...
public class Uint8ArrayCopyWithin02Test extends BasTest {
    ...
    view1.set(0, 10); view1.set(1, 20); view1.set(2, 30);
    view1.set(3, 40); view1.set(4, 50); view1.set(5, 60);
    view1.copyWithin(0, 2, 4);
    assertEqual(30, view2.get(0));
    assertEqual(40, view2.get(1));}
    ...
    arr.set(3, 40); arr.set(4, 50); arr.set(5, 60);
