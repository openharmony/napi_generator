...
public class Uint8ClampedArrayCopyWithin02Test extends BasTest {
    ...
    assertEqualInt(11, arr.get(1));
    assertEqualInt(11, arr.get(2));
    }
    ...
    assertEqual(arr.get(1).intValue(), r.get(1).intValue());
    }
