...
public class Uint8ClampedArrayFill02Test extends BasTest {
    ...
    assertEqualInt(0, fullView.get(0));
    assertEqualInt(200, fullView.get(2));
    assertEqualInt(200, fullView.get(5));
    assertEqualInt(0, fullView.get(6));
    }
