...
public class Uint8ClampedArrayFindIndexTest extends BasTest {
    ...
    arr.findIndex((v, i, a) -> { received[0] = a; return false;});
    ...
    int[] valSum = {0};
    int[] idxSum = {0};
    arr.findIndex((v, i, a) -> { valSum[0] += v; idxSum[0] += i; return false;});
    ...
    int[] callCount = {0};
    int idx = arr.findIndex((v, i, a) -> { callCount[0]++; return v == 3;});
    assertEqual(2, idx);
    ...
    int[] callCount = {0};
    int idx = arr.findIndex((v, i, a) -> { callCount[0]++; return false;});
    assertEqual(-1, idx);
    ...
    int[] called = {0};
    int idx = arr.findIndex((v, i, a) -> { called[0]++; return true;});
    assertEqual(-1, idx);
    ...
    Uint8ClampedArray arr = new Uint8ClampedArray(new int[] {1, 2, 3});
    try {
    arr.findIndex((v, i, a) -> { throw new Error("boom");});
    fail();} catch (Error e) {
    ...
    Uint8ClampedArray arr = new Uint8ClampedArray(new int[] {1, 2, 3});
    try {
    arr.findIndex((v, i, a) -> { throw new TypeError("type");});
    ...
    Uint8ClampedArray arr = new Uint8ClampedArray(new int[] {1, 2, 3});
    try {
    arr.findIndex((v, i, a) -> { throw new RangeError("range");});
    ...
    int[] callCount = {0};
    try {
    arr.findIndex((v, i, a) -> { callCount[0]++; throw new Error("first");});
    ...
    Uint8ClampedArray arr = new Uint8ClampedArray(new int[] {1, 2, 3});
    try {
    arr.findIndex((v, i, a) -> { throw new Error("x");});
    fail();} catch (Error e) { assertEqual("Error", e.getClass().getSimpleName());};}
    /**
    ...
    int idx = a1.findIndex((v, i, a) -> { int inner = a2.findIndex((vv, ii, aa) -> vv == v * 10); return inner == 1;});
    assertEqual(1, idx);}
    /**
    ...
    arr.findIndex((v, i, a) -> {
    if (a.buffer() == buf) bufMatched[0] = true;
    return false;});
    ...
    arr.findIndex((v, i, a) -> { seen.add(v); return false;});
    ...
    Uint8ClampedArray sub = arr.subarray(1, 4);
    int[] count = {0};
    sub.findIndex((v, i, a) -> { count[0]++; return false;});
    ...
    boolean[] match = {true};
    int[] calls = {0};
    arr.findIndex((v, i, a) -> { if (a.get(i) != v) match[0] = false; calls[0]++; return false;});
    assertTrue(match[0]);
