...
public class Uint8ClampedArrayReduceRight02Test extends BasTest {
    ...
    Uint8ClampedArray arr = new Uint8ClampedArray(new int[] {1, 2, 3});
    try {
    arr.reduceRight((p, c, i, a)-> { throw new RangeError("boom");});
    ...
    Uint8ClampedArray arr = new Uint8ClampedArray(new int[] {1, 2, 3});
    try {
    arr.reduceRight((p, c, i, a)-> { throw new TypeError("boom");});
    ...
    int[] count = {0};
    try {
    arr.reduceRight((p, c, i, a)-> { count[0]++; throw new Error("x");});
    fail();} catch (Error e) {
    ...
    Uint8ClampedArray arr = new Uint8ClampedArray(new int[] {1, 2, 3, 4});
    int[] total = {0};
    arr.reduceRight((p, c, i, a)-> { total[0] += c; return p;});
    assertEqual(6, total[0]);}

    @Test
    void testUint8ClampedArrayReduceRightTwo015() {
    Uint8ClampedArray arr = new Uint8ClampedArray(new int[] {1, 2, 3});
    int r = arr.reduceRight((p, c, i, a)-> { Uint8ClampedArray inner = new Uint8ClampedArray(new int[] {c}); return p + inner.reduceRight((pp, cc, ii, aa)-> pp + cc);});;
    assertEqual(6, r);}
    ...
    arr.set(0, 5); arr.set(1, 10); arr.set(2, 15); arr.set(3, 20);
    int r = arr.reduceRight((p, c, i, a)-> p + c);
    assertEqual(50, r);}
    ...
    Uint8ClampedArray arr = new Uint8ClampedArray(new int[] {1, 2, 3});
    int[] lastRet = {-1};
    int r = arr.reduceRight((p, c, i, a)-> { int ret = p + c; lastRet[0] = ret; return ret;});;
    ...
    int[] cnt = {0};
    try {
    arr.reduceRight((p, c, i, a)-> { cnt[0]++; return p;});
    fail();} catch (TypeError e) {
    assertEqual("TypeError", e.getClass().getSimpleName());
    assertEqual(0, cnt[0]);};}
    ...
    Uint8ClampedArray arr = new Uint8ClampedArray(new int[] {1, 2});
    try {
    arr.reduceRight((p, c, i, a)-> { throw new SyntaxError("s");});
