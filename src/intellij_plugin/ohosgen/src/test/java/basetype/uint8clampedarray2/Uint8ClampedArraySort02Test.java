...
public class Uint8ClampedArraySort02Test extends BasTest {
    ...
    Uint8ClampedArray r = arr.sort((array, unusedB) -> {
        return 1;
        });
    assertEqual(3, r.length());
    assertEqualInt(1, r.get(0));
    ...
    Uint8ClampedArray r1 = arr.sort((a, b) -> {
        return (int) (a - b);
        });
    Uint8ClampedArray r2 = arr.sort((a, b) -> {
        return (int) (b - a);
        });
    assertEqual(r2, r1);
    assertEqualInt(5, r1.get(0));
    assertEqualInt(4, r1.get(1));
    assertEqualInt(3, r1.get(2));
    assertEqualInt(2, r1.get(3));
    assertEqualInt(1, r1.get(4));
    }
