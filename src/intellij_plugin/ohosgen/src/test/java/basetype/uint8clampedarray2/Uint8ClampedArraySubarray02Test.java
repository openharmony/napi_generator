...
public class Uint8ClampedArraySubarray02Test extends BasTest {
    ...
    assertEqual(3, sub.length());
    assertEqualInt(11, sub.get(0));
    assertEqualInt(22, sub.get(1));
    assertEqualInt(33, sub.get(2));
    }
    ...
    assertEqualInt(150, sub.get(1));
    assertEqualInt(200, sub.get(2));
    }
    ...
    assertEqualInt(0, sub.get(0));
    assertEqualInt(0, sub.get(255));
    assertEqualInt(0, sub.get(511));
    }
    ...
    assertEqualInt(4, sub3.get(0));
    assertEqualInt(5, sub3.get(1));
    assertEqualInt(6, sub3.get(2));
    assertEqualInt(7, sub3.get(3));
    }
    ...
    assertEqualInt(0, secondSub.get(0));
    assertEqualInt(0, secondSub.get(1));
    assertEqualInt(0, secondSub.get(2));
    assertEqualInt(0, secondSub.get(3));
    }
    ...
    assertEqualInt(10, s1.get(0));
    assertEqualInt(20, s1.get(1));
    assertEqualInt(30, s1.get(2));
    assertEqualInt(40, s1.get(3));
    }
    ...
    Uint8ClampedArray sub = arr.subarray(2, 4);
    assertEqual(2, sub.length());
    assertEqual(arr.get(2).intValue(), sub.get(0).intValue());
    assertEqual(arr.get(3).intValue(), sub.get(1).intValue());
    }
    ...
    Uint8ClampedArray sub = arr.subarray(1, 3);
    assertEqual(2, sub.length());
    assertEqual(arr.get(1).intValue(), sub.get(0).intValue());
    assertEqual(arr.get(2).intValue(), sub.get(1).intValue());
    }
    ...
    assertEqualInt(3, sub.get(0));
    assertEqualInt(4, sub.get(1));
    assertEqualInt(5, sub.get(2));
    }
