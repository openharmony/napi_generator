...
public class Uint8ClampedArrayToLocaleString02Test extends BasTest {
    ...
    assertEqual(2, sub.length());
    assertEqualInt(100, parent.get(0));
    assertEqualInt(200, parent.get(1));
    assertEqualInt(250, parent.get(2));
    assertEqualInt(100, sub.get(0));
    assertEqualInt(200, sub.get(1));
    }
