...
public class Uint8ClampedArrayUnderGetTest extends BasTest {
    ...
    assertEqualInt(40, arr.get(arr.length() - 1));
    }
    ...
    arr.set(254, 200);
    assertEqualInt(200, arr.get(254));
    }
    ...
    Uint8ClampedArray arr = new Uint8ClampedArray(1024);
    arr.set(1023, 200);
    assertEqualInt(200, arr.get(1023));
    }
    ...
    Uint8ClampedArray arr = new Uint8ClampedArray(65535);
    arr.set(65534, 2);
    assertEqualInt(2, arr.get(65534));
    }
