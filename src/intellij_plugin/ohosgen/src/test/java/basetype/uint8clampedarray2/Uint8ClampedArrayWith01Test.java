...
public class Uint8ClampedArrayWith01Test extends BasTest {
    ...
    assertEqualInt(10, r2.get(0));
    assertEqualInt(20, r2.get(1));
    assertEqualInt(3, r2.get(2));
    }
    ...
    Uint8ClampedArray arr = new Uint8ClampedArray(new int[] {1, 2, 3});
    try {
    java.util.function.IntSupplier withFn = (java.util.function.IntSupplier) () -> {
