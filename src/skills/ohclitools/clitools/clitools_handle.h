...
#ifndef CLITOOLS_HANDLE_H
#define CLITOOLS_HANDLE_H
...
void PrintAvailableServices(const std::vector<OHOS::Bluetooth::GattService>& services,
    const char* title = "Available services:");
void PrintAvailableCharacteristics(const std::vector<OHOS::Bluetooth::GattCharacteristic>& characteristics,
    const std::string& serviceUuid);
void PrintServiceNotFound(const std::string& serviceUuid, const std::vector<OHOS::Bluetooth::GattService>& services);
void PrintCharacteristicNotFound(const std::string& characteristicUuid,
    const std::vector<OHOS::Bluetooth::GattCharacteristic>& characteristics, const std::string& serviceUuid);
...
void DumpBrStatus();
void DumpServiceData(const OHOS::Bluetooth::BleScanResult& result);
void DumpServiceUuids(const std::vector<OHOS::Bluetooth::GattService>& services);
