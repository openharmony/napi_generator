...
## 目录 
	...
	├── napi_generator/src/vscode_plugin/h2dts                     # TS框架生成工具
...
[工具使用说明](https://gitee.com/openharmony/napi_generator/tree/master/src/vscode_plugin/h2dts/ts_vs_plugin/docs/usage/INSTRUCTION_ZH.md)
...
开发者可以根据如下的步骤来完成对工具VS Code插件的开发：
 ...
 [工具开发说明](https://gitee.com/openharmony/napi_generator/tree/master/src/vscode_plugin/h2dts/ts_vs_plugin/docs/guide/DEVELOP_ZH.md)
