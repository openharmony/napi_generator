...
suite('Parse_Class_C_Suite', () => {
    ...
    test('parseClass_test_1', () => {
        let testenum = `typedef class OTC {
            private int len,
            public char name[20],
            public void contruct(int a);
            public void deconstruct();
        } OperationType;`
        let enumObjList = parsec.parseClass(testenum);
        assert.strictEqual(enumObjList.length, 1);
        let enumItem = enumObjList[0];
        assert.strictEqual(enumItem.name, 'OTC');
    ...
    //     enumObjList = parsec.parseClass(testenum);
    //     assert.strictEqual(enumObjList.length, 1);
    ...
    //     let teststr: string = '';
    //     let enumObjList = parsec.parseClass(teststr);
    //     assert.strictEqual(enumObjList.length, 0);

    //     teststr = 'enum { ENUM_1 }';
    //     enumObjList = parsec.parseClass(teststr);
    //     assert.strictEqual(enumObjList.length, 1);
    //     let enumItem = enumObjList[0];
    //     // assert.strictEqual(enumItem.members[0], 'ENUM_1');
    ...
    //     let enumObjList = parsec.parseClass('');
    //     assert.strictEqual(enumObjList.length, 0);
