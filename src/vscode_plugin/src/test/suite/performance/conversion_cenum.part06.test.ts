...
{
  this.timeout(600000);
  vscode.window.showInformationMessage('Start Performance_C_Enum_Suite part06.');

  /**
  * @tc.number c_enum_0144
  * @tc.name c_enum_0144
  * @tc.desc h2dts parseEnum：扩充-矩阵：31 成员（无赋值） 的解析结果与性能。
  * @tc.size MediumTest
  * @tc.type Function
  * @tc.level Level 1
  */
  test('c_enum_0144', () => {
    ...
    M30
      ...
      assert.strictEqual(objList[0].name, 'En31F0');
      assert.strictEqual(objList[0].alias, 'En31F0');
      assert.strictEqual(objList[0].members.length, 31);
      ...
      assert.ok(
        ...
        `c_enum_0144 总耗时 ${elapsed}ms 超过阈值 ${PARSE_TOTAL_MS}ms（次数 ${localLoop}）`
      );
    } catch (err) {
      assert.fail(`c_enum_0144 执行异常: ${String(err)}`);
    }
  });

  /**
  * @tc.number c_enum_0145
  * @tc.name c_enum_0145
  * @tc.desc h2dts parseEnum：扩充-矩阵：31 成员（数字赋值） 的解析结果与性能。
  * @tc.size MediumTest
  * @tc.type Function
  * @tc.level Level 1
  */
  test('c_enum_0145', () => {
    ...
    M30 = 30
      ...
      assert.ok(objList);
      assert.strictEqual(objList.length, 1);
      assert.strictEqual(objList[0].name, 'En31F1');
      assert.strictEqual(objList[0].alias, 'En31F1');
      assert.strictEqual(objList[0].members.length, 31);
      ...
      assert.ok(
        elapsed < PARSE_TOTAL_MS,
        `c_enum_0145 总耗时 ${elapsed}ms 超过阈值 ${PARSE_TOTAL_MS}ms（次数 ${localLoop}）`
      );
    } catch (err) {
      assert.fail(`c_enum_0145 执行异常: ${String(err)}`);
    }
  });

  /**
  * @tc.number c_enum_0146
  * @tc.name c_enum_0146
  * @tc.desc h2dts parseEnum：扩充-矩阵：31 成员（字符串赋值） 的解析结果与性能。
  * @tc.size MediumTest
  * @tc.type Function
  * @tc.level Level 1
  */
  test('c_enum_0146', () => {
    ...
    M30 = "v30"
      ...
      assert.ok(objList);
      assert.strictEqual(objList.length, 1);
      assert.strictEqual(objList[0].name, 'En31F2');
      assert.strictEqual(objList[0].alias, 'En31F2');
      assert.strictEqual(objList[0].members.length, 31);
      ...
      assert.ok(
        elapsed < PARSE_TOTAL_MS,
        `c_enum_0146 总耗时 ${elapsed}ms 超过阈值 ${PARSE_TOTAL_MS}ms（次数 ${localLoop}）`
      );
    } catch (err) {
      assert.fail(`c_enum_0146 执行异常: ${String(err)}`);
    }
  });

  /**
  * @tc.number c_enum_0147
  * @tc.name c_enum_0147
  * @tc.desc h2dts parseEnum：扩充-矩阵：31 成员（十六进制赋值） 的解析结果与性能。
  * @tc.size MediumTest
  * @tc.type Function
  * @tc.level Level 1
  */
  test('c_enum_0147', () => {
    ...
    M30 = 0x1F
      ...
      assert.ok(objList);
      assert.strictEqual(objList.length, 1);
      assert.strictEqual(objList[0].name, 'En31F3');
      assert.strictEqual(objList[0].alias, 'En31F3');
      assert.strictEqual(objList[0].members.length, 31);
      ...
      assert.ok(
        elapsed < PARSE_TOTAL_MS,
        `c_enum_0147 总耗时 ${elapsed}ms 超过阈值 ${PARSE_TOTAL_MS}ms（次数 ${localLoop}）`
      );
    } catch (err) {
      assert.fail(`c_enum_0147 执行异常: ${String(err)}`);
    }
  });

  /**
  * @tc.number c_enum_0148
  * @tc.name c_enum_0148
  * @tc.desc h2dts parseEnum：扩充-矩阵：32 成员（无赋值） 的解析结果与性能。
  * @tc.size MediumTest
  * @tc.type Function
  * @tc.level Level 1
  */
  test('c_enum_0148', () => {
    ...
    M31
      ...
      assert.ok(objList);
      assert.strictEqual(objList.length, 1);
      assert.strictEqual(objList[0].name, 'En32F0');
      assert.strictEqual(objList[0].alias, 'En32F0');
      assert.strictEqual(objList[0].members.length, 32);
      assert.strictEqual(objList[0].members[0], 'M0');
      assert.strictEqual(objList[0].members[1], 'M1');
      assert.strictEqual(objList[0].members[2], 'M2');
      assert.strictEqual(objList[0].members[3], 'M3');
      ...
      assert.ok(
        elapsed < PARSE_TOTAL_MS,
        `c_enum_0148 总耗时 ${elapsed}ms 超过阈值 ${PARSE_TOTAL_MS}ms（次数 ${localLoop}）`
      );
    } catch (err) {
      assert.fail(`c_enum_0148 执行异常: ${String(err)}`);
    }
  });

  /**
  * @tc.number c_enum_0149
  * @tc.name c_enum_0149
  * @tc.desc h2dts parseEnum：扩充-矩阵：32 成员（数字赋值） 的解析结果与性能。
  * @tc.size MediumTest
  * @tc.type Function
  * @tc.level Level 1
  */
  test('c_enum_0149', () => {
    ...
    M31 = 31
      ...
      assert.ok(objList);
      assert.strictEqual(objList.length, 1);
      assert.strictEqual(objList[0].name, 'En32F1');
      assert.strictEqual(objList[0].alias, 'En32F1');
      assert.strictEqual(objList[0].members.length, 32);
      assert.strictEqual(objList[0].members[0], 'M0=0');
      assert.strictEqual(objList[0].members[1], 'M1=1');
      assert.strictEqual(objList[0].members[2], 'M2=2');
      ...
      assert.ok(
        elapsed < PARSE_TOTAL_MS,
        `c_enum_0149 总耗时 ${elapsed}ms 超过阈值 ${PARSE_TOTAL_MS}ms（次数 ${localLoop}）`
      );
    } catch (err) {
      assert.fail(`c_enum_0149 执行异常: ${String(err)}`);
    }
  });

  /**
  * @tc.number c_enum_0150
  * @tc.name c_enum_0150
  * @tc.desc h2dts parseEnum：扩充-矩阵：32 成员（字符串赋值） 的解析结果与性能。
  * @tc.size MediumTest
  * @tc.type Function
  * @tc.level Level 1
  */
  test('c_enum_0150', () => {
    ...
    M31 = "v31"
      ...
      assert.ok(objList);
      assert.strictEqual(objList.length, 1);
      assert.strictEqual(objList[0].name, 'En32F2');
      assert.strictEqual(objList[0].alias, 'En32F2');
      assert.strictEqual(objList[0].members.length, 32);
      assert.strictEqual(objList[0].members[0], 'M0="v0"');
      assert.strictEqual(objList[0].members[1], 'M1="v1"');
      assert.strictEqual(objList[0].members[2], 'M2="v2"');
      ...
      assert.ok(
        elapsed < PARSE_TOTAL_MS,
        `c_enum_0150 总耗时 ${elapsed}ms 超过阈值 ${PARSE_TOTAL_MS}ms（次数 ${localLoop}）`
      );
    } catch (err) {
      assert.fail(`c_enum_0150 执行异常: ${String(err)}`);
    }
  });

  /**
  * @tc.number c_enum_0151
  * @tc.name c_enum_0151
  * @tc.desc h2dts parseEnum：扩充-矩阵：32 成员（十六进制赋值） 的解析结果与性能。
  * @tc.size MediumTest
  * @tc.type Function
  * @tc.level Level 1
  */
  test('c_enum_0151', () => {
    ...
    M31 = 0x20
      ...
      assert.ok(objList);
      assert.strictEqual(objList.length, 1);
      assert.strictEqual(objList[0].name, 'En32F3');
      assert.strictEqual(objList[0].alias, 'En32F3');
      assert.strictEqual(objList[0].members.length, 32);
      assert.strictEqual(objList[0].members[0], 'M0=0x1');
      assert.strictEqual(objList[0].members[1], 'M1=0x2');
      assert.strictEqual(objList[0].members[2], 'M2=0x3');
      ...
      assert.ok(
        elapsed < PARSE_TOTAL_MS,
        `c_enum_0151 总耗时 ${elapsed}ms 超过阈值 ${PARSE_TOTAL_MS}ms（次数 ${localLoop}）`
      );
    } catch (err) {
      assert.fail(`c_enum_0151 执行异常: ${String(err)}`);
    }
  });

  /**
  * @tc.number c_enum_0152
  * @tc.name c_enum_0152
  * @tc.desc h2dts parseEnum：扩充-矩阵：33 成员（无赋值） 的解析结果与性能。
  * @tc.size MediumTest
  * @tc.type Function
  * @tc.level Level 1
  */
  test('c_enum_0152', () => {
    ...
    M32
      ...
      assert.ok(objList);
      assert.strictEqual(objList.length, 1);
      assert.strictEqual(objList[0].name, 'En33F0');
      assert.strictEqual(objList[0].alias, 'En33F0');
      ...
      assert.ok(
        elapsed < PARSE_TOTAL_MS,
        `c_enum_0152 总耗时 ${elapsed}ms 超过阈值 ${PARSE_TOTAL_MS}ms（次数 ${localLoop}）`
      );
    } catch (err) {
      assert.fail(`c_enum_0152 执行异常: ${String(err)}`);
    }
  });

  /**
  * @tc.number c_enum_0153
  * @tc.name c_enum_0153
  * @tc.desc h2dts parseEnum：扩充-矩阵：33 成员（数字赋值） 的解析结果与性能。
  * @tc.size MediumTest
  * @tc.type Function
  * @tc.level Level 1
  */
  test('c_enum_0153', () => {
    ...
    M32 = 32
      ...
      assert.ok(objList);
      assert.strictEqual(objList.length, 1);
      assert.strictEqual(objList[0].name, 'En33F1');
      assert.strictEqual(objList[0].alias, 'En33F1');
      assert.strictEqual(objList[0].members.length, 33);
      assert.strictEqual(objList[0].members[0], 'M0=0');
      assert.strictEqual(objList[0].members[1], 'M1=1');
      assert.strictEqual(objList[0].members[2], 'M2=2');
      ...
      assert.ok(
        elapsed < PARSE_TOTAL_MS,
        `c_enum_0153 总耗时 ${elapsed}ms 超过阈值 ${PARSE_TOTAL_MS}ms（次数 ${localLoop}）`
      );
    } catch (err) {
      assert.fail(`c_enum_0153 执行异常: ${String(err)}`);
    }
  });

  /**
  * @tc.number c_enum_0154
  * @tc.name c_enum_0154
  * @tc.desc h2dts parseEnum：扩充-矩阵：33 成员（字符串赋值） 的解析结果与性能。
  * @tc.size MediumTest
  * @tc.type Function
  * @tc.level Level 1
  */
  test('c_enum_0154', () => {
    ...
    M32 = "v32"
      ...
      assert.ok(objList);
      assert.strictEqual(objList.length, 1);
      assert.strictEqual(objList[0].name, 'En33F2');
      assert.strictEqual(objList[0].alias, 'En33F2');
      assert.strictEqual(objList[0].members.length, 33);
      assert.strictEqual(objList[0].members[0], 'M0="v0"');
      assert.strictEqual(objList[0].members[1], 'M1="v1"');
      assert.strictEqual(objList[0].members[2], 'M2="v2"');
      ...
      assert.ok(
        elapsed < PARSE_TOTAL_MS,
        `c_enum_0154 总耗时 ${elapsed}ms 超过阈值 ${PARSE_TOTAL_MS}ms（次数 ${localLoop}）`
      );
    } catch (err) {
      assert.fail(`c_enum_0154 执行异常: ${String(err)}`);
    }
  });

  /**
  * @tc.number c_enum_0155
  * @tc.name c_enum_0155
  * @tc.desc h2dts parseEnum：扩充-矩阵：33 成员（十六进制赋值） 的解析结果与性能。
  * @tc.size MediumTest
  * @tc.type Function
  * @tc.level Level 1
  */
  test('c_enum_0155', () => {
    ...
    M32 = 0x21
      ...
      assert.ok(objList);
      assert.strictEqual(objList.length, 1);
      assert.strictEqual(objList[0].name, 'En33F3');
      assert.strictEqual(objList[0].alias, 'En33F3');
      assert.strictEqual(objList[0].members.length, 33);
      assert.strictEqual(objList[0].members[0], 'M0=0x1');
      assert.strictEqual(objList[0].members[1], 'M1=0x2');
      assert.strictEqual(objList[0].members[2], 'M2=0x3');
      ...
      assert.ok(
        elapsed < PARSE_TOTAL_MS,
        `c_enum_0155 总耗时 ${elapsed}ms 超过阈值 ${PARSE_TOTAL_MS}ms（次数 ${localLoop}）`
      );
    } catch (err) {
      assert.fail(`c_enum_0155 执行异常: ${String(err)}`);
    }
  });

  /**
  * @tc.number c_enum_0156
  * @tc.name c_enum_0156
  * @tc.desc h2dts parseEnum：扩充-矩阵：34 成员（无赋值） 的解析结果与性能。
  * @tc.size MediumTest
  * @tc.type Function
  * @tc.level Level 1
  */
  test('c_enum_0156', () => {
    ...
    M33
      ...
      assert.ok(objList);
      assert.strictEqual(objList.length, 1);
      assert.strictEqual(objList[0].name, 'En34F0');
      assert.strictEqual(objList[0].alias, 'En34F0');
      assert.strictEqual(objList[0].members.length, 34);
      assert.strictEqual(objList[0].members[0], 'M0');
      assert.strictEqual(objList[0].members[1], 'M1');
      assert.strictEqual(objList[0].members[2], 'M2');
      assert.strictEqual(objList[0].members[3], 'M3');
      ...
      assert.ok(
        elapsed < PARSE_TOTAL_MS,
        `c_enum_0156 总耗时 ${elapsed}ms 超过阈值 ${PARSE_TOTAL_MS}ms（次数 ${localLoop}）`
      );
    } catch (err) {
      assert.fail(`c_enum_0156 执行异常: ${String(err)}`);
    }
  });

  /**
  * @tc.number c_enum_0157
  * @tc.name c_enum_0157
  * @tc.desc h2dts parseEnum：扩充-矩阵：34 成员（数字赋值） 的解析结果与性能。
  * @tc.size MediumTest
  * @tc.type Function
  * @tc.level Level 1
  */
  test('c_enum_0157', () => {
    ...
    M33 = 33
      ...
      assert.ok(objList);
      assert.strictEqual(objList.length, 1);
      assert.strictEqual(objList[0].name, 'En34F1');
      assert.strictEqual(objList[0].alias, 'En34F1');
      assert.strictEqual(objList[0].members.length, 34);
      assert.strictEqual(objList[0].members[0], 'M0=0');
      assert.strictEqual(objList[0].members[1], 'M1=1');
      assert.strictEqual(objList[0].members[2], 'M2=2');
      ...
      assert.ok(
        elapsed < PARSE_TOTAL_MS,
        `c_enum_0157 总耗时 ${elapsed}ms 超过阈值 ${PARSE_TOTAL_MS}ms（次数 ${localLoop}）`
      );
    } catch (err) {
      assert.fail(`c_enum_0157 执行异常: ${String(err)}`);
    }
  });

  /**
  * @tc.number c_enum_0158
  * @tc.name c_enum_0158
  * @tc.desc h2dts parseEnum：扩充-矩阵：34 成员（字符串赋值） 的解析结果与性能。
  * @tc.size MediumTest
  * @tc.type Function
  * @tc.level Level 1
  */
  test('c_enum_0158', () => {
    ...
    M33 = "v33"
      ...
      assert.ok(objList);
      assert.strictEqual(objList.length, 1);
      assert.strictEqual(objList[0].name, 'En34F2');
      assert.strictEqual(objList[0].alias, 'En34F2');
      assert.strictEqual(objList[0].members.length, 34);
      assert.strictEqual(objList[0].members[0], 'M0="v0"');
      assert.strictEqual(objList[0].members[1], 'M1="v1"');
      assert.strictEqual(objList[0].members[2], 'M2="v2"');
      ...
      assert.ok(
        elapsed < PARSE_TOTAL_MS,
        `c_enum_0158 总耗时 ${elapsed}ms 超过阈值 ${PARSE_TOTAL_MS}ms（次数 ${localLoop}）`
      );
    } catch (err) {
      assert.fail(`c_enum_0158 执行异常: ${String(err)}`);
    }
  });

  /**
  * @tc.number c_enum_0159
  * @tc.name c_enum_0159
  * @tc.desc h2dts parseEnum：扩充-矩阵：34 成员（十六进制赋值） 的解析结果与性能。
  * @tc.size MediumTest
  * @tc.type Function
  * @tc.level Level 1
  */
  test('c_enum_0159', () => {
    ...
    M33 = 0x22
      ...
      assert.ok(objList);
      assert.strictEqual(objList.length, 1);
      assert.strictEqual(objList[0].name, 'En34F3');
      assert.strictEqual(objList[0].alias, 'En34F3');
      assert.strictEqual(objList[0].members.length, 34);
      assert.strictEqual(objList[0].members[0], 'M0=0x1');
      assert.strictEqual(objList[0].members[1], 'M1=0x2');
      assert.strictEqual(objList[0].members[2], 'M2=0x3');
      ...
      assert.ok(
        elapsed < PARSE_TOTAL_MS,
        `c_enum_0159 总耗时 ${elapsed}ms 超过阈值 ${PARSE_TOTAL_MS}ms（次数 ${localLoop}）`
      );
    } catch (err) {
      assert.fail(`c_enum_0159 执行异常: ${String(err)}`);
    }
  });

  /**
  * @tc.number c_enum_0160
  * @tc.name c_enum_0160
  * @tc.desc h2dts parseEnum：扩充-矩阵：35 成员（无赋值） 的解析结果与性能。
  * @tc.size MediumTest
  * @tc.type Function
  * @tc.level Level 1
  */
  test('c_enum_0160', () => {
    ...
    M34
      ...
      assert.ok(objList);
      assert.strictEqual(objList.length, 1);
      assert.strictEqual(objList[0].name, 'En35F0');
      assert.strictEqual(objList[0].alias, 'En35F0');
      ...
      assert.ok(
        elapsed < PARSE_TOTAL_MS,
        `c_enum_0160 总耗时 ${elapsed}ms 超过阈值 ${PARSE_TOTAL_MS}ms（次数 ${localLoop}）`
      );
    } catch (err) {
      assert.fail(`c_enum_0160 执行异常: ${String(err)}`);
    }
  });

  /**
  * @tc.number c_enum_0161
  * @tc.name c_enum_0161
  * @tc.desc h2dts parseEnum：扩充-矩阵：35 成员（数字赋值） 的解析结果与性能。
  * @tc.size MediumTest
  * @tc.type Function
  * @tc.level Level 1
  */
  test('c_enum_0161', () => {
    ...
    M34 = 34
      ...
      assert.ok(objList);
      assert.strictEqual(objList.length, 1);
      assert.strictEqual(objList[0].name, 'En35F1');
      assert.strictEqual(objList[0].alias, 'En35F1');
      assert.strictEqual(objList[0].members.length, 35);
      assert.strictEqual(objList[0].members[0], 'M0=0');
      assert.strictEqual(objList[0].members[1], 'M1=1');
      assert.strictEqual(objList[0].members[2], 'M2=2');
      ...
      assert.ok(
        elapsed < PARSE_TOTAL_MS,
        `c_enum_0161 总耗时 ${elapsed}ms 超过阈值 ${PARSE_TOTAL_MS}ms（次数 ${localLoop}）`
      );
    } catch (err) {
      assert.fail(`c_enum_0161 执行异常: ${String(err)}`);
    }
  });

  /**
  * @tc.number c_enum_0162
  * @tc.name c_enum_0162
  * @tc.desc h2dts parseEnum：扩充-矩阵：35 成员（字符串赋值） 的解析结果与性能。
  * @tc.size MediumTest
  * @tc.type Function
  * @tc.level Level 1
  */
  test('c_enum_0162', () => {
    ...
    M34 = "v34"
      ...
      assert.ok(objList);
      assert.strictEqual(objList.length, 1);
      assert.strictEqual(objList[0].name, 'En35F2');
      assert.strictEqual(objList[0].alias, 'En35F2');
      assert.strictEqual(objList[0].members.length, 35);
      assert.strictEqual(objList[0].members[0], 'M0="v0"');
      assert.strictEqual(objList[0].members[1], 'M1="v1"');
      assert.strictEqual(objList[0].members[2], 'M2="v2"');
      ...
      assert.ok(
        elapsed < PARSE_TOTAL_MS,
        `c_enum_0162 总耗时 ${elapsed}ms 超过阈值 ${PARSE_TOTAL_MS}ms（次数 ${localLoop}）`
      );
    } catch (err) {
      assert.fail(`c_enum_0162 执行异常: ${String(err)}`);
    }
  });
