...
{
  this.timeout(600000);
  vscode.window.showInformationMessage('Start Performance_C_Enum_Suite part08.');

  /**
  * @tc.number c_enum_0180
  * @tc.name c_enum_0180
  * @tc.desc h2dts parseEnum：扩充-矩阵：40 成员（无赋值） 的解析结果与性能。
  * @tc.size MediumTest
  * @tc.type Function
  * @tc.level Level 1
  */
  test('c_enum_0180', () => {
    ...
    M39
      ...
      assert.strictEqual(objList[0].name, 'En40F0');
      assert.strictEqual(objList[0].alias, 'En40F0');
      assert.strictEqual(objList[0].members.length, 40);
      ...
      assert.ok(
        ...
        `c_enum_0180 总耗时 ${elapsed}ms 超过阈值 ${PARSE_TOTAL_MS}ms（次数 ${localLoop}）`
      );
    } catch (err) {
      assert.fail(`c_enum_0180 执行异常: ${String(err)}`);
    }
  });

  /**
  * @tc.number c_enum_0181
  * @tc.name c_enum_0181
  * @tc.desc h2dts parseEnum：扩充-矩阵：40 成员（数字赋值） 的解析结果与性能。
  * @tc.size MediumTest
  * @tc.type Function
  * @tc.level Level 1
  */
  test('c_enum_0181', () => {
    ...
    M39 = 39
      ...
      assert.ok(objList);
      assert.strictEqual(objList.length, 1);
      assert.strictEqual(objList[0].name, 'En40F1');
      assert.strictEqual(objList[0].alias, 'En40F1');
      assert.strictEqual(objList[0].members.length, 40);
      ...
      assert.ok(
        elapsed < PARSE_TOTAL_MS,
        `c_enum_0181 总耗时 ${elapsed}ms 超过阈值 ${PARSE_TOTAL_MS}ms（次数 ${localLoop}）`
      );
    } catch (err) {
      assert.fail(`c_enum_0181 执行异常: ${String(err)}`);
    }
  });

  /**
  * @tc.number c_enum_0182
  * @tc.name c_enum_0182
  * @tc.desc h2dts parseEnum：扩充-矩阵：40 成员（字符串赋值） 的解析结果与性能。
  * @tc.size MediumTest
  * @tc.type Function
  * @tc.level Level 1
  */
  test('c_enum_0182', () => {
    ...
    M39 = "v39"
      ...
      assert.ok(objList);
      assert.strictEqual(objList.length, 1);
      assert.strictEqual(objList[0].name, 'En40F2');
      assert.strictEqual(objList[0].alias, 'En40F2');
      assert.strictEqual(objList[0].members.length, 40);
      ...
      assert.ok(
        elapsed < PARSE_TOTAL_MS,
        `c_enum_0182 总耗时 ${elapsed}ms 超过阈值 ${PARSE_TOTAL_MS}ms（次数 ${localLoop}）`
      );
    } catch (err) {
      assert.fail(`c_enum_0182 执行异常: ${String(err)}`);
    }
  });

  /**
  * @tc.number c_enum_0183
  * @tc.name c_enum_0183
  * @tc.desc h2dts parseEnum：扩充-矩阵：40 成员（十六进制赋值） 的解析结果与性能。
  * @tc.size MediumTest
  * @tc.type Function
  * @tc.level Level 1
  */
  test('c_enum_0183', () => {
    ...
    M39 = 0x28
      ...
      assert.ok(objList);
      assert.strictEqual(objList.length, 1);
      assert.strictEqual(objList[0].name, 'En40F3');
      assert.strictEqual(objList[0].alias, 'En40F3');
      assert.strictEqual(objList[0].members.length, 40);
      ...
      assert.ok(
        elapsed < PARSE_TOTAL_MS,
        `c_enum_0183 总耗时 ${elapsed}ms 超过阈值 ${PARSE_TOTAL_MS}ms（次数 ${localLoop}）`
      );
    } catch (err) {
      assert.fail(`c_enum_0183 执行异常: ${String(err)}`);
    }
  });

  /**
  * @tc.number c_enum_0184
  * @tc.name c_enum_0184
  * @tc.desc h2dts parseEnum：扩充-矩阵：41 成员（无赋值） 的解析结果与性能。
  * @tc.size MediumTest
  * @tc.type Function
  * @tc.level Level 1
  */
  test('c_enum_0184', () => {
    ...
    M40
      ...
      assert.ok(objList);
      assert.strictEqual(objList.length, 1);
      assert.strictEqual(objList[0].name, 'En41F0');
      assert.strictEqual(objList[0].alias, 'En41F0');
      assert.strictEqual(objList[0].members.length, 41);
      assert.strictEqual(objList[0].members[0], 'M0');
      assert.strictEqual(objList[0].members[1], 'M1');
      assert.strictEqual(objList[0].members[2], 'M2');
      assert.strictEqual(objList[0].members[3], 'M3');
      ...
      assert.ok(
        elapsed < PARSE_TOTAL_MS,
        `c_enum_0184 总耗时 ${elapsed}ms 超过阈值 ${PARSE_TOTAL_MS}ms（次数 ${localLoop}）`
      );
    } catch (err) {
      assert.fail(`c_enum_0184 执行异常: ${String(err)}`);
    }
  });

  /**
  * @tc.number c_enum_0185
  * @tc.name c_enum_0185
  * @tc.desc h2dts parseEnum：扩充-矩阵：41 成员（数字赋值） 的解析结果与性能。
  * @tc.size MediumTest
  * @tc.type Function
  * @tc.level Level 1
  */
  test('c_enum_0185', () => {
    ...
    M40 = 40
      ...
      assert.ok(objList);
      assert.strictEqual(objList.length, 1);
      assert.strictEqual(objList[0].name, 'En41F1');
      assert.strictEqual(objList[0].alias, 'En41F1');
      assert.strictEqual(objList[0].members.length, 41);
      assert.strictEqual(objList[0].members[0], 'M0=0');
      assert.strictEqual(objList[0].members[1], 'M1=1');
      assert.strictEqual(objList[0].members[2], 'M2=2');
      ...
      assert.ok(
        elapsed < PARSE_TOTAL_MS,
        `c_enum_0185 总耗时 ${elapsed}ms 超过阈值 ${PARSE_TOTAL_MS}ms（次数 ${localLoop}）`
      );
    } catch (err) {
      assert.fail(`c_enum_0185 执行异常: ${String(err)}`);
    }
  });

  /**
  * @tc.number c_enum_0186
  * @tc.name c_enum_0186
  * @tc.desc h2dts parseEnum：扩充-矩阵：41 成员（字符串赋值） 的解析结果与性能。
  * @tc.size MediumTest
  * @tc.type Function
  * @tc.level Level 1
  */
  test('c_enum_0186', () => {
    ...
    M40 = "v40"
      ...
      assert.ok(objList);
      assert.strictEqual(objList.length, 1);
      assert.strictEqual(objList[0].name, 'En41F2');
      assert.strictEqual(objList[0].alias, 'En41F2');
      assert.strictEqual(objList[0].members.length, 41);
      assert.strictEqual(objList[0].members[0], 'M0="v0"');
      assert.strictEqual(objList[0].members[1], 'M1="v1"');
      assert.strictEqual(objList[0].members[2], 'M2="v2"');
      ...
      assert.ok(
        elapsed < PARSE_TOTAL_MS,
        `c_enum_0186 总耗时 ${elapsed}ms 超过阈值 ${PARSE_TOTAL_MS}ms（次数 ${localLoop}）`
      );
    } catch (err) {
      assert.fail(`c_enum_0186 执行异常: ${String(err)}`);
    }
  });

  /**
  * @tc.number c_enum_0187
  * @tc.name c_enum_0187
  * @tc.desc h2dts parseEnum：扩充-矩阵：41 成员（十六进制赋值） 的解析结果与性能。
  * @tc.size MediumTest
  * @tc.type Function
  * @tc.level Level 1
  */
  test('c_enum_0187', () => {
    ...
    M40 = 0x29
      ...
      assert.ok(objList);
      assert.strictEqual(objList.length, 1);
      assert.strictEqual(objList[0].name, 'En41F3');
      assert.strictEqual(objList[0].alias, 'En41F3');
      assert.strictEqual(objList[0].members.length, 41);
      assert.strictEqual(objList[0].members[0], 'M0=0x1');
      assert.strictEqual(objList[0].members[1], 'M1=0x2');
      assert.strictEqual(objList[0].members[2], 'M2=0x3');
      ...
      assert.ok(
        elapsed < PARSE_TOTAL_MS,
        `c_enum_0187 总耗时 ${elapsed}ms 超过阈值 ${PARSE_TOTAL_MS}ms（次数 ${localLoop}）`
      );
    } catch (err) {
      assert.fail(`c_enum_0187 执行异常: ${String(err)}`);
    }
  });

  /**
  * @tc.number c_enum_0188
  * @tc.name c_enum_0188
  * @tc.desc h2dts parseEnum：扩充-矩阵：42 成员（无赋值） 的解析结果与性能。
  * @tc.size MediumTest
  * @tc.type Function
  * @tc.level Level 1
  */
  test('c_enum_0188', () => {
    ...
    M41
      ...
      assert.ok(objList);
      assert.strictEqual(objList.length, 1);
      assert.strictEqual(objList[0].name, 'En42F0');
      assert.strictEqual(objList[0].alias, 'En42F0');
      assert.strictEqual(objList[0].members.length, 42);
      assert.strictEqual(objList[0].members[0], 'M0');
      assert.strictEqual(objList[0].members[1], 'M1');
      assert.strictEqual(objList[0].members[2], 'M2');
      assert.strictEqual(objList[0].members[3], 'M3');
      ...
      assert.ok(
        elapsed < PARSE_TOTAL_MS,
        `c_enum_0188 总耗时 ${elapsed}ms 超过阈值 ${PARSE_TOTAL_MS}ms（次数 ${localLoop}）`
      );
    } catch (err) {
      assert.fail(`c_enum_0188 执行异常: ${String(err)}`);
    }
  });

  /**
  * @tc.number c_enum_0189
  * @tc.name c_enum_0189
  * @tc.desc h2dts parseEnum：扩充-矩阵：42 成员（数字赋值） 的解析结果与性能。
  * @tc.size MediumTest
  * @tc.type Function
  * @tc.level Level 1
  */
  test('c_enum_0189', () => {
    ...
    M41 = 41
      ...
      assert.ok(objList);
      assert.strictEqual(objList.length, 1);
      assert.strictEqual(objList[0].name, 'En42F1');
      assert.strictEqual(objList[0].alias, 'En42F1');
      assert.strictEqual(objList[0].members.length, 42);
      assert.strictEqual(objList[0].members[0], 'M0=0');
      assert.strictEqual(objList[0].members[1], 'M1=1');
      assert.strictEqual(objList[0].members[2], 'M2=2');
      ...
      assert.ok(
        elapsed < PARSE_TOTAL_MS,
        `c_enum_0189 总耗时 ${elapsed}ms 超过阈值 ${PARSE_TOTAL_MS}ms（次数 ${localLoop}）`
      );
    } catch (err) {
      assert.fail(`c_enum_0189 执行异常: ${String(err)}`);
    }
  });

  /**
  * @tc.number c_enum_0190
  * @tc.name c_enum_0190
  * @tc.desc h2dts parseEnum：扩充-矩阵：42 成员（字符串赋值） 的解析结果与性能。
  * @tc.size MediumTest
  * @tc.type Function
  * @tc.level Level 1
  */
  test('c_enum_0190', () => {
    ...
    M41 = "v41"
      ...
      assert.ok(objList);
      assert.strictEqual(objList.length, 1);
      assert.strictEqual(objList[0].name, 'En42F2');
      assert.strictEqual(objList[0].alias, 'En42F2');
      assert.strictEqual(objList[0].members.length, 42);
      assert.strictEqual(objList[0].members[0], 'M0="v0"');
      assert.strictEqual(objList[0].members[1], 'M1="v1"');
      assert.strictEqual(objList[0].members[2], 'M2="v2"');
      ...
      assert.ok(
        elapsed < PARSE_TOTAL_MS,
        `c_enum_0190 总耗时 ${elapsed}ms 超过阈值 ${PARSE_TOTAL_MS}ms（次数 ${localLoop}）`
      );
    } catch (err) {
      assert.fail(`c_enum_0190 执行异常: ${String(err)}`);
    }
  });

  /**
  * @tc.number c_enum_0191
  * @tc.name c_enum_0191
  * @tc.desc h2dts parseEnum：扩充-矩阵：42 成员（十六进制赋值） 的解析结果与性能。
  * @tc.size MediumTest
  * @tc.type Function
  * @tc.level Level 1
  */
  test('c_enum_0191', () => {
    ...
    M41 = 0x2A
      ...
      assert.ok(objList);
      assert.strictEqual(objList.length, 1);
      assert.strictEqual(objList[0].name, 'En42F3');
      assert.strictEqual(objList[0].alias, 'En42F3');
      assert.strictEqual(objList[0].members.length, 42);
      assert.strictEqual(objList[0].members[0], 'M0=0x1');
      assert.strictEqual(objList[0].members[1], 'M1=0x2');
      assert.strictEqual(objList[0].members[2], 'M2=0x3');
      ...
      assert.ok(
        elapsed < PARSE_TOTAL_MS,
        `c_enum_0191 总耗时 ${elapsed}ms 超过阈值 ${PARSE_TOTAL_MS}ms（次数 ${localLoop}）`
      );
    } catch (err) {
      assert.fail(`c_enum_0191 执行异常: ${String(err)}`);
    }
  });

  /**
  * @tc.number c_enum_0192
  * @tc.name c_enum_0192
  * @tc.desc h2dts parseEnum：扩充-矩阵：43 成员（无赋值） 的解析结果与性能。
  * @tc.size MediumTest
  * @tc.type Function
  * @tc.level Level 1
  */
  test('c_enum_0192', () => {
    ...
    M42
      ...
      assert.ok(objList);
      assert.strictEqual(objList.length, 1);
      assert.strictEqual(objList[0].name, 'En43F0');
      assert.strictEqual(objList[0].alias, 'En43F0');
      assert.strictEqual(objList[0].members.length, 43);
      assert.strictEqual(objList[0].members[0], 'M0');
      assert.strictEqual(objList[0].members[1], 'M1');
      assert.strictEqual(objList[0].members[2], 'M2');
      assert.strictEqual(objList[0].members[3], 'M3');
      ...
      assert.ok(
        elapsed < PARSE_TOTAL_MS,
        `c_enum_0192 总耗时 ${elapsed}ms 超过阈值 ${PARSE_TOTAL_MS}ms（次数 ${localLoop}）`
      );
    } catch (err) {
      assert.fail(`c_enum_0192 执行异常: ${String(err)}`);
    }
  });

  /**
  * @tc.number c_enum_0193
  * @tc.name c_enum_0193
  * @tc.desc h2dts parseEnum：扩充-矩阵：43 成员（数字赋值） 的解析结果与性能。
  * @tc.size MediumTest
  * @tc.type Function
  * @tc.level Level 1
  */
  test('c_enum_0193', () => {
    ...
    M42 = 42
      ...
      assert.ok(objList);
      assert.strictEqual(objList.length, 1);
      assert.strictEqual(objList[0].name, 'En43F1');
      assert.strictEqual(objList[0].alias, 'En43F1');
      assert.strictEqual(objList[0].members.length, 43);
      assert.strictEqual(objList[0].members[0], 'M0=0');
      assert.strictEqual(objList[0].members[1], 'M1=1');
      assert.strictEqual(objList[0].members[2], 'M2=2');
      ...
      assert.ok(
        elapsed < PARSE_TOTAL_MS,
        `c_enum_0193 总耗时 ${elapsed}ms 超过阈值 ${PARSE_TOTAL_MS}ms（次数 ${localLoop}）`
      );
    } catch (err) {
      assert.fail(`c_enum_0193 执行异常: ${String(err)}`);
    }
  });

  /**
  * @tc.number c_enum_0194
  * @tc.name c_enum_0194
  * @tc.desc h2dts parseEnum：扩充-矩阵：43 成员（字符串赋值） 的解析结果与性能。
  * @tc.size MediumTest
  * @tc.type Function
  * @tc.level Level 1
  */
  test('c_enum_0194', () => {
    ...
    M42 = "v42"
      ...
      assert.ok(objList);
      assert.strictEqual(objList.length, 1);
      assert.strictEqual(objList[0].name, 'En43F2');
      assert.strictEqual(objList[0].alias, 'En43F2');
      assert.strictEqual(objList[0].members.length, 43);
      assert.strictEqual(objList[0].members[0], 'M0="v0"');
      assert.strictEqual(objList[0].members[1], 'M1="v1"');
      assert.strictEqual(objList[0].members[2], 'M2="v2"');
      ...
      assert.ok(
        elapsed < PARSE_TOTAL_MS,
        `c_enum_0194 总耗时 ${elapsed}ms 超过阈值 ${PARSE_TOTAL_MS}ms（次数 ${localLoop}）`
      );
    } catch (err) {
      assert.fail(`c_enum_0194 执行异常: ${String(err)}`);
    }
  });

  /**
  * @tc.number c_enum_0195
  * @tc.name c_enum_0195
  * @tc.desc h2dts parseEnum：扩充-矩阵：43 成员（十六进制赋值） 的解析结果与性能。
  * @tc.size MediumTest
  * @tc.type Function
  * @tc.level Level 1
  */
  test('c_enum_0195', () => {
    ...
    M42 = 0x2B
      ...
      assert.ok(objList);
      assert.strictEqual(objList.length, 1);
      assert.strictEqual(objList[0].name, 'En43F3');
      assert.strictEqual(objList[0].alias, 'En43F3');
      assert.strictEqual(objList[0].members.length, 43);
      assert.strictEqual(objList[0].members[0], 'M0=0x1');
      assert.strictEqual(objList[0].members[1], 'M1=0x2');
      assert.strictEqual(objList[0].members[2], 'M2=0x3');
      ...
      assert.ok(
        elapsed < PARSE_TOTAL_MS,
        `c_enum_0195 总耗时 ${elapsed}ms 超过阈值 ${PARSE_TOTAL_MS}ms（次数 ${localLoop}）`
      );
    } catch (err) {
      assert.fail(`c_enum_0195 执行异常: ${String(err)}`);
    }
  });
