...
suite('Performance_DTS2CPP_Enum_Suite', function ()
{
  ...
  /**
  * @tc.number dts2cpp_enum_0197
  * @tc.name dts2cpp_enum_0197
  * @tc.desc dts2cpp enum 扩充-矩阵：24 成员 enum（全部十六进制赋值） 的解析结果与性能。
  * @tc.size MediumTest
  * @tc.type Function
  * @tc.level Level 1
  */
  test('dts2cpp_enum_0197', () => {
    try {
      ...
      const enumItem_0 = parseObj.enums.find(item => item.name === 'EnumC24F3');
      ...
      assert.ok(
        ...
        `dts2cpp_enum_0197 总耗时 ${elapsed}ms 超过阈值 ${PARSE_TOTAL_MS}ms（次数 ${localLoop}）`
      );
    } catch (err) {
      assert.fail(`dts2cpp_enum_0197 执行异常: ${String(err)}`);
    }
  });

  /**
  * @tc.number dts2cpp_enum_0198
  * @tc.name dts2cpp_enum_0198
  * @tc.desc dts2cpp enum 扩充-矩阵：24 成员 enum（全部位运算赋值） 的解析结果与性能。
  * @tc.size MediumTest
  * @tc.type Function
  * @tc.level Level 1
  */
  test('dts2cpp_enum_0198', () => {
    try {
      let parseObj: ParseObj | undefined;
      const localLoop = PARSE_LOOP;
      const elapsed = measureElapsed(() => {
      ...
      assert.ok(parseObj.enums);
      assert.strictEqual(parseObj.enums.length, 1);
      const enumItem_0 = parseObj.enums.find(item => item.name === 'EnumC24F4');
      assert.ok(enumItem_0);
      assert.strictEqual(enumItem_0!.members!.length, 24);
      assert.strictEqual(enumItem_0!.members![0], 'M0');
      assert.strictEqual(enumItem_0!.members![1], 'M1');
      ...
      assert.ok(
        elapsed < PARSE_TOTAL_MS,
        `dts2cpp_enum_0198 总耗时 ${elapsed}ms 超过阈值 ${PARSE_TOTAL_MS}ms（次数 ${localLoop}）`
      );
    } catch (err) {
      assert.fail(`dts2cpp_enum_0198 执行异常: ${String(err)}`);
    }
  });

  /**
  * @tc.number dts2cpp_enum_0199
  * @tc.name dts2cpp_enum_0199
  * @tc.desc dts2cpp enum 扩充-矩阵：24 成员 enum（奇偶数字/字符串混合赋值） 的解析结果与性能。
  * @tc.size MediumTest
  * @tc.type Function
  * @tc.level Level 1
  */
  test('dts2cpp_enum_0199', () => {
    try {
      let parseObj: ParseObj | undefined;
      const localLoop = PARSE_LOOP;
      const elapsed = measureElapsed(() => {
      ...
      assert.ok(parseObj.enums);
      assert.strictEqual(parseObj.enums.length, 1);
      const enumItem_0 = parseObj.enums.find(item => item.name === 'EnumC24F5');
      assert.ok(enumItem_0);
      assert.strictEqual(enumItem_0!.members!.length, 24);
      assert.strictEqual(enumItem_0!.members![0], 'M0');
      assert.strictEqual(enumItem_0!.members![1], 'M1');
      ...
      assert.ok(
        elapsed < PARSE_TOTAL_MS,
        `dts2cpp_enum_0199 总耗时 ${elapsed}ms 超过阈值 ${PARSE_TOTAL_MS}ms（次数 ${localLoop}）`
      );
    } catch (err) {
      assert.fail(`dts2cpp_enum_0199 执行异常: ${String(err)}`);
    }
  });

  /**
  * @tc.number dts2cpp_enum_0200
  * @tc.name dts2cpp_enum_0200
  * @tc.desc dts2cpp enum 扩充-矩阵：25 成员 enum（无赋值） 的解析结果与性能。
  * @tc.size MediumTest
  * @tc.type Function
  * @tc.level Level 1
  */
  test('dts2cpp_enum_0200', () => {
    try {
      let parseObj: ParseObj | undefined;
      const localLoop = PARSE_LOOP;
      const elapsed = measureElapsed(() => {
      ...
      assert.ok(parseObj.enums);
      assert.strictEqual(parseObj.enums.length, 1);
      const enumItem_0 = parseObj.enums.find(item => item.name === 'EnumC25F0');
      assert.ok(enumItem_0);
      assert.strictEqual(enumItem_0!.members!.length, 25);
      assert.strictEqual(enumItem_0!.members![0], 'M0');
      assert.strictEqual(enumItem_0!.members![1], 'M1');
      assert.strictEqual(enumItem_0!.members![2], 'M2');
      assert.strictEqual(enumItem_0!.members![3], 'M3');
      ...
      assert.ok(
        elapsed < PARSE_TOTAL_MS,
        `dts2cpp_enum_0200 总耗时 ${elapsed}ms 超过阈值 ${PARSE_TOTAL_MS}ms（次数 ${localLoop}）`
      );
    } catch (err) {
      assert.fail(`dts2cpp_enum_0200 执行异常: ${String(err)}`);
    }
  });

  /**
  * @tc.number dts2cpp_enum_0201
  * @tc.name dts2cpp_enum_0201
  * @tc.desc dts2cpp enum 扩充-矩阵：25 成员 enum（全部数字赋值） 的解析结果与性能。
  * @tc.size MediumTest
  * @tc.type Function
  * @tc.level Level 1
  */
  test('dts2cpp_enum_0201', () => {
    try {
      let parseObj: ParseObj | undefined;
      const localLoop = PARSE_LOOP;
      const elapsed = measureElapsed(() => {
      ...
      assert.ok(parseObj.enums);
      assert.strictEqual(parseObj.enums.length, 1);
      const enumItem_0 = parseObj.enums.find(item => item.name === 'EnumC25F1');
      assert.ok(enumItem_0);
      assert.strictEqual(enumItem_0!.members!.length, 25);
      assert.strictEqual(enumItem_0!.members![0], 'M0');
      assert.strictEqual(enumItem_0!.members![1], 'M1');
      ...
      assert.strictEqual(enumItem_0!.members![23], 'M23');
      assert.strictEqual(enumItem_0!.members![24], 'M24');
      assert.strictEqual(enumItem_0!.values!.length, 25);
      assert.strictEqual(enumItem_0!.values![0], '0');
      assert.strictEqual(enumItem_0!.values![1], '1');
      ...
      assert.ok(
        elapsed < PARSE_TOTAL_MS,
        `dts2cpp_enum_0201 总耗时 ${elapsed}ms 超过阈值 ${PARSE_TOTAL_MS}ms（次数 ${localLoop}）`
      );
    } catch (err) {
      assert.fail(`dts2cpp_enum_0201 执行异常: ${String(err)}`);
    }
  });

  /**
  * @tc.number dts2cpp_enum_0202
  * @tc.name dts2cpp_enum_0202
  * @tc.desc dts2cpp enum 扩充-矩阵：25 成员 enum（全部字符串赋值） 的解析结果与性能。
  * @tc.size MediumTest
  * @tc.type Function
  * @tc.level Level 1
  */
  test('dts2cpp_enum_0202', () => {
    try {
      let parseObj: ParseObj | undefined;
      const localLoop = PARSE_LOOP;
      const elapsed = measureElapsed(() => {
      ...
      assert.ok(parseObj.enums);
      assert.strictEqual(parseObj.enums.length, 1);
      const enumItem_0 = parseObj.enums.find(item => item.name === 'EnumC25F2');
      assert.ok(enumItem_0);
      assert.strictEqual(enumItem_0!.members!.length, 25);
      assert.strictEqual(enumItem_0!.members![0], 'M0');
      assert.strictEqual(enumItem_0!.members![1], 'M1');
      ...
      assert.ok(
        elapsed < PARSE_TOTAL_MS,
        `dts2cpp_enum_0202 总耗时 ${elapsed}ms 超过阈值 ${PARSE_TOTAL_MS}ms（次数 ${localLoop}）`
      );
    } catch (err) {
      assert.fail(`dts2cpp_enum_0202 执行异常: ${String(err)}`);
    }
  });

  /**
  * @tc.number dts2cpp_enum_0203
  * @tc.name dts2cpp_enum_0203
  * @tc.desc dts2cpp enum 扩充-矩阵：25 成员 enum（全部十六进制赋值） 的解析结果与性能。
  * @tc.size MediumTest
  * @tc.type Function
  * @tc.level Level 1
  */
  test('dts2cpp_enum_0203', () => {
    try {
      let parseObj: ParseObj | undefined;
      const localLoop = PARSE_LOOP;
      const elapsed = measureElapsed(() => {
      ...
      assert.ok(parseObj.enums);
      assert.strictEqual(parseObj.enums.length, 1);
      const enumItem_0 = parseObj.enums.find(item => item.name === 'EnumC25F3');
      assert.ok(enumItem_0);
      assert.strictEqual(enumItem_0!.members!.length, 25);
      assert.strictEqual(enumItem_0!.members![0], 'M0');
      assert.strictEqual(enumItem_0!.members![1], 'M1');
      ...
      assert.ok(
        elapsed < PARSE_TOTAL_MS,
        `dts2cpp_enum_0203 总耗时 ${elapsed}ms 超过阈值 ${PARSE_TOTAL_MS}ms（次数 ${localLoop}）`
      );
    } catch (err) {
      assert.fail(`dts2cpp_enum_0203 执行异常: ${String(err)}`);
    }
  });

  /**
  * @tc.number dts2cpp_enum_0204
  * @tc.name dts2cpp_enum_0204
  * @tc.desc dts2cpp enum 扩充-矩阵：25 成员 enum（全部位运算赋值） 的解析结果与性能。
  * @tc.size MediumTest
  * @tc.type Function
  * @tc.level Level 1
  */
  test('dts2cpp_enum_0204', () => {
    try {
      let parseObj: ParseObj | undefined;
      const localLoop = PARSE_LOOP;
      const elapsed = measureElapsed(() => {
      ...
      assert.ok(parseObj.enums);
      assert.strictEqual(parseObj.enums.length, 1);
      const enumItem_0 = parseObj.enums.find(item => item.name === 'EnumC25F4');
      assert.ok(enumItem_0);
      assert.strictEqual(enumItem_0!.members!.length, 25);
      assert.strictEqual(enumItem_0!.members![0], 'M0');
      assert.strictEqual(enumItem_0!.members![1], 'M1');
      ...
      assert.ok(
        elapsed < PARSE_TOTAL_MS,
        `dts2cpp_enum_0204 总耗时 ${elapsed}ms 超过阈值 ${PARSE_TOTAL_MS}ms（次数 ${localLoop}）`
      );
    } catch (err) {
      assert.fail(`dts2cpp_enum_0204 执行异常: ${String(err)}`);
    }
  });

  /**
  * @tc.number dts2cpp_enum_0205
  * @tc.name dts2cpp_enum_0205
  * @tc.desc dts2cpp enum 扩充-矩阵：25 成员 enum（奇偶数字/字符串混合赋值） 的解析结果与性能。
  * @tc.size MediumTest
  * @tc.type Function
  * @tc.level Level 1
  */
  test('dts2cpp_enum_0205', () => {
    try {
      let parseObj: ParseObj | undefined;
      const localLoop = PARSE_LOOP;
      const elapsed = measureElapsed(() => {
      ...
      assert.ok(parseObj.enums);
      assert.strictEqual(parseObj.enums.length, 1);
      const enumItem_0 = parseObj.enums.find(item => item.name === 'EnumC25F5');
      assert.ok(enumItem_0);
      assert.strictEqual(enumItem_0!.members!.length, 25);
      assert.strictEqual(enumItem_0!.members![0], 'M0');
      assert.strictEqual(enumItem_0!.members![1], 'M1');
      ...
      assert.ok(
        elapsed < PARSE_TOTAL_MS,
        `dts2cpp_enum_0205 总耗时 ${elapsed}ms 超过阈值 ${PARSE_TOTAL_MS}ms（次数 ${localLoop}）`
      );
    } catch (err) {
      assert.fail(`dts2cpp_enum_0205 执行异常: ${String(err)}`);
    }
  });

  /**
  * @tc.number dts2cpp_enum_0206
  * @tc.name dts2cpp_enum_0206
  * @tc.desc dts2cpp enum 扩充-矩阵：26 成员 enum（无赋值） 的解析结果与性能。
  * @tc.size MediumTest
  * @tc.type Function
  * @tc.level Level 1
  */
  test('dts2cpp_enum_0206', () => {
    try {
      let parseObj: ParseObj | undefined;
      const localLoop = PARSE_LOOP;
      const elapsed = measureElapsed(() => {
      ...
      assert.ok(parseObj.enums);
      assert.strictEqual(parseObj.enums.length, 1);
      const enumItem_0 = parseObj.enums.find(item => item.name === 'EnumC26F0');
      assert.ok(enumItem_0);
      assert.strictEqual(enumItem_0!.members!.length, 26);
      assert.strictEqual(enumItem_0!.members![0], 'M0');
      assert.strictEqual(enumItem_0!.members![1], 'M1');
      assert.strictEqual(enumItem_0!.members![2], 'M2');
      assert.strictEqual(enumItem_0!.members![3], 'M3');
      ...
      assert.ok(
        elapsed < PARSE_TOTAL_MS,
        `dts2cpp_enum_0206 总耗时 ${elapsed}ms 超过阈值 ${PARSE_TOTAL_MS}ms（次数 ${localLoop}）`
      );
    } catch (err) {
      assert.fail(`dts2cpp_enum_0206 执行异常: ${String(err)}`);
    }
  });

  /**
  * @tc.number dts2cpp_enum_0207
  * @tc.name dts2cpp_enum_0207
  * @tc.desc dts2cpp enum 扩充-矩阵：26 成员 enum（全部数字赋值） 的解析结果与性能。
  * @tc.size MediumTest
  * @tc.type Function
  * @tc.level Level 1
  */
  test('dts2cpp_enum_0207', () => {
    try {
      let parseObj: ParseObj | undefined;
      const localLoop = PARSE_LOOP;
      const elapsed = measureElapsed(() => {
      ...
      assert.ok(parseObj.enums);
      assert.strictEqual(parseObj.enums.length, 1);
      const enumItem_0 = parseObj.enums.find(item => item.name === 'EnumC26F1');
      assert.ok(enumItem_0);
      assert.strictEqual(enumItem_0!.members!.length, 26);
      assert.strictEqual(enumItem_0!.members![0], 'M0');
      assert.strictEqual(enumItem_0!.members![1], 'M1');
      ...
      assert.strictEqual(enumItem_0!.members![24], 'M24');
      assert.strictEqual(enumItem_0!.members![25], 'M25');
      assert.strictEqual(enumItem_0!.values!.length, 26);
      assert.strictEqual(enumItem_0!.values![0], '0');
      assert.strictEqual(enumItem_0!.values![1], '1');
      assert.strictEqual(enumItem_0!.values![2], '2');
      assert.strictEqual(enumItem_0!.values![3], '3');
      ...
      assert.ok(
        elapsed < PARSE_TOTAL_MS,
        `dts2cpp_enum_0207 总耗时 ${elapsed}ms 超过阈值 ${PARSE_TOTAL_MS}ms（次数 ${localLoop}）`
      );
    } catch (err) {
      assert.fail(`dts2cpp_enum_0207 执行异常: ${String(err)}`);
    }
  });

  /**
  * @tc.number dts2cpp_enum_0208
  * @tc.name dts2cpp_enum_0208
  * @tc.desc dts2cpp enum 扩充-矩阵：26 成员 enum（全部字符串赋值） 的解析结果与性能。
  * @tc.size MediumTest
  * @tc.type Function
  * @tc.level Level 1
  */
  test('dts2cpp_enum_0208', () => {
    try {
      let parseObj: ParseObj | undefined;
      const localLoop = PARSE_LOOP;
      const elapsed = measureElapsed(() => {
      ...
      assert.ok(parseObj.enums);
      assert.strictEqual(parseObj.enums.length, 1);
      const enumItem_0 = parseObj.enums.find(item => item.name === 'EnumC26F2');
      assert.ok(enumItem_0);
      assert.strictEqual(enumItem_0!.members!.length, 26);
      assert.strictEqual(enumItem_0!.members![0], 'M0');
      assert.strictEqual(enumItem_0!.members![1], 'M1');
      ...
      assert.ok(
        elapsed < PARSE_TOTAL_MS,
        `dts2cpp_enum_0208 总耗时 ${elapsed}ms 超过阈值 ${PARSE_TOTAL_MS}ms（次数 ${localLoop}）`
      );
    } catch (err) {
      assert.fail(`dts2cpp_enum_0208 执行异常: ${String(err)}`);
    }
  });

  /**
  * @tc.number dts2cpp_enum_0209
  * @tc.name dts2cpp_enum_0209
  * @tc.desc dts2cpp enum 扩充-矩阵：26 成员 enum（全部十六进制赋值） 的解析结果与性能。
  * @tc.size MediumTest
  * @tc.type Function
  * @tc.level Level 1
  */
  test('dts2cpp_enum_0209', () => {
    try {
      let parseObj: ParseObj | undefined;
      const localLoop = PARSE_LOOP;
      const elapsed = measureElapsed(() => {
      ...
      assert.ok(parseObj.enums);
      assert.strictEqual(parseObj.enums.length, 1);
      const enumItem_0 = parseObj.enums.find(item => item.name === 'EnumC26F3');
      assert.ok(enumItem_0);
      assert.strictEqual(enumItem_0!.members!.length, 26);
      assert.strictEqual(enumItem_0!.members![0], 'M0');
      assert.strictEqual(enumItem_0!.members![1], 'M1');
      ...
      assert.ok(
        elapsed < PARSE_TOTAL_MS,
        `dts2cpp_enum_0209 总耗时 ${elapsed}ms 超过阈值 ${PARSE_TOTAL_MS}ms（次数 ${localLoop}）`
      );
    } catch (err) {
      assert.fail(`dts2cpp_enum_0209 执行异常: ${String(err)}`);
    }
  });

  /**
  * @tc.number dts2cpp_enum_0210
  * @tc.name dts2cpp_enum_0210
  * @tc.desc dts2cpp enum 扩充-矩阵：26 成员 enum（全部位运算赋值） 的解析结果与性能。
  * @tc.size MediumTest
  * @tc.type Function
  * @tc.level Level 1
  */
  test('dts2cpp_enum_0210', () => {
    try {
      let parseObj: ParseObj | undefined;
      const localLoop = PARSE_LOOP;
      const elapsed = measureElapsed(() => {
      ...
      assert.ok(parseObj.enums);
      assert.strictEqual(parseObj.enums.length, 1);
      const enumItem_0 = parseObj.enums.find(item => item.name === 'EnumC26F4');
      assert.ok(enumItem_0);
      assert.strictEqual(enumItem_0!.members!.length, 26);
      assert.strictEqual(enumItem_0!.members![0], 'M0');
      assert.strictEqual(enumItem_0!.members![1], 'M1');
      ...
      assert.ok(
        elapsed < PARSE_TOTAL_MS,
        `dts2cpp_enum_0210 总耗时 ${elapsed}ms 超过阈值 ${PARSE_TOTAL_MS}ms（次数 ${localLoop}）`
      );
    } catch (err) {
      assert.fail(`dts2cpp_enum_0210 执行异常: ${String(err)}`);
    }
  });

  /**
  * @tc.number dts2cpp_enum_0211
  * @tc.name dts2cpp_enum_0211
  * @tc.desc dts2cpp enum 扩充-矩阵：26 成员 enum（奇偶数字/字符串混合赋值） 的解析结果与性能。
  * @tc.size MediumTest
  * @tc.type Function
  * @tc.level Level 1
  */
  test('dts2cpp_enum_0211', () => {
    try {
      let parseObj: ParseObj | undefined;
      const localLoop = PARSE_LOOP;
      const elapsed = measureElapsed(() => {
      ...
      assert.ok(parseObj.enums);
      assert.strictEqual(parseObj.enums.length, 1);
      const enumItem_0 = parseObj.enums.find(item => item.name === 'EnumC26F5');
      assert.ok(enumItem_0);
      assert.strictEqual(enumItem_0!.members!.length, 26);
      assert.strictEqual(enumItem_0!.members![0], 'M0');
      assert.strictEqual(enumItem_0!.members![1], 'M1');
      ...
      assert.ok(
        elapsed < PARSE_TOTAL_MS,
        `dts2cpp_enum_0211 总耗时 ${elapsed}ms 超过阈值 ${PARSE_TOTAL_MS}ms（次数 ${localLoop}）`
      );
    } catch (err) {
      assert.fail(`dts2cpp_enum_0211 执行异常: ${String(err)}`);
    }
  });

  /**
  * @tc.number dts2cpp_enum_0212
  * @tc.name dts2cpp_enum_0212
  * @tc.desc dts2cpp enum 扩充-矩阵：27 成员 enum（无赋值） 的解析结果与性能。
  * @tc.size MediumTest
  * @tc.type Function
  * @tc.level Level 1
  */
  test('dts2cpp_enum_0212', () => {
    try {
      let parseObj: ParseObj | undefined;
      const localLoop = PARSE_LOOP;
      const elapsed = measureElapsed(() => {
      ...
      assert.ok(parseObj.enums);
      assert.strictEqual(parseObj.enums.length, 1);
      const enumItem_0 = parseObj.enums.find(item => item.name === 'EnumC27F0');
      assert.ok(enumItem_0);
      ...
      assert.ok(
        elapsed < PARSE_TOTAL_MS,
        `dts2cpp_enum_0212 总耗时 ${elapsed}ms 超过阈值 ${PARSE_TOTAL_MS}ms（次数 ${localLoop}）`
      );
    } catch (err) {
      assert.fail(`dts2cpp_enum_0212 执行异常: ${String(err)}`);
    }
  });

  /**
  * @tc.number dts2cpp_enum_0213
  * @tc.name dts2cpp_enum_0213
  * @tc.desc dts2cpp enum 扩充-矩阵：27 成员 enum（全部数字赋值） 的解析结果与性能。
  * @tc.size MediumTest
  * @tc.type Function
  * @tc.level Level 1
  */
  test('dts2cpp_enum_0213', () => {
    try {
      let parseObj: ParseObj | undefined;
      const localLoop = PARSE_LOOP;
      const elapsed = measureElapsed(() => {
      ...
      assert.ok(parseObj.enums);
      assert.strictEqual(parseObj.enums.length, 1);
      const enumItem_0 = parseObj.enums.find(item => item.name === 'EnumC27F1');
      assert.ok(enumItem_0);
      assert.strictEqual(enumItem_0!.members!.length, 27);
      assert.strictEqual(enumItem_0!.members![0], 'M0');
      assert.strictEqual(enumItem_0!.members![1], 'M1');
      ...
      assert.ok(
        elapsed < PARSE_TOTAL_MS,
        `dts2cpp_enum_0213 总耗时 ${elapsed}ms 超过阈值 ${PARSE_TOTAL_MS}ms（次数 ${localLoop}）`
      );
    } catch (err) {
      assert.fail(`dts2cpp_enum_0213 执行异常: ${String(err)}`);
    }
  });
