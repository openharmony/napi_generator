...
suite('Performance_DTS2CPP_Enum_Suite', function ()
{
  ...
  /**
  * @tc.number dts2cpp_enum_0266
  * @tc.name dts2cpp_enum_0266
  * @tc.desc dts2cpp enum 扩充-矩阵：36 成员 enum（无赋值） 的解析结果与性能。
  * @tc.size MediumTest
  * @tc.type Function
  * @tc.level Level 1
  */
  test('dts2cpp_enum_0266', () => {
    try {
      ...
      const enumItem_0 = parseObj.enums.find(item => item.name === 'EnumC36F0');
      assert.ok(enumItem_0);
      assert.strictEqual(enumItem_0!.members!.length, 36);
      ...
      assert.ok(
        ...
        `dts2cpp_enum_0266 总耗时 ${elapsed}ms 超过阈值 ${PARSE_TOTAL_MS}ms（次数 ${localLoop}）`
      );
    } catch (err) {
      assert.fail(`dts2cpp_enum_0266 执行异常: ${String(err)}`);
    }
  });

  /**
  * @tc.number dts2cpp_enum_0267
  * @tc.name dts2cpp_enum_0267
  * @tc.desc dts2cpp enum 扩充-矩阵：36 成员 enum（全部数字赋值） 的解析结果与性能。
  * @tc.size MediumTest
  * @tc.type Function
  * @tc.level Level 1
  */
  test('dts2cpp_enum_0267', () => {
    try {
      let parseObj: ParseObj | undefined;
      const localLoop = PARSE_LOOP;
      const elapsed = measureElapsed(() => {
      ...
      assert.ok(parseObj.enums);
      assert.strictEqual(parseObj.enums.length, 1);
      const enumItem_0 = parseObj.enums.find(item => item.name === 'EnumC36F1');
      assert.ok(enumItem_0);
      assert.strictEqual(enumItem_0!.members!.length, 36);
      assert.strictEqual(enumItem_0!.members![0], 'M0');
      assert.strictEqual(enumItem_0!.members![1], 'M1');
      ...
      assert.strictEqual(enumItem_0!.members![34], 'M34');
      assert.strictEqual(enumItem_0!.members![35], 'M35');
      assert.strictEqual(enumItem_0!.values!.length, 36);
      ...
      assert.ok(
        elapsed < PARSE_TOTAL_MS,
        `dts2cpp_enum_0267 总耗时 ${elapsed}ms 超过阈值 ${PARSE_TOTAL_MS}ms（次数 ${localLoop}）`
      );
    } catch (err) {
      assert.fail(`dts2cpp_enum_0267 执行异常: ${String(err)}`);
    }
  });

  /**
  * @tc.number dts2cpp_enum_0268
  * @tc.name dts2cpp_enum_0268
  * @tc.desc dts2cpp enum 扩充-矩阵：36 成员 enum（全部字符串赋值） 的解析结果与性能。
  * @tc.size MediumTest
  * @tc.type Function
  * @tc.level Level 1
  */
  test('dts2cpp_enum_0268', () => {
    try {
      let parseObj: ParseObj | undefined;
      const localLoop = PARSE_LOOP;
      const elapsed = measureElapsed(() => {
      ...
      assert.ok(parseObj.enums);
      assert.strictEqual(parseObj.enums.length, 1);
      const enumItem_0 = parseObj.enums.find(item => item.name === 'EnumC36F2');
      assert.ok(enumItem_0);
      assert.strictEqual(enumItem_0!.members!.length, 36);
      assert.strictEqual(enumItem_0!.members![0], 'M0');
      assert.strictEqual(enumItem_0!.members![1], 'M1');
      ...
      assert.ok(
        elapsed < PARSE_TOTAL_MS,
        `dts2cpp_enum_0268 总耗时 ${elapsed}ms 超过阈值 ${PARSE_TOTAL_MS}ms（次数 ${localLoop}）`
      );
    } catch (err) {
      assert.fail(`dts2cpp_enum_0268 执行异常: ${String(err)}`);
    }
  });

  /**
  * @tc.number dts2cpp_enum_0269
  * @tc.name dts2cpp_enum_0269
  * @tc.desc dts2cpp enum 扩充-矩阵：36 成员 enum（全部十六进制赋值） 的解析结果与性能。
  * @tc.size MediumTest
  * @tc.type Function
  * @tc.level Level 1
  */
  test('dts2cpp_enum_0269', () => {
    try {
      let parseObj: ParseObj | undefined;
      const localLoop = PARSE_LOOP;
      const elapsed = measureElapsed(() => {
      ...
      assert.ok(parseObj.enums);
      assert.strictEqual(parseObj.enums.length, 1);
      const enumItem_0 = parseObj.enums.find(item => item.name === 'EnumC36F3');
      assert.ok(enumItem_0);
      assert.strictEqual(enumItem_0!.members!.length, 36);
      assert.strictEqual(enumItem_0!.members![0], 'M0');
      assert.strictEqual(enumItem_0!.members![1], 'M1');
      ...
      assert.ok(
        elapsed < PARSE_TOTAL_MS,
        `dts2cpp_enum_0269 总耗时 ${elapsed}ms 超过阈值 ${PARSE_TOTAL_MS}ms（次数 ${localLoop}）`
      );
    } catch (err) {
      assert.fail(`dts2cpp_enum_0269 执行异常: ${String(err)}`);
    }
  });

  /**
  * @tc.number dts2cpp_enum_0270
  * @tc.name dts2cpp_enum_0270
  * @tc.desc dts2cpp enum 扩充-矩阵：36 成员 enum（全部位运算赋值） 的解析结果与性能。
  * @tc.size MediumTest
  * @tc.type Function
  * @tc.level Level 1
  */
  test('dts2cpp_enum_0270', () => {
    try {
      let parseObj: ParseObj | undefined;
      const localLoop = PARSE_LOOP;
      const elapsed = measureElapsed(() => {
      ...
      assert.ok(parseObj.enums);
      assert.strictEqual(parseObj.enums.length, 1);
      const enumItem_0 = parseObj.enums.find(item => item.name === 'EnumC36F4');
      assert.ok(enumItem_0);
      assert.strictEqual(enumItem_0!.members!.length, 36);
      assert.strictEqual(enumItem_0!.members![0], 'M0');
      assert.strictEqual(enumItem_0!.members![1], 'M1');
      ...
      assert.ok(
        elapsed < PARSE_TOTAL_MS,
        `dts2cpp_enum_0270 总耗时 ${elapsed}ms 超过阈值 ${PARSE_TOTAL_MS}ms（次数 ${localLoop}）`
      );
    } catch (err) {
      assert.fail(`dts2cpp_enum_0270 执行异常: ${String(err)}`);
    }
  });

  /**
  * @tc.number dts2cpp_enum_0271
  * @tc.name dts2cpp_enum_0271
  * @tc.desc dts2cpp enum 扩充-矩阵：36 成员 enum（奇偶数字/字符串混合赋值） 的解析结果与性能。
  * @tc.size MediumTest
  * @tc.type Function
  * @tc.level Level 1
  */
  test('dts2cpp_enum_0271', () => {
    try {
      let parseObj: ParseObj | undefined;
      const localLoop = PARSE_LOOP;
      const elapsed = measureElapsed(() => {
      ...
      assert.ok(parseObj.enums);
      assert.strictEqual(parseObj.enums.length, 1);
      const enumItem_0 = parseObj.enums.find(item => item.name === 'EnumC36F5');
      assert.ok(enumItem_0);
      assert.strictEqual(enumItem_0!.members!.length, 36);
      assert.strictEqual(enumItem_0!.members![0], 'M0');
      assert.strictEqual(enumItem_0!.members![1], 'M1');
      ...
      assert.ok(
        elapsed < PARSE_TOTAL_MS,
        `dts2cpp_enum_0271 总耗时 ${elapsed}ms 超过阈值 ${PARSE_TOTAL_MS}ms（次数 ${localLoop}）`
      );
    } catch (err) {
      assert.fail(`dts2cpp_enum_0271 执行异常: ${String(err)}`);
    }
  });

  /**
  * @tc.number dts2cpp_enum_0272
  * @tc.name dts2cpp_enum_0272
  * @tc.desc dts2cpp enum 扩充-矩阵：37 成员 enum（无赋值） 的解析结果与性能。
  * @tc.size MediumTest
  * @tc.type Function
  * @tc.level Level 1
  */
  test('dts2cpp_enum_0272', () => {
    try {
      let parseObj: ParseObj | undefined;
      const localLoop = PARSE_LOOP;
      const elapsed = measureElapsed(() => {
      ...
      assert.ok(parseObj.enums);
      assert.strictEqual(parseObj.enums.length, 1);
      const enumItem_0 = parseObj.enums.find(item => item.name === 'EnumC37F0');
      assert.ok(enumItem_0);
      assert.strictEqual(enumItem_0!.members!.length, 37);
      assert.strictEqual(enumItem_0!.members![0], 'M0');
      assert.strictEqual(enumItem_0!.members![1], 'M1');
      assert.strictEqual(enumItem_0!.members![2], 'M2');
      assert.strictEqual(enumItem_0!.members![3], 'M3');
      ...
      assert.ok(
        elapsed < PARSE_TOTAL_MS,
        `dts2cpp_enum_0272 总耗时 ${elapsed}ms 超过阈值 ${PARSE_TOTAL_MS}ms（次数 ${localLoop}）`
      );
    } catch (err) {
      assert.fail(`dts2cpp_enum_0272 执行异常: ${String(err)}`);
    }
  });

  /**
  * @tc.number dts2cpp_enum_0273
  * @tc.name dts2cpp_enum_0273
  * @tc.desc dts2cpp enum 扩充-矩阵：37 成员 enum（全部数字赋值） 的解析结果与性能。
  * @tc.size MediumTest
  * @tc.type Function
  * @tc.level Level 1
  */
  test('dts2cpp_enum_0273', () => {
    try {
      let parseObj: ParseObj | undefined;
      const localLoop = PARSE_LOOP;
      const elapsed = measureElapsed(() => {
      ...
      assert.ok(parseObj.enums);
      assert.strictEqual(parseObj.enums.length, 1);
      const enumItem_0 = parseObj.enums.find(item => item.name === 'EnumC37F1');
      assert.ok(enumItem_0);
      assert.strictEqual(enumItem_0!.members!.length, 37);
      assert.strictEqual(enumItem_0!.members![0], 'M0');
      assert.strictEqual(enumItem_0!.members![1], 'M1');
      ...
      assert.strictEqual(enumItem_0!.members![35], 'M35');
      assert.strictEqual(enumItem_0!.members![36], 'M36');
      assert.strictEqual(enumItem_0!.values!.length, 37);
      assert.strictEqual(enumItem_0!.values![0], '0');
      assert.strictEqual(enumItem_0!.values![1], '1');
      assert.strictEqual(enumItem_0!.values![2], '2');
      assert.strictEqual(enumItem_0!.values![3], '3');
      ...
      assert.ok(
        elapsed < PARSE_TOTAL_MS,
        `dts2cpp_enum_0273 总耗时 ${elapsed}ms 超过阈值 ${PARSE_TOTAL_MS}ms（次数 ${localLoop}）`
      );
    } catch (err) {
      assert.fail(`dts2cpp_enum_0273 执行异常: ${String(err)}`);
    }
  });

  /**
  * @tc.number dts2cpp_enum_0274
  * @tc.name dts2cpp_enum_0274
  * @tc.desc dts2cpp enum 扩充-矩阵：37 成员 enum（全部字符串赋值） 的解析结果与性能。
  * @tc.size MediumTest
  * @tc.type Function
  * @tc.level Level 1
  */
  test('dts2cpp_enum_0274', () => {
    try {
      let parseObj: ParseObj | undefined;
      const localLoop = PARSE_LOOP;
      const elapsed = measureElapsed(() => {
      ...
      assert.ok(parseObj.enums);
      assert.strictEqual(parseObj.enums.length, 1);
      const enumItem_0 = parseObj.enums.find(item => item.name === 'EnumC37F2');
      assert.ok(enumItem_0);
      assert.strictEqual(enumItem_0!.members!.length, 37);
      assert.strictEqual(enumItem_0!.members![0], 'M0');
      assert.strictEqual(enumItem_0!.members![1], 'M1');
      ...
      assert.ok(
        elapsed < PARSE_TOTAL_MS,
        `dts2cpp_enum_0274 总耗时 ${elapsed}ms 超过阈值 ${PARSE_TOTAL_MS}ms（次数 ${localLoop}）`
      );
    } catch (err) {
      assert.fail(`dts2cpp_enum_0274 执行异常: ${String(err)}`);
    }
  });

  /**
  * @tc.number dts2cpp_enum_0275
  * @tc.name dts2cpp_enum_0275
  * @tc.desc dts2cpp enum 扩充-矩阵：37 成员 enum（全部十六进制赋值） 的解析结果与性能。
  * @tc.size MediumTest
  * @tc.type Function
  * @tc.level Level 1
  */
  test('dts2cpp_enum_0275', () => {
    try {
      let parseObj: ParseObj | undefined;
      const localLoop = PARSE_LOOP;
      const elapsed = measureElapsed(() => {
      ...
      assert.ok(parseObj.enums);
      assert.strictEqual(parseObj.enums.length, 1);
      const enumItem_0 = parseObj.enums.find(item => item.name === 'EnumC37F3');
      assert.ok(enumItem_0);
      assert.strictEqual(enumItem_0!.members!.length, 37);
      assert.strictEqual(enumItem_0!.members![0], 'M0');
      assert.strictEqual(enumItem_0!.members![1], 'M1');
      ...
      assert.ok(
        elapsed < PARSE_TOTAL_MS,
        `dts2cpp_enum_0275 总耗时 ${elapsed}ms 超过阈值 ${PARSE_TOTAL_MS}ms（次数 ${localLoop}）`
      );
    } catch (err) {
      assert.fail(`dts2cpp_enum_0275 执行异常: ${String(err)}`);
    }
  });

  /**
  * @tc.number dts2cpp_enum_0276
  * @tc.name dts2cpp_enum_0276
  * @tc.desc dts2cpp enum 扩充-矩阵：37 成员 enum（全部位运算赋值） 的解析结果与性能。
  * @tc.size MediumTest
  * @tc.type Function
  * @tc.level Level 1
  */
  test('dts2cpp_enum_0276', () => {
    try {
      let parseObj: ParseObj | undefined;
      const localLoop = PARSE_LOOP;
      const elapsed = measureElapsed(() => {
      ...
      assert.ok(parseObj.enums);
      assert.strictEqual(parseObj.enums.length, 1);
      const enumItem_0 = parseObj.enums.find(item => item.name === 'EnumC37F4');
      assert.ok(enumItem_0);
      assert.strictEqual(enumItem_0!.members!.length, 37);
      assert.strictEqual(enumItem_0!.members![0], 'M0');
      assert.strictEqual(enumItem_0!.members![1], 'M1');
      ...
      assert.ok(
        elapsed < PARSE_TOTAL_MS,
        `dts2cpp_enum_0276 总耗时 ${elapsed}ms 超过阈值 ${PARSE_TOTAL_MS}ms（次数 ${localLoop}）`
      );
    } catch (err) {
      assert.fail(`dts2cpp_enum_0276 执行异常: ${String(err)}`);
    }
  });

  /**
  * @tc.number dts2cpp_enum_0277
  * @tc.name dts2cpp_enum_0277
  * @tc.desc dts2cpp enum 扩充-矩阵：37 成员 enum（奇偶数字/字符串混合赋值） 的解析结果与性能。
  * @tc.size MediumTest
  * @tc.type Function
  * @tc.level Level 1
  */
  test('dts2cpp_enum_0277', () => {
    try {
      let parseObj: ParseObj | undefined;
      const localLoop = PARSE_LOOP;
      const elapsed = measureElapsed(() => {
      ...
      assert.ok(parseObj.enums);
      assert.strictEqual(parseObj.enums.length, 1);
      const enumItem_0 = parseObj.enums.find(item => item.name === 'EnumC37F5');
      assert.ok(enumItem_0);
      assert.strictEqual(enumItem_0!.members!.length, 37);
      assert.strictEqual(enumItem_0!.members![0], 'M0');
      assert.strictEqual(enumItem_0!.members![1], 'M1');
      ...
      assert.ok(
        elapsed < PARSE_TOTAL_MS,
        `dts2cpp_enum_0277 总耗时 ${elapsed}ms 超过阈值 ${PARSE_TOTAL_MS}ms（次数 ${localLoop}）`
      );
    } catch (err) {
      assert.fail(`dts2cpp_enum_0277 执行异常: ${String(err)}`);
    }
  });

  /**
  * @tc.number dts2cpp_enum_0278
  * @tc.name dts2cpp_enum_0278
  * @tc.desc dts2cpp enum 扩充-矩阵：38 成员 enum（无赋值） 的解析结果与性能。
  * @tc.size MediumTest
  * @tc.type Function
  * @tc.level Level 1
  */
  test('dts2cpp_enum_0278', () => {
    try {
      let parseObj: ParseObj | undefined;
      const localLoop = PARSE_LOOP;
      const elapsed = measureElapsed(() => {
      ...
      assert.ok(parseObj.enums);
      assert.strictEqual(parseObj.enums.length, 1);
      const enumItem_0 = parseObj.enums.find(item => item.name === 'EnumC38F0');
      assert.ok(enumItem_0);
      ...
      assert.ok(
        elapsed < PARSE_TOTAL_MS,
        `dts2cpp_enum_0278 总耗时 ${elapsed}ms 超过阈值 ${PARSE_TOTAL_MS}ms（次数 ${localLoop}）`
      );
    } catch (err) {
      assert.fail(`dts2cpp_enum_0278 执行异常: ${String(err)}`);
    }
  });

  /**
  * @tc.number dts2cpp_enum_0279
  * @tc.name dts2cpp_enum_0279
  * @tc.desc dts2cpp enum 扩充-矩阵：38 成员 enum（全部数字赋值） 的解析结果与性能。
  * @tc.size MediumTest
  * @tc.type Function
  * @tc.level Level 1
  */
  test('dts2cpp_enum_0279', () => {
    try {
      let parseObj: ParseObj | undefined;
      const localLoop = PARSE_LOOP;
      const elapsed = measureElapsed(() => {
      ...
      assert.ok(parseObj.enums);
      assert.strictEqual(parseObj.enums.length, 1);
      const enumItem_0 = parseObj.enums.find(item => item.name === 'EnumC38F1');
      assert.ok(enumItem_0);
      assert.strictEqual(enumItem_0!.members!.length, 38);
      assert.strictEqual(enumItem_0!.members![0], 'M0');
      assert.strictEqual(enumItem_0!.members![1], 'M1');
      ...
      assert.ok(
        elapsed < PARSE_TOTAL_MS,
        `dts2cpp_enum_0279 总耗时 ${elapsed}ms 超过阈值 ${PARSE_TOTAL_MS}ms（次数 ${localLoop}）`
      );
    } catch (err) {
      assert.fail(`dts2cpp_enum_0279 执行异常: ${String(err)}`);
    }
  });
