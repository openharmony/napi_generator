...
suite('Stability_DTS2CPP_COMPAT_FUNC_Part03', function() {
  this.timeout(600000);
  vscode.window.showInformationMessage('Start Stability_DTS2CPP_COMPAT_FUNC_Part03.');
  ...
  test('dts2cpp_compat_func_0001', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const parsed = doParseTs('compat37.ts', `function compat37(a: (p0:strng)=>vod): void {}`);
        ...
        assert.strictEqual(converted.funcs[0].parameters[0].type, "std::function<vod(strng)>",
  ...
  test('dts2cpp_compat_func_0002', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const parsed = doParseTs('compat37.ts', `function compat37(a: anny): void {}`);
        assert.ok(parsed !== undefined && parsed !== null && typeof parsed === 'object',
  ...
  test('dts2cpp_compat_func_0003', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const parsed = doParseTs('compat37.ts', `class Compat37 { field: (p0:string)=>void; }`);
        assert.ok(parsed !== undefined && parsed !== null && typeof parsed === 'object',
  ...
  test('dts2cpp_compat_func_0004', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const parsed = doParseTs('compat37.ts', `type Compat37 = { x: (p0:string)=>void; };`);
        assert.ok(parsed !== undefined && parsed !== null && typeof parsed === 'object',
        ...
        assert.strictEqual(converted.types[0].alias, "{ x: (p0:string)=>void; }", "dts2cpp_compat_func_0004_alias");
      });
      assert.ok(finished, 'compat task must finish without process crash');
    } catch (err) {
  ...
  test('dts2cpp_compat_func_0007', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const parsed = doParseTs('compat38.ts', `function compat38(a: numbr): void {}`);
        assert.ok(parsed !== undefined && parsed !== null && typeof parsed === 'object',
  ...
  test('dts2cpp_compat_func_0008', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const parsed = doParseTs('compat38.ts', `function compat38(a: strng): void {}`);
        assert.ok(parsed !== undefined && parsed !== null && typeof parsed === 'object',
  ...
  test('dts2cpp_compat_func_0009', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const parsed = doParseTs('compat38.ts', `function compat38(a: boolea): void {}`);
        assert.ok(parsed !== undefined && parsed !== null && typeof parsed === 'object',
  ...
  test('dts2cpp_compat_func_0010', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const parsed = doParseTs('compat38.ts', `function compat38(a: (p0:boolean)=>void): void {}`);
        assert.ok(parsed !== undefined && parsed !== null && typeof parsed === 'object',
  ...
  test('dts2cpp_compat_func_0011', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const parsed = doParseTs('compat38.ts', `function compat38(a: (p0:boolea)=>vod): void {}`);
        assert.ok(parsed !== undefined && parsed !== null && typeof parsed === 'object',
        ...
        assert.strictEqual(converted.funcs[0].parameters[0].type, "std::function<vod(boolea)>",
  ...
  test('dts2cpp_compat_func_0012', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const parsed = doParseTs('compat38.ts', `function compat38(a: anny): void {}`);
        assert.ok(parsed !== undefined && parsed !== null && typeof parsed === 'object',
  ...
  test('dts2cpp_compat_func_0013', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const parsed = doParseTs('compat38.ts', `class Compat38 { field: (p0:boolean)=>void; }`);
        assert.ok(parsed !== undefined && parsed !== null && typeof parsed === 'object',
  ...
  test('dts2cpp_compat_func_0014', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const parsed = doParseTs('compat38.ts', `type Compat38 = { x: (p0:boolean)=>void; };`);
        assert.ok(parsed !== undefined && parsed !== null && typeof parsed === 'object',
        ...
        assert.strictEqual(converted.types[0].alias, "{ x: (p0:boolean)=>void; }", "dts2cpp_compat_func_0014_alias");
      });
      assert.ok(finished, 'compat task must finish without process crash');
    } catch (err) {
  ...
  test('dts2cpp_compat_func_0017', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const parsed = doParseTs('compat39.ts', `function compat39(a: numbr): void {}`);
        assert.ok(parsed !== undefined && parsed !== null && typeof parsed === 'object',
  ...
  test('dts2cpp_compat_func_0018', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const parsed = doParseTs('compat39.ts', `function compat39(a: strng): void {}`);
        assert.ok(parsed !== undefined && parsed !== null && typeof parsed === 'object',
  ...
  test('dts2cpp_compat_func_0019', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const parsed = doParseTs('compat39.ts', `function compat39(a: boolea): void {}`);
        assert.ok(parsed !== undefined && parsed !== null && typeof parsed === 'object',
  ...
  test('dts2cpp_compat_func_0020', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const parsed = doParseTs('compat39.ts', `function compat39(a: (p0:number,p1:number)=>number): void {}`);
        assert.ok(parsed !== undefined && parsed !== null && typeof parsed === 'object',
  ...
  test('dts2cpp_compat_func_0021', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const parsed = doParseTs('compat39.ts', `function compat39(a: (p0:numbr,p1:numbr)=>numbr): void {}`);
        assert.ok(parsed !== undefined && parsed !== null && typeof parsed === 'object',
        ...
        assert.strictEqual(converted.funcs[0].parameters[0].type, "std::function<numbr(numbr, numbr)>",
  ...
  test('dts2cpp_compat_func_0022', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const parsed = doParseTs('compat39.ts', `function compat39(a: anny): void {}`);
        assert.ok(parsed !== undefined && parsed !== null && typeof parsed === 'object',
  ...
  test('dts2cpp_compat_func_0023', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const parsed = doParseTs('compat39.ts', `class Compat39 { field: (p0:number,p1:number)=>number; }`);
        assert.ok(parsed !== undefined && parsed !== null && typeof parsed === 'object',
  ...
  test('dts2cpp_compat_func_0024', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const parsed = doParseTs('compat39.ts', `type Compat39 = { x: (p0:number,p1:number)=>number; };`);
        assert.ok(parsed !== undefined && parsed !== null && typeof parsed === 'object',
        ...
        assert.strictEqual(converted.types[0].alias, "{ x: (p0:number,p1:number)=>number; }",
          "dts2cpp_compat_func_0024_alias");
      });
      assert.ok(finished, 'compat task must finish without process crash');
    } catch (err) {
  ...
  test('dts2cpp_compat_func_0027', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const parsed = doParseTs('compat40.ts', `function compat40(a: numbr): void {}`);
        assert.ok(parsed !== undefined && parsed !== null && typeof parsed === 'object',
  ...
  test('dts2cpp_compat_func_0028', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const parsed = doParseTs('compat40.ts', `function compat40(a: strng): void {}`);
        assert.ok(parsed !== undefined && parsed !== null && typeof parsed === 'object',
  ...
  test('dts2cpp_compat_func_0029', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const parsed = doParseTs('compat40.ts', `function compat40(a: boolea): void {}`);
        assert.ok(parsed !== undefined && parsed !== null && typeof parsed === 'object',
  ...
  test('dts2cpp_compat_func_0030', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const parsed = doParseTs('compat40.ts', `function compat40(a: (p0:number,p1:boolean)=>number): void {}`);
        assert.ok(parsed !== undefined && parsed !== null && typeof parsed === 'object',
  ...
  test('dts2cpp_compat_func_0031', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const parsed = doParseTs('compat40.ts', `function compat40(a: (p0:numbr,p1:boolea)=>numbr): void {}`);
        assert.ok(parsed !== undefined && parsed !== null && typeof parsed === 'object',
        ...
        assert.strictEqual(converted.funcs[0].parameters[0].type, "std::function<numbr(numbr, boolea)>",
  ...
  test('dts2cpp_compat_func_0032', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const parsed = doParseTs('compat40.ts', `function compat40(a: anny): void {}`);
        assert.ok(parsed !== undefined && parsed !== null && typeof parsed === 'object',
  ...
  test('dts2cpp_compat_func_0033', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const parsed = doParseTs('compat40.ts', `class Compat40 { field: (p0:number,p1:boolean)=>number; }`);
        assert.ok(parsed !== undefined && parsed !== null && typeof parsed === 'object',
  ...
  test('dts2cpp_compat_func_0034', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const parsed = doParseTs('compat40.ts', `type Compat40 = { x: (p0:number,p1:boolean)=>number; };`);
        assert.ok(parsed !== undefined && parsed !== null && typeof parsed === 'object',
        ...
        assert.strictEqual(converted.types[0].alias, "{ x: (p0:number,p1:boolean)=>number; }",
          "dts2cpp_compat_func_0034_alias");
      });
      assert.ok(finished, 'compat task must finish without process crash');
    } catch (err) {
  ...
  test('dts2cpp_compat_func_0037', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const parsed = doParseTs('compat41.ts', `function compat41(a: numbr): void {}`);
        assert.ok(parsed !== undefined && parsed !== null && typeof parsed === 'object',
  ...
  test('dts2cpp_compat_func_0038', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const parsed = doParseTs('compat41.ts', `function compat41(a: strng): void {}`);
        assert.ok(parsed !== undefined && parsed !== null && typeof parsed === 'object',
  ...
  test('dts2cpp_compat_func_0039', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const parsed = doParseTs('compat41.ts', `function compat41(a: boolea): void {}`);
        assert.ok(parsed !== undefined && parsed !== null && typeof parsed === 'object',
  ...
  test('dts2cpp_compat_func_0040', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const parsed = doParseTs('compat41.ts', `function compat41(a: (p0:string,p1:string)=>number): void {}`);
        assert.ok(parsed !== undefined && parsed !== null && typeof parsed === 'object',
  ...
  test('dts2cpp_compat_func_0041', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const parsed = doParseTs('compat41.ts', `function compat41(a: (p0:strng,p1:strng)=>numbr): void {}`);
        assert.ok(parsed !== undefined && parsed !== null && typeof parsed === 'object',
        ...
        assert.strictEqual(converted.funcs[0].parameters[0].type, "std::function<numbr(strng, strng)>",
  ...
  test('dts2cpp_compat_func_0042', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const parsed = doParseTs('compat41.ts', `function compat41(a: anny): void {}`);
        assert.ok(parsed !== undefined && parsed !== null && typeof parsed === 'object',
  ...
  test('dts2cpp_compat_func_0043', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const parsed = doParseTs('compat41.ts', `class Compat41 { field: (p0:string,p1:string)=>number; }`);
        assert.ok(parsed !== undefined && parsed !== null && typeof parsed === 'object',
  ...
  test('dts2cpp_compat_func_0044', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const parsed = doParseTs('compat41.ts', `type Compat41 = { x: (p0:string,p1:string)=>number; };`);
        assert.ok(parsed !== undefined && parsed !== null && typeof parsed === 'object',
        ...
        assert.strictEqual(converted.types[0].alias, "{ x: (p0:string,p1:string)=>number; }",
          "dts2cpp_compat_func_0044_alias");
      });
      assert.ok(finished, 'compat task must finish without process crash');
    } catch (err) {
  ...
  test('dts2cpp_compat_func_0047', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const parsed = doParseTs('compat42.ts', `function compat42(a: numbr): void {}`);
        assert.ok(parsed !== undefined && parsed !== null && typeof parsed === 'object',
  ...
  test('dts2cpp_compat_func_0048', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const parsed = doParseTs('compat42.ts', `function compat42(a: strng): void {}`);
        assert.ok(parsed !== undefined && parsed !== null && typeof parsed === 'object',
  ...
  test('dts2cpp_compat_func_0049', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const parsed = doParseTs('compat42.ts', `function compat42(a: boolea): void {}`);
        assert.ok(parsed !== undefined && parsed !== null && typeof parsed === 'object',
  ...
  test('dts2cpp_compat_func_0050', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const parsed = doParseTs('compat42.ts', `function compat42(a: (p0:boolean,p1:number)=>number): void {}`);
        assert.ok(parsed !== undefined && parsed !== null && typeof parsed === 'object',
  ...
  test('dts2cpp_compat_func_0051', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const parsed = doParseTs('compat42.ts', `function compat42(a: (p0:boolea,p1:numbr)=>numbr): void {}`);
        assert.ok(parsed !== undefined && parsed !== null && typeof parsed === 'object',
        ...
        assert.strictEqual(converted.funcs[0].parameters[0].type, "std::function<numbr(boolea, numbr)>",
  ...
  test('dts2cpp_compat_func_0052', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const parsed = doParseTs('compat42.ts', `function compat42(a: anny): void {}`);
        assert.ok(parsed !== undefined && parsed !== null && typeof parsed === 'object',
  ...
  test('dts2cpp_compat_func_0053', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const parsed = doParseTs('compat42.ts', `class Compat42 { field: (p0:boolean,p1:number)=>number; }`);
        assert.ok(parsed !== undefined && parsed !== null && typeof parsed === 'object',
  ...
  test('dts2cpp_compat_func_0054', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const parsed = doParseTs('compat42.ts', `type Compat42 = { x: (p0:boolean,p1:number)=>number; };`);
        assert.ok(parsed !== undefined && parsed !== null && typeof parsed === 'object',
        ...
        assert.strictEqual(converted.types[0].alias, "{ x: (p0:boolean,p1:number)=>number; }",
          "dts2cpp_compat_func_0054_alias");
      });
      assert.ok(finished, 'compat task must finish without process crash');
    } catch (err) {
  ...
  test('dts2cpp_compat_func_0057', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const parsed = doParseTs('compat43.ts', `function compat43(a: numbr): void {}`);
        assert.ok(parsed !== undefined && parsed !== null && typeof parsed === 'object',
  ...
  test('dts2cpp_compat_func_0058', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const parsed = doParseTs('compat43.ts', `function compat43(a: strng): void {}`);
        assert.ok(parsed !== undefined && parsed !== null && typeof parsed === 'object',
  ...
  test('dts2cpp_compat_func_0059', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const parsed = doParseTs('compat43.ts', `function compat43(a: boolea): void {}`);
        assert.ok(parsed !== undefined && parsed !== null && typeof parsed === 'object',
  ...
  test('dts2cpp_compat_func_0060', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const parsed = doParseTs('compat43.ts', `function compat43(a: (p0:boolean,p1:boolean)=>number): void {}`);
        assert.ok(parsed !== undefined && parsed !== null && typeof parsed === 'object',
  ...
  test('dts2cpp_compat_func_0061', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const parsed = doParseTs('compat43.ts', `function compat43(a: (p0:boolea,p1:boolea)=>numbr): void {}`);
        assert.ok(parsed !== undefined && parsed !== null && typeof parsed === 'object',
        ...
        assert.strictEqual(converted.funcs[0].parameters[0].type, "std::function<numbr(boolea, boolea)>",
  ...
  test('dts2cpp_compat_func_0062', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const parsed = doParseTs('compat43.ts', `function compat43(a: anny): void {}`);
        assert.ok(parsed !== undefined && parsed !== null && typeof parsed === 'object',
  ...
  test('dts2cpp_compat_func_0063', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const parsed = doParseTs('compat43.ts', `class Compat43 { field: (p0:boolean,p1:boolean)=>number; }`);
        assert.ok(parsed !== undefined && parsed !== null && typeof parsed === 'object',
  ...
  test('dts2cpp_compat_func_0064', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const parsed = doParseTs('compat43.ts', `type Compat43 = { x: (p0:boolean,p1:boolean)=>number; };`);
        assert.ok(parsed !== undefined && parsed !== null && typeof parsed === 'object',
        ...
        assert.strictEqual(converted.types[0].alias, "{ x: (p0:boolean,p1:boolean)=>number; }",
          "dts2cpp_compat_func_0064_alias");
      });
      assert.ok(finished, 'compat task must finish without process crash');
    } catch (err) {
  ...
  test('dts2cpp_compat_func_0067', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const parsed = doParseTs('compat44.ts', `function compat44(a: numbr): void {}`);
        assert.ok(parsed !== undefined && parsed !== null && typeof parsed === 'object',
  ...
  test('dts2cpp_compat_func_0068', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const parsed = doParseTs('compat44.ts', `function compat44(a: strng): void {}`);
        assert.ok(parsed !== undefined && parsed !== null && typeof parsed === 'object',
  ...
  test('dts2cpp_compat_func_0069', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const parsed = doParseTs('compat44.ts', `function compat44(a: boolea): void {}`);
        assert.ok(parsed !== undefined && parsed !== null && typeof parsed === 'object',
  ...
  test('dts2cpp_compat_func_0070', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const parsed = doParseTs('compat44.ts', `function compat44(a: (p0:number,p1:number)=>string): void {}`);
        assert.ok(parsed !== undefined && parsed !== null && typeof parsed === 'object',
  ...
  test('dts2cpp_compat_func_0071', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const parsed = doParseTs('compat44.ts', `function compat44(a: (p0:numbr,p1:numbr)=>strng): void {}`);
        assert.ok(parsed !== undefined && parsed !== null && typeof parsed === 'object',
        ...
        assert.strictEqual(converted.funcs[0].parameters[0].type, "std::function<strng(numbr, numbr)>",
  ...
  test('dts2cpp_compat_func_0072', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const parsed = doParseTs('compat44.ts', `function compat44(a: anny): void {}`);
        assert.ok(parsed !== undefined && parsed !== null && typeof parsed === 'object',
  ...
  test('dts2cpp_compat_func_0073', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const parsed = doParseTs('compat44.ts', `class Compat44 { field: (p0:number,p1:number)=>string; }`);
        assert.ok(parsed !== undefined && parsed !== null && typeof parsed === 'object',
  ...
  test('dts2cpp_compat_func_0074', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const parsed = doParseTs('compat44.ts', `type Compat44 = { x: (p0:number,p1:number)=>string; };`);
        assert.ok(parsed !== undefined && parsed !== null && typeof parsed === 'object',
        ...
        assert.strictEqual(converted.types[0].alias, "{ x: (p0:number,p1:number)=>string; }",
          "dts2cpp_compat_func_0074_alias");
      });
      assert.ok(finished, 'compat task must finish without process crash');
    } catch (err) {
  ...
  test('dts2cpp_compat_func_0077', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const parsed = doParseTs('compat45.ts', `function compat45(a: numbr): void {}`);
        assert.ok(parsed !== undefined && parsed !== null && typeof parsed === 'object',
  ...
  test('dts2cpp_compat_func_0078', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const parsed = doParseTs('compat45.ts', `function compat45(a: strng): void {}`);
        assert.ok(parsed !== undefined && parsed !== null && typeof parsed === 'object',
  ...
  test('dts2cpp_compat_func_0079', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const parsed = doParseTs('compat45.ts', `function compat45(a: boolea): void {}`);
        assert.ok(parsed !== undefined && parsed !== null && typeof parsed === 'object',
  ...
  test('dts2cpp_compat_func_0080', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const parsed = doParseTs('compat45.ts', `function compat45(a: (p0:number,p1:boolean)=>string): void {}`);
        assert.ok(parsed !== undefined && parsed !== null && typeof parsed === 'object',
  ...
  test('dts2cpp_compat_func_0081', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const parsed = doParseTs('compat45.ts', `function compat45(a: (p0:numbr,p1:boolea)=>strng): void {}`);
        assert.ok(parsed !== undefined && parsed !== null && typeof parsed === 'object',
        ...
        assert.strictEqual(converted.funcs[0].parameters[0].type, "std::function<strng(numbr, boolea)>",
  ...
  test('dts2cpp_compat_func_0082', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const parsed = doParseTs('compat45.ts', `function compat45(a: anny): void {}`);
        assert.ok(parsed !== undefined && parsed !== null && typeof parsed === 'object',
  ...
  test('dts2cpp_compat_func_0083', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const parsed = doParseTs('compat45.ts', `class Compat45 { field: (p0:number,p1:boolean)=>string; }`);
        assert.ok(parsed !== undefined && parsed !== null && typeof parsed === 'object',
  ...
  test('dts2cpp_compat_func_0084', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const parsed = doParseTs('compat45.ts', `type Compat45 = { x: (p0:number,p1:boolean)=>string; };`);
        assert.ok(parsed !== undefined && parsed !== null && typeof parsed === 'object',
        ...
        assert.strictEqual(converted.types[0].alias, "{ x: (p0:number,p1:boolean)=>string; }",
          "dts2cpp_compat_func_0084_alias");
      });
      assert.ok(finished, 'compat task must finish without process crash');
    } catch (err) {
