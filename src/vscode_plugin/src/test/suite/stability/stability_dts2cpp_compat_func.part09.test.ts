...
suite('Stability_DTS2CPP_COMPAT_FUNC_Part09', function() {
  ...
  test('dts2cpp_compat_func_0001', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const parsed = doParseTs('compat101.ts', `function compat101(a: (p0:any,p1:strng)=>any): void {}`);
  ...
  test('dts2cpp_compat_func_0002', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const parsed = doParseTs('compat101.ts', `function compat101(a: anny): void {}`);
        assert.ok(parsed !== undefined && parsed !== null && typeof parsed === 'object',
  ...
  test('dts2cpp_compat_func_0004', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        ...
        assert.strictEqual(converted.types[0].alias, "{ x: (p0:any,p1:string)=>any; }", "dts2cpp_compat_func_0004_alias");
      });
      assert.ok(finished, 'compat task must finish without process crash');
    } catch (err) {
  ...
  test('dts2cpp_compat_func_0011', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const parsed = doParseTs('compat102.ts', `function compat102(a: (p0:any,p1:boolea)=>any): void {}`);
        assert.ok(parsed !== undefined && parsed !== null && typeof parsed === 'object',
  ...
  test('dts2cpp_compat_func_0012', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const parsed = doParseTs('compat102.ts', `function compat102(a: anny): void {}`);
        assert.ok(parsed !== undefined && parsed !== null && typeof parsed === 'object',
  ...
  test('dts2cpp_compat_func_0014', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        ...
        assert.strictEqual(converted.types[0].alias, "{ x: (p0:any,p1:boolean)=>any; }", "dts2cpp_compat_func_0014_alias");
      });
      assert.ok(finished, 'compat task must finish without process crash');
    } catch (err) {
  ...
  test('dts2cpp_compat_func_0022', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const parsed = doParseTs('compat103.ts', `function compat103(a: anny): void {}`);
        assert.ok(parsed !== undefined && parsed !== null && typeof parsed === 'object',
  ...
  test('dts2cpp_compat_func_0024', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        ...
        assert.strictEqual(converted.types[0].alias, "{ x: (p0:object,p1:any)=>any; }", "dts2cpp_compat_func_0024_alias");
      });
      assert.ok(finished, 'compat task must finish without process crash');
    } catch (err) {
  ...
  test('dts2cpp_compat_func_0031', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const parsed = doParseTs('compat104.ts', `function compat104(a: (p0:object,p1:numbr)=>any): void {}`);
        assert.ok(parsed !== undefined && parsed !== null && typeof parsed === 'object',
  ...
  test('dts2cpp_compat_func_0032', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const parsed = doParseTs('compat104.ts', `function compat104(a: anny): void {}`);
        assert.ok(parsed !== undefined && parsed !== null && typeof parsed === 'object',
  ...
  test('dts2cpp_compat_func_0034', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        ...
        assert.strictEqual(converted.types[0].alias, "{ x: (p0:object,p1:number)=>any; }", "dts2cpp_compat_func_0034_alias");
      });
      assert.ok(finished, 'compat task must finish without process crash');
    } catch (err) {
  ...
  test('dts2cpp_compat_func_0041', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const parsed = doParseTs('compat105.ts', `function compat105(a: (p0:object,p1:strng)=>any): void {}`);
        assert.ok(parsed !== undefined && parsed !== null && typeof parsed === 'object',
  ...
  test('dts2cpp_compat_func_0042', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const parsed = doParseTs('compat105.ts', `function compat105(a: anny): void {}`);
        assert.ok(parsed !== undefined && parsed !== null && typeof parsed === 'object',
  ...
  test('dts2cpp_compat_func_0044', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        ...
        assert.strictEqual(converted.types[0].alias, "{ x: (p0:object,p1:string)=>any; }", "dts2cpp_compat_func_0044_alias");
      });
      assert.ok(finished, 'compat task must finish without process crash');
    } catch (err) {
  ...
  test('dts2cpp_compat_func_0051', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const parsed = doParseTs('compat106.ts', `function compat106(a: (p0:object,p1:boolea)=>any): void {}`);
        assert.ok(parsed !== undefined && parsed !== null && typeof parsed === 'object',
  ...
  test('dts2cpp_compat_func_0052', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const parsed = doParseTs('compat106.ts', `function compat106(a: anny): void {}`);
        assert.ok(parsed !== undefined && parsed !== null && typeof parsed === 'object',
  ...
  test('dts2cpp_compat_func_0054', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        ...
        assert.strictEqual(converted.types[0].alias, "{ x: (p0:object,p1:boolean)=>any; }", "dts2cpp_compat_func_0054_alias");
      });
      assert.ok(finished, 'compat task must finish without process crash');
    } catch (err) {
  ...
  test('dts2cpp_compat_func_0061', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const parsed = doParseTs('compat107.ts', `function compat107(a: (p0:numbr,p1:any)=>any): void {}`);
        assert.ok(parsed !== undefined && parsed !== null && typeof parsed === 'object',
  ...
  test('dts2cpp_compat_func_0062', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const parsed = doParseTs('compat107.ts', `function compat107(a: anny): void {}`);
        assert.ok(parsed !== undefined && parsed !== null && typeof parsed === 'object',
  ...
  test('dts2cpp_compat_func_0064', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        ...
        assert.strictEqual(converted.types[0].alias, "{ x: (p0:number,p1:any)=>any; }", "dts2cpp_compat_func_0064_alias");
      });
      assert.ok(finished, 'compat task must finish without process crash');
    } catch (err) {
  ...
  test('dts2cpp_compat_func_0071', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const parsed = doParseTs('compat108.ts', `function compat108(a: (p0:numbr,p1:object)=>any): void {}`);
        assert.ok(parsed !== undefined && parsed !== null && typeof parsed === 'object',
  ...
  test('dts2cpp_compat_func_0072', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const parsed = doParseTs('compat108.ts', `function compat108(a: anny): void {}`);
        assert.ok(parsed !== undefined && parsed !== null && typeof parsed === 'object',
  ...
  test('dts2cpp_compat_func_0074', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        ...
        assert.strictEqual(converted.types[0].alias, "{ x: (p0:number,p1:object)=>any; }", "dts2cpp_compat_func_0074_alias");
      });
      assert.ok(finished, 'compat task must finish without process crash');
    } catch (err) {
  ...
  test('dts2cpp_compat_func_0081', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const parsed = doParseTs('compat109.ts', `function compat109(a: (p0:numbr,p1:numbr)=>any): void {}`);
        assert.ok(parsed !== undefined && parsed !== null && typeof parsed === 'object',
  ...
  test('dts2cpp_compat_func_0082', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const parsed = doParseTs('compat109.ts', `function compat109(a: anny): void {}`);
        assert.ok(parsed !== undefined && parsed !== null && typeof parsed === 'object',
  ...
  test('dts2cpp_compat_func_0084', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        ...
        assert.strictEqual(converted.types[0].alias, "{ x: (p0:number,p1:number)=>any; }", "dts2cpp_compat_func_0084_alias");
      });
      assert.ok(finished, 'compat task must finish without process crash');
    } catch (err) {
