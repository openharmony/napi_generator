...
suite('Stability_DTS2CPP_COMPAT_FUNC_Part11', function() {
  this.timeout(600000);
  vscode.window.showInformationMessage('Start Stability_DTS2CPP_COMPAT_FUNC_Part11.');
  ...
  test('dts2cpp_compat_func_0001', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const parsed = doParseTs('compat118.ts', `function compat118(a: (p0:boolean,p1:object)=>any,): void {}`);
  ...
  test('dts2cpp_compat_func_0002', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const parsed = doParseTs('compat118.ts', `function compat118(a: Numbr): void {}`);
        assert.ok(parsed !== undefined && parsed !== null && typeof parsed === 'object',
  ...
  test('dts2cpp_compat_func_0003', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const parsed = doParseTs('compat119.ts', `function compat119(a: numbr): void {}`);
        assert.ok(parsed !== undefined && parsed !== null && typeof parsed === 'object',
  ...
  test('dts2cpp_compat_func_0004', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const parsed = doParseTs('compat119.ts', `function compat119(a: strng): void {}`);
        assert.ok(parsed !== undefined && parsed !== null && typeof parsed === 'object',
  ...
  test('dts2cpp_compat_func_0005', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const parsed = doParseTs('compat119.ts', `function compat119(a: boolea): void {}`);
        assert.ok(parsed !== undefined && parsed !== null && typeof parsed === 'object',
  ...
  test('dts2cpp_compat_func_0006', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const parsed = doParseTs('compat119.ts', `function compat119(a: (p0:boolean,p1:number)=>any): void {}`);
        assert.ok(parsed !== undefined && parsed !== null && typeof parsed === 'object',
  ...
  test('dts2cpp_compat_func_0007', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const parsed = doParseTs('compat119.ts', `function compat119(a: (p0:boolea,p1:numbr)=>any): void {}`);
        assert.ok(parsed !== undefined && parsed !== null && typeof parsed === 'object',
        ...
        assert.strictEqual(converted.funcs[0].parameters[0].type, "std::function<std::any(boolea, numbr)>",
  ...
  test('dts2cpp_compat_func_0008', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const parsed = doParseTs('compat119.ts', `function compat119(a: anny): void {}`);
        assert.ok(parsed !== undefined && parsed !== null && typeof parsed === 'object',
        ...
        assert.strictEqual(converted.funcs[0].parameters[0].type, "anny", "dts2cpp_compat_func_0008 param type");
      });
      assert.ok(finished, 'compat task must finish without process crash');
    } catch (err) {
  ...
  test('dts2cpp_compat_func_0009', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const parsed = doParseTs('compat119.ts', `class Compat119 { field: (p0:boolean,p1:number)=>any; }`);
        assert.ok(parsed !== undefined && parsed !== null && typeof parsed === 'object',
          "dts2cpp_compat_func_0009 parse result must be object");
        const converted = transParseObj(parsed);
        assert.ok(converted !== undefined && converted !== null && typeof converted === 'object',
          "dts2cpp_compat_func_0009 convert result must be object");
        assert.ok(converted.classes && converted.classes.length >= 1, "dts2cpp_compat_func_0009 must parse class");
        assert.ok(converted.classes[0].variableList && converted.classes[0].variableList.length >= 1,
          "dts2cpp_compat_func_0009 must parse class field");
  ...
  test('dts2cpp_compat_func_0010', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const parsed = doParseTs('compat119.ts', `type Compat119 = { x: (p0:boolean,p1:number)=>any; };`);
        assert.ok(parsed !== undefined && parsed !== null && typeof parsed === 'object',
          "dts2cpp_compat_func_0010 parse result must be object");
        const converted = transParseObj(parsed);
        assert.ok(converted !== undefined && converted !== null && typeof converted === 'object',
          "dts2cpp_compat_func_0010 convert result must be object");
        assert.ok(converted.types && converted.types.length >= 1, "dts2cpp_compat_func_0010 must parse type alias");
        assert.strictEqual(converted.types[0].alias, "{ x: (p0:boolean,p1:number)=>any; }", "dts2cpp_compat_func_0010_alias");
      });
      assert.ok(finished, 'compat task must finish without process crash');
    } catch (err) {
  ...
  test('dts2cpp_compat_func_0013', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const parsed = doParseTs('compat120.ts', `function compat120(a: numbr): void {}`);
        assert.ok(parsed !== undefined && parsed !== null && typeof parsed === 'object',
  ...
  test('dts2cpp_compat_func_0014', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const parsed = doParseTs('compat120.ts', `function compat120(a: strng): void {}`);
        assert.ok(parsed !== undefined && parsed !== null && typeof parsed === 'object',
  ...
  test('dts2cpp_compat_func_0015', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const parsed = doParseTs('compat120.ts', `function compat120(a: boolea): void {}`);
        assert.ok(parsed !== undefined && parsed !== null && typeof parsed === 'object',
  ...
  test('dts2cpp_compat_func_0016', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const parsed = doParseTs('compat120.ts', `function compat120(a: (p0:boolean,p1:string)=>any): void {}`);
        assert.ok(parsed !== undefined && parsed !== null && typeof parsed === 'object',
  ...
  test('dts2cpp_compat_func_0017', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const parsed = doParseTs('compat120.ts', `function compat120(a: (p0:boolea,p1:strng)=>any): void {}`);
        assert.ok(parsed !== undefined && parsed !== null && typeof parsed === 'object',
        ...
        assert.strictEqual(converted.funcs[0].parameters[0].type, "std::function<std::any(boolea, strng)>",
  ...
  test('dts2cpp_compat_func_0018', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const parsed = doParseTs('compat120.ts', `function compat120(a: anny): void {}`);
        assert.ok(parsed !== undefined && parsed !== null && typeof parsed === 'object',
        ...
        assert.strictEqual(converted.funcs[0].parameters[0].type, "anny", "dts2cpp_compat_func_0018 param type");
      });
      assert.ok(finished, 'compat task must finish without process crash');
    } catch (err) {
  ...
  test('dts2cpp_compat_func_0019', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const parsed = doParseTs('compat120.ts', `class Compat120 { field: (p0:boolean,p1:string)=>any; }`);
        assert.ok(parsed !== undefined && parsed !== null && typeof parsed === 'object',
          "dts2cpp_compat_func_0019 parse result must be object");
        const converted = transParseObj(parsed);
        assert.ok(converted !== undefined && converted !== null && typeof converted === 'object',
          "dts2cpp_compat_func_0019 convert result must be object");
        assert.ok(converted.classes && converted.classes.length >= 1, "dts2cpp_compat_func_0019 must parse class");
        assert.ok(converted.classes[0].variableList && converted.classes[0].variableList.length >= 1,
          "dts2cpp_compat_func_0019 must parse class field");
  ...
  test('dts2cpp_compat_func_0020', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const parsed = doParseTs('compat120.ts', `type Compat120 = { x: (p0:boolean,p1:string)=>any; };`);
        assert.ok(parsed !== undefined && parsed !== null && typeof parsed === 'object',
          "dts2cpp_compat_func_0020 parse result must be object");
        const converted = transParseObj(parsed);
        assert.ok(converted !== undefined && converted !== null && typeof converted === 'object',
          "dts2cpp_compat_func_0020 convert result must be object");
        assert.ok(converted.types && converted.types.length >= 1, "dts2cpp_compat_func_0020 must parse type alias");
        assert.strictEqual(converted.types[0].alias, "{ x: (p0:boolean,p1:string)=>any; }", "dts2cpp_compat_func_0020_alias");
      });
      assert.ok(finished, 'compat task must finish without process crash');
    } catch (err) {
  ...
  test('dts2cpp_compat_func_0023', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const parsed = doParseTs('compat121.ts', `function compat121(a: numbr): void {}`);
        assert.ok(parsed !== undefined && parsed !== null && typeof parsed === 'object',
  ...
  test('dts2cpp_compat_func_0024', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const parsed = doParseTs('compat121.ts', `function compat121(a: strng): void {}`);
        assert.ok(parsed !== undefined && parsed !== null && typeof parsed === 'object',
  ...
  test('dts2cpp_compat_func_0025', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const parsed = doParseTs('compat121.ts', `function compat121(a: boolea): void {}`);
        assert.ok(parsed !== undefined && parsed !== null && typeof parsed === 'object',
  ...
  test('dts2cpp_compat_func_0026', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const parsed = doParseTs('compat121.ts', `function compat121(a: (p0:boolean,p1:boolean)=>any): void {}`);
        assert.ok(parsed !== undefined && parsed !== null && typeof parsed === 'object',
  ...
  test('dts2cpp_compat_func_0027', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const parsed = doParseTs('compat121.ts', `function compat121(a: (p0:boolea,p1:boolea)=>any): void {}`);
        assert.ok(parsed !== undefined && parsed !== null && typeof parsed === 'object',
        ...
        assert.strictEqual(converted.funcs[0].parameters[0].type, "std::function<std::any(boolea, boolea)>",
  ...
  test('dts2cpp_compat_func_0028', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const parsed = doParseTs('compat121.ts', `function compat121(a: anny): void {}`);
        assert.ok(parsed !== undefined && parsed !== null && typeof parsed === 'object',
        ...
        assert.strictEqual(converted.funcs[0].parameters[0].type, "anny", "dts2cpp_compat_func_0028 param type");
      });
      assert.ok(finished, 'compat task must finish without process crash');
    } catch (err) {
  ...
  test('dts2cpp_compat_func_0029', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const parsed = doParseTs('compat121.ts', `class Compat121 { field: (p0:boolean,p1:boolean)=>any; }`);
        assert.ok(parsed !== undefined && parsed !== null && typeof parsed === 'object',
          "dts2cpp_compat_func_0029 parse result must be object");
        const converted = transParseObj(parsed);
        assert.ok(converted !== undefined && converted !== null && typeof converted === 'object',
          "dts2cpp_compat_func_0029 convert result must be object");
        assert.ok(converted.classes && converted.classes.length >= 1, "dts2cpp_compat_func_0029 must parse class");
        assert.ok(converted.classes[0].variableList && converted.classes[0].variableList.length >= 1,
          "dts2cpp_compat_func_0029 must parse class field");
  ...
  test('dts2cpp_compat_func_0030', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const parsed = doParseTs('compat121.ts', `type Compat121 = { x: (p0:boolean,p1:boolean)=>any; };`);
        assert.ok(parsed !== undefined && parsed !== null && typeof parsed === 'object',
          "dts2cpp_compat_func_0030 parse result must be object");
        const converted = transParseObj(parsed);
        assert.ok(converted !== undefined && converted !== null && typeof converted === 'object',
          "dts2cpp_compat_func_0030 convert result must be object");
        assert.ok(converted.types && converted.types.length >= 1, "dts2cpp_compat_func_0030 must parse type alias");
        assert.strictEqual(converted.types[0].alias, "{ x: (p0:boolean,p1:boolean)=>any; }",
          "dts2cpp_compat_func_0030_alias");
      });
      assert.ok(finished, 'compat task must finish without process crash');
    } catch (err) {
  ...
  test('dts2cpp_compat_func_0033', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const parsed = doParseTs('compat122.ts', `function compat122(a: numbr): void {}`);
        assert.ok(parsed !== undefined && parsed !== null && typeof parsed === 'object',
  ...
  test('dts2cpp_compat_func_0034', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const parsed = doParseTs('compat122.ts', `function compat122(a: strng): void {}`);
        assert.ok(parsed !== undefined && parsed !== null && typeof parsed === 'object',
  ...
  test('dts2cpp_compat_func_0035', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const parsed = doParseTs('compat122.ts', `function compat122(a: boolea): void {}`);
        assert.ok(parsed !== undefined && parsed !== null && typeof parsed === 'object',
  ...
  test('dts2cpp_compat_func_0036', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const parsed = doParseTs('compat122.ts', `function compat122(a: (p0:any,p1:object)=>object): void {}`);
        assert.ok(parsed !== undefined && parsed !== null && typeof parsed === 'object',
  ...
  test('dts2cpp_compat_func_0038', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const parsed = doParseTs('compat122.ts', `function compat122(a: anny): void {}`);
        assert.ok(parsed !== undefined && parsed !== null && typeof parsed === 'object',
        ...
        assert.strictEqual(converted.funcs[0].parameters[0].type, "anny", "dts2cpp_compat_func_0038 param type");
      });
      assert.ok(finished, 'compat task must finish without process crash');
    } catch (err) {
  ...
  test('dts2cpp_compat_func_0039', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const parsed = doParseTs('compat122.ts', `class Compat122 { field: (p0:any,p1:object)=>object; }`);
        assert.ok(parsed !== undefined && parsed !== null && typeof parsed === 'object',
          "dts2cpp_compat_func_0039 parse result must be object");
        const converted = transParseObj(parsed);
        assert.ok(converted !== undefined && converted !== null && typeof converted === 'object',
          "dts2cpp_compat_func_0039 convert result must be object");
        assert.ok(converted.classes && converted.classes.length >= 1, "dts2cpp_compat_func_0039 must parse class");
        assert.ok(converted.classes[0].variableList && converted.classes[0].variableList.length >= 1,
          "dts2cpp_compat_func_0039 must parse class field");
  ...
  test('dts2cpp_compat_func_0040', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const parsed = doParseTs('compat122.ts', `type Compat122 = { x: (p0:any,p1:object)=>object; };`);
        assert.ok(parsed !== undefined && parsed !== null && typeof parsed === 'object',
          "dts2cpp_compat_func_0040 parse result must be object");
        const converted = transParseObj(parsed);
        assert.ok(converted !== undefined && converted !== null && typeof converted === 'object',
          "dts2cpp_compat_func_0040 convert result must be object");
        assert.ok(converted.types && converted.types.length >= 1, "dts2cpp_compat_func_0040 must parse type alias");
        assert.strictEqual(converted.types[0].alias, "{ x: (p0:any,p1:object)=>object; }", "dts2cpp_compat_func_0040_alias");
      });
      assert.ok(finished, 'compat task must finish without process crash');
    } catch (err) {
  ...
  test('dts2cpp_compat_func_0043', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const parsed = doParseTs('compat123.ts', `function compat123(a: numbr): void {}`);
        assert.ok(parsed !== undefined && parsed !== null && typeof parsed === 'object',
  ...
  test('dts2cpp_compat_func_0044', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const parsed = doParseTs('compat123.ts', `function compat123(a: strng): void {}`);
        assert.ok(parsed !== undefined && parsed !== null && typeof parsed === 'object',
  ...
  test('dts2cpp_compat_func_0045', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const parsed = doParseTs('compat123.ts', `function compat123(a: boolea): void {}`);
        assert.ok(parsed !== undefined && parsed !== null && typeof parsed === 'object',
  ...
  test('dts2cpp_compat_func_0046', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const parsed = doParseTs('compat123.ts', `function compat123(a: (p0:any,p1:number)=>object): void {}`);
        assert.ok(parsed !== undefined && parsed !== null && typeof parsed === 'object',
  ...
  test('dts2cpp_compat_func_0047', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const parsed = doParseTs('compat123.ts', `function compat123(a: (p0:any,p1:numbr)=>object): void {}`);
        assert.ok(parsed !== undefined && parsed !== null && typeof parsed === 'object',
  ...
  test('dts2cpp_compat_func_0048', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const parsed = doParseTs('compat123.ts', `function compat123(a: anny): void {}`);
        assert.ok(parsed !== undefined && parsed !== null && typeof parsed === 'object',
        ...
        assert.strictEqual(converted.funcs[0].parameters[0].type, "anny", "dts2cpp_compat_func_0048 param type");
      });
      assert.ok(finished, 'compat task must finish without process crash');
    } catch (err) {
  ...
  test('dts2cpp_compat_func_0049', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const parsed = doParseTs('compat123.ts', `class Compat123 { field: (p0:any,p1:number)=>object; }`);
        assert.ok(parsed !== undefined && parsed !== null && typeof parsed === 'object',
          "dts2cpp_compat_func_0049 parse result must be object");
        const converted = transParseObj(parsed);
        assert.ok(converted !== undefined && converted !== null && typeof converted === 'object',
          "dts2cpp_compat_func_0049 convert result must be object");
        assert.ok(converted.classes && converted.classes.length >= 1, "dts2cpp_compat_func_0049 must parse class");
        assert.ok(converted.classes[0].variableList && converted.classes[0].variableList.length >= 1,
          "dts2cpp_compat_func_0049 must parse class field");
  ...
  test('dts2cpp_compat_func_0050', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const parsed = doParseTs('compat123.ts', `type Compat123 = { x: (p0:any,p1:number)=>object; };`);
        assert.ok(parsed !== undefined && parsed !== null && typeof parsed === 'object',
          "dts2cpp_compat_func_0050 parse result must be object");
        const converted = transParseObj(parsed);
        assert.ok(converted !== undefined && converted !== null && typeof converted === 'object',
          "dts2cpp_compat_func_0050 convert result must be object");
        assert.ok(converted.types && converted.types.length >= 1, "dts2cpp_compat_func_0050 must parse type alias");
        assert.strictEqual(converted.types[0].alias, "{ x: (p0:any,p1:number)=>object; }", "dts2cpp_compat_func_0050_alias");
      });
      assert.ok(finished, 'compat task must finish without process crash');
    } catch (err) {
  ...
  test('dts2cpp_compat_func_0053', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const parsed = doParseTs('compat124.ts', `function compat124(a: numbr): void {}`);
        assert.ok(parsed !== undefined && parsed !== null && typeof parsed === 'object',
  ...
  test('dts2cpp_compat_func_0054', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const parsed = doParseTs('compat124.ts', `function compat124(a: strng): void {}`);
        assert.ok(parsed !== undefined && parsed !== null && typeof parsed === 'object',
  ...
  test('dts2cpp_compat_func_0055', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const parsed = doParseTs('compat124.ts', `function compat124(a: boolea): void {}`);
        assert.ok(parsed !== undefined && parsed !== null && typeof parsed === 'object',
  ...
  test('dts2cpp_compat_func_0056', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const parsed = doParseTs('compat124.ts', `function compat124(a: (p0:any,p1:string)=>object): void {}`);
        assert.ok(parsed !== undefined && parsed !== null && typeof parsed === 'object',
  ...
  test('dts2cpp_compat_func_0057', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const parsed = doParseTs('compat124.ts', `function compat124(a: (p0:any,p1:strng)=>object): void {}`);
        assert.ok(parsed !== undefined && parsed !== null && typeof parsed === 'object',
  ...
  test('dts2cpp_compat_func_0058', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const parsed = doParseTs('compat124.ts', `function compat124(a: anny): void {}`);
        assert.ok(parsed !== undefined && parsed !== null && typeof parsed === 'object',
        ...
        assert.strictEqual(converted.funcs[0].parameters[0].type, "anny", "dts2cpp_compat_func_0058 param type");
      });
      assert.ok(finished, 'compat task must finish without process crash');
    } catch (err) {
  ...
  test('dts2cpp_compat_func_0059', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const parsed = doParseTs('compat124.ts', `class Compat124 { field: (p0:any,p1:string)=>object; }`);
        assert.ok(parsed !== undefined && parsed !== null && typeof parsed === 'object',
          "dts2cpp_compat_func_0059 parse result must be object");
        const converted = transParseObj(parsed);
        assert.ok(converted !== undefined && converted !== null && typeof converted === 'object',
          "dts2cpp_compat_func_0059 convert result must be object");
        assert.ok(converted.classes && converted.classes.length >= 1, "dts2cpp_compat_func_0059 must parse class");
        assert.ok(converted.classes[0].variableList && converted.classes[0].variableList.length >= 1,
          "dts2cpp_compat_func_0059 must parse class field");
  ...
  test('dts2cpp_compat_func_0060', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const parsed = doParseTs('compat124.ts', `type Compat124 = { x: (p0:any,p1:string)=>object; };`);
        assert.ok(parsed !== undefined && parsed !== null && typeof parsed === 'object',
          "dts2cpp_compat_func_0060 parse result must be object");
        const converted = transParseObj(parsed);
        assert.ok(converted !== undefined && converted !== null && typeof converted === 'object',
          "dts2cpp_compat_func_0060 convert result must be object");
        assert.ok(converted.types && converted.types.length >= 1, "dts2cpp_compat_func_0060 must parse type alias");
        assert.strictEqual(converted.types[0].alias, "{ x: (p0:any,p1:string)=>object; }", "dts2cpp_compat_func_0060_alias");
      });
      assert.ok(finished, 'compat task must finish without process crash');
    } catch (err) {
  ...
  test('dts2cpp_compat_func_0063', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const parsed = doParseTs('compat125.ts', `function compat125(a: numbr): void {}`);
        assert.ok(parsed !== undefined && parsed !== null && typeof parsed === 'object',
  ...
  test('dts2cpp_compat_func_0064', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const parsed = doParseTs('compat125.ts', `function compat125(a: strng): void {}`);
        assert.ok(parsed !== undefined && parsed !== null && typeof parsed === 'object',
  ...
  test('dts2cpp_compat_func_0065', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const parsed = doParseTs('compat125.ts', `function compat125(a: boolea): void {}`);
        assert.ok(parsed !== undefined && parsed !== null && typeof parsed === 'object',
  ...
  test('dts2cpp_compat_func_0066', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const parsed = doParseTs('compat125.ts', `function compat125(a: (p0:any,p1:boolean)=>object): void {}`);
        assert.ok(parsed !== undefined && parsed !== null && typeof parsed === 'object',
  ...
  test('dts2cpp_compat_func_0067', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const parsed = doParseTs('compat125.ts', `function compat125(a: (p0:any,p1:boolea)=>object): void {}`);
        assert.ok(parsed !== undefined && parsed !== null && typeof parsed === 'object',
  ...
  test('dts2cpp_compat_func_0068', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const parsed = doParseTs('compat125.ts', `function compat125(a: anny): void {}`);
        assert.ok(parsed !== undefined && parsed !== null && typeof parsed === 'object',
        ...
        assert.strictEqual(converted.funcs[0].parameters[0].type, "anny", "dts2cpp_compat_func_0068 param type");
      });
      assert.ok(finished, 'compat task must finish without process crash');
    } catch (err) {
  ...
  test('dts2cpp_compat_func_0069', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const parsed = doParseTs('compat125.ts', `class Compat125 { field: (p0:any,p1:boolean)=>object; }`);
        assert.ok(parsed !== undefined && parsed !== null && typeof parsed === 'object',
          "dts2cpp_compat_func_0069 parse result must be object");
        const converted = transParseObj(parsed);
        assert.ok(converted !== undefined && converted !== null && typeof converted === 'object',
          "dts2cpp_compat_func_0069 convert result must be object");
        assert.ok(converted.classes && converted.classes.length >= 1, "dts2cpp_compat_func_0069 must parse class");
        assert.ok(converted.classes[0].variableList && converted.classes[0].variableList.length >= 1,
          "dts2cpp_compat_func_0069 must parse class field");
  ...
  test('dts2cpp_compat_func_0070', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const parsed = doParseTs('compat125.ts', `type Compat125 = { x: (p0:any,p1:boolean)=>object; };`);
        assert.ok(parsed !== undefined && parsed !== null && typeof parsed === 'object',
          "dts2cpp_compat_func_0070 parse result must be object");
        const converted = transParseObj(parsed);
        assert.ok(converted !== undefined && converted !== null && typeof converted === 'object',
          "dts2cpp_compat_func_0070 convert result must be object");
        assert.ok(converted.types && converted.types.length >= 1, "dts2cpp_compat_func_0070 must parse type alias");
        assert.strictEqual(converted.types[0].alias, "{ x: (p0:any,p1:boolean)=>object; }", "dts2cpp_compat_func_0070_alias");
      });
      assert.ok(finished, 'compat task must finish without process crash');
    } catch (err) {
  ...
  test('dts2cpp_compat_func_0073', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const parsed = doParseTs('compat126.ts', `function compat126(a: numbr): void {}`);
        assert.ok(parsed !== undefined && parsed !== null && typeof parsed === 'object',
  ...
  test('dts2cpp_compat_func_0074', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const parsed = doParseTs('compat126.ts', `function compat126(a: strng): void {}`);
        assert.ok(parsed !== undefined && parsed !== null && typeof parsed === 'object',
  ...
  test('dts2cpp_compat_func_0075', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const parsed = doParseTs('compat126.ts', `function compat126(a: boolea): void {}`);
        assert.ok(parsed !== undefined && parsed !== null && typeof parsed === 'object',
  ...
  test('dts2cpp_compat_func_0076', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const parsed = doParseTs('compat126.ts', `function compat126(a: (p0:object,p1:any)=>object): void {}`);
        assert.ok(parsed !== undefined && parsed !== null && typeof parsed === 'object',
  ...
  test('dts2cpp_compat_func_0078', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const parsed = doParseTs('compat126.ts', `function compat126(a: anny): void {}`);
        assert.ok(parsed !== undefined && parsed !== null && typeof parsed === 'object',
        ...
        assert.strictEqual(converted.funcs[0].parameters[0].type, "anny", "dts2cpp_compat_func_0078 param type");
      });
      assert.ok(finished, 'compat task must finish without process crash');
    } catch (err) {
  ...
  test('dts2cpp_compat_func_0079', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const parsed = doParseTs('compat126.ts', `class Compat126 { field: (p0:object,p1:any)=>object; }`);
        assert.ok(parsed !== undefined && parsed !== null && typeof parsed === 'object',
          "dts2cpp_compat_func_0079 parse result must be object");
        const converted = transParseObj(parsed);
        assert.ok(converted !== undefined && converted !== null && typeof converted === 'object',
          "dts2cpp_compat_func_0079 convert result must be object");
        assert.ok(converted.classes && converted.classes.length >= 1, "dts2cpp_compat_func_0079 must parse class");
        assert.ok(converted.classes[0].variableList && converted.classes[0].variableList.length >= 1,
          "dts2cpp_compat_func_0079 must parse class field");
        assert.strictEqual(converted.classes[0].variableList[0].type, "std::function<std::any(std::any, std::any)>",
  ...
  test('dts2cpp_compat_func_0080', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const parsed = doParseTs('compat126.ts', `type Compat126 = { x: (p0:object,p1:any)=>object; };`);
        assert.ok(parsed !== undefined && parsed !== null && typeof parsed === 'object',
          "dts2cpp_compat_func_0080 parse result must be object");
        const converted = transParseObj(parsed);
        assert.ok(converted !== undefined && converted !== null && typeof converted === 'object',
          "dts2cpp_compat_func_0080 convert result must be object");
        assert.ok(converted.types && converted.types.length >= 1, "dts2cpp_compat_func_0080 must parse type alias");
        assert.strictEqual(converted.types[0].alias, "{ x: (p0:object,p1:any)=>object; }", "dts2cpp_compat_func_0080_alias");
      });
      assert.ok(finished, 'compat task must finish without process crash');
    } catch (err) {
  ...
  test('dts2cpp_compat_func_0084', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const parsed = doParseTs('compat127.ts', `function compat127(a: strng): void {}`);
        assert.ok(parsed !== undefined && parsed !== null && typeof parsed === 'object',
  ...
  test('dts2cpp_compat_func_0085', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const parsed = doParseTs('compat127.ts', `function compat127(a: boolea): void {}`);
        assert.ok(parsed !== undefined && parsed !== null && typeof parsed === 'object',
