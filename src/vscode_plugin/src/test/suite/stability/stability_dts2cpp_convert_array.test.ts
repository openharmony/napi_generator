...
suite('Stability_DTS2CPP_CONVERT_ARRAY_Part01', function() {
  ...
  test('dts2cpp_convert_array_0001', () => {
    try {
      ...
      assert.ok(typeof result === 'string' && result.length > 0,
        "dts2cpp_convert_array_0001 convert output non-empty");
  ...
  test('dts2cpp_convert_array_0006', () => {
    try {
      ...
      assert.ok(typeof result === 'string' && result.length > 0,
        "dts2cpp_convert_array_0006 convert output non-empty");
  ...
  test('dts2cpp_convert_array_0011', () => {
    try {
      ...
      assert.ok(typeof result === 'string' && result.length > 0,
        "dts2cpp_convert_array_0011 convert output non-empty");
  ...
  test('dts2cpp_convert_array_0016', () => {
    try {
      ...
      assert.ok(typeof result === 'string' && result.length > 0,
        "dts2cpp_convert_array_0016 convert output non-empty");
  ...
  test('dts2cpp_convert_array_0021', () => {
    try {
      ...
      assert.ok(typeof result === 'string' && result.length > 0,
        "dts2cpp_convert_array_0021 convert output non-empty");
  ...
  test('dts2cpp_convert_array_0026', () => {
    try {
      ...
      assert.ok(typeof result === 'string' && result.length > 0,
        "dts2cpp_convert_array_0026 convert output non-empty");
  ...
  test('dts2cpp_convert_array_0031', () => {
    try {
      ...
      assert.ok(typeof result === 'string' && result.length > 0,
        "dts2cpp_convert_array_0031 convert output non-empty");
  ...
  test('dts2cpp_convert_array_0036', () => {
    try {
      ...
      assert.ok(typeof result === 'string' && result.length > 0,
        "dts2cpp_convert_array_0036 convert output non-empty");
  ...
  test('dts2cpp_convert_array_0041', () => {
    try {
      ...
      assert.ok(typeof result === 'string' && result.length > 0,
        "dts2cpp_convert_array_0041 convert output non-empty");
  ...
  test('dts2cpp_convert_array_0046', () => {
    try {
      ...
      assert.ok(typeof result === 'string' && result.length > 0,
        "dts2cpp_convert_array_0046 convert output non-empty");
  ...
  test('dts2cpp_convert_array_0048', () => {
    try {
      ...
      assert.strictEqual(converted.funcs[0].returns,
        "Array<object>",
        "dts2cpp_convert_array_0048 return convert output");
  ...
  test('dts2cpp_convert_array_0051', () => {
    try {
      ...
      assert.ok(typeof result === 'string' && result.length > 0,
        "dts2cpp_convert_array_0051 convert output non-empty");
  ...
  test('dts2cpp_convert_array_0056', () => {
    try {
      ...
      assert.ok(typeof result === 'string' && result.length > 0,
        "dts2cpp_convert_array_0056 convert output non-empty");
  ...
  test('dts2cpp_convert_array_0061', () => {
    try {
      ...
      assert.ok(typeof result === 'string' && result.length > 0,
        "dts2cpp_convert_array_0061 convert output non-empty");
  ...
  test('dts2cpp_convert_array_0066', () => {
    try {
      ...
      assert.ok(typeof result === 'string' && result.length > 0,
        "dts2cpp_convert_array_0066 convert output non-empty");
