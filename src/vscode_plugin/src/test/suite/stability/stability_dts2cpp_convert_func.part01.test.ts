...
suite('Stability_DTS2CPP_CONVERT_FUNC_Part01', function() {
  ...
  test('dts2cpp_convert_func_0001', () => {
    try {
      ...
      assert.ok(typeof result === 'string' && result.length > 0, "dts2cpp_convert_func_0001 convert output non-empty");
  ...
  test('dts2cpp_convert_func_0006', () => {
    try {
      ...
      assert.ok(typeof result === 'string' && result.length > 0, "dts2cpp_convert_func_0006 convert output non-empty");
  ...
  test('dts2cpp_convert_func_0011', () => {
    try {
      ...
      assert.ok(typeof result === 'string' && result.length > 0, "dts2cpp_convert_func_0011 convert output non-empty");
  ...
  test('dts2cpp_convert_func_0016', () => {
    try {
      ...
      assert.ok(typeof result === 'string' && result.length > 0, "dts2cpp_convert_func_0016 convert output non-empty");
  ...
  test('dts2cpp_convert_func_0021', () => {
    try {
      const result = transCkey2Dtskey('Callback<number[]>');
      assert.ok(typeof result === 'string' && result.length > 0, "dts2cpp_convert_func_0021 convert output non-empty");
      assert.strictEqual(result, "std::function<void(std::vector<double>)>", "dts2cpp_convert_func_0021 convert output");
    } catch (err) {
  ...
  test('dts2cpp_convert_func_0026', () => {
    try {
      const result = transCkey2Dtskey('Callback<string[]>');
      assert.ok(typeof result === 'string' && result.length > 0, "dts2cpp_convert_func_0026 convert output non-empty");
      assert.strictEqual(result, "std::function<void(std::vector<std::string>)>",
  ...
  test('dts2cpp_convert_func_0031', () => {
    try {
      const result = transCkey2Dtskey('Callback<boolean[]>');
      assert.ok(typeof result === 'string' && result.length > 0, "dts2cpp_convert_func_0031 convert output non-empty");
  ...
  test('dts2cpp_convert_func_0036', () => {
    try {
      ...
      assert.ok(typeof result === 'string' && result.length > 0, "dts2cpp_convert_func_0036 convert output non-empty");
  ...
  test('dts2cpp_convert_func_0041', () => {
    try {
      ...
      assert.ok(typeof result === 'string' && result.length > 0, "dts2cpp_convert_func_0041 convert output non-empty");
  ...
  test('dts2cpp_convert_func_0046', () => {
    try {
      ...
      assert.ok(typeof result === 'string' && result.length > 0, "dts2cpp_convert_func_0046 convert output non-empty");
  ...
  test('dts2cpp_convert_func_0051', () => {
    try {
      ...
      assert.ok(typeof result === 'string' && result.length > 0, "dts2cpp_convert_func_0051 convert output non-empty");
  ...
  test('dts2cpp_convert_func_0056', () => {
    try {
      ...
      assert.ok(typeof result === 'string' && result.length > 0, "dts2cpp_convert_func_0056 convert output non-empty");
  ...
  test('dts2cpp_convert_func_0061', () => {
    try {
      ...
      assert.ok(typeof result === 'string' && result.length > 0, "dts2cpp_convert_func_0061 convert output non-empty");
  ...
  test('dts2cpp_convert_func_0066', () => {
    try {
      ...
      assert.ok(typeof result === 'string' && result.length > 0, "dts2cpp_convert_func_0066 convert output non-empty");
  ...
  test('dts2cpp_convert_func_0071', () => {
    try {
      ...
      assert.ok(typeof result === 'string' && result.length > 0, "dts2cpp_convert_func_0071 convert output non-empty");
  ...
  test('dts2cpp_convert_func_0076', () => {
    try {
      ...
      assert.ok(typeof result === 'string' && result.length > 0, "dts2cpp_convert_func_0076 convert output non-empty");
  ...
  test('dts2cpp_convert_func_0081', () => {
    try {
      ...
      assert.ok(typeof result === 'string' && result.length > 0, "dts2cpp_convert_func_0081 convert output non-empty");
  ...
  test('dts2cpp_convert_func_0086', () => {
    try {
      ...
      assert.ok(typeof result === 'string' && result.length > 0, "dts2cpp_convert_func_0086 convert output non-empty");
  ...
  test('dts2cpp_convert_func_0091', () => {
    try {
      ...
      assert.ok(typeof result === 'string' && result.length > 0, "dts2cpp_convert_func_0091 convert output non-empty");
  ...
  test('dts2cpp_convert_func_0096', () => {
    try {
      ...
      assert.ok(typeof result === 'string' && result.length > 0, "dts2cpp_convert_func_0096 convert output non-empty");
  ...
  test('dts2cpp_convert_func_0101', () => {
    try {
      ...
      assert.ok(typeof result === 'string' && result.length > 0, "dts2cpp_convert_func_0101 convert output non-empty");
  ...
  test('dts2cpp_convert_func_0106', () => {
    try {
      ...
      assert.ok(typeof result === 'string' && result.length > 0, "dts2cpp_convert_func_0106 convert output non-empty");
      assert.strictEqual(result, "std::function<double(std::string, std::string)>",
  ...
  test('dts2cpp_convert_func_0111', () => {
    try {
      ...
      assert.ok(typeof result === 'string' && result.length > 0, "dts2cpp_convert_func_0111 convert output non-empty");
