...
suite('Stability_DTS2CPP_CONVERT_FUNC_Part03', function() {
  ...
  test('dts2cpp_convert_func_0030', () => {
    try {
      ...
      assert.ok(converted.funcs[0].parameters.length >= 1);
      assert.strictEqual(converted.funcs[0].parameters[0].type,
        "std::function<void(Array<object)>",
  ...
  test('dts2cpp_convert_func_0045', () => {
    try {
      ...
      assert.ok(converted.funcs[0].parameters.length >= 1);
      assert.strictEqual(converted.funcs[0].parameters[0].type,
        "std::function<std::any(std::string)>",
  ...
  test('dts2cpp_convert_func_0089', () => {
    try {
      ...
      assert.ok(typeof result === 'string' && result.length > 0,
        "dts2cpp_convert_func_0089 convert output non-empty");
  ...
  test('dts2cpp_convert_func_0094', () => {
    try {
      ...
      assert.ok(typeof result === 'string' && result.length > 0,
        "dts2cpp_convert_func_0094 convert output non-empty");
  ...
  test('dts2cpp_convert_func_0099', () => {
    try {
      ...
      assert.ok(typeof result === 'string' && result.length > 0,
        "dts2cpp_convert_func_0099 convert output non-empty");
  ...
  test('dts2cpp_convert_func_0104', () => {
    try {
      ...
      assert.ok(typeof result === 'string' && result.length > 0,
        "dts2cpp_convert_func_0104 convert output non-empty");
      assert.strictEqual(result,
        "std::function<std::any(std::any, std::any)>",
  ...
  test('dts2cpp_convert_func_0109', () => {
    try {
      ...
      assert.ok(typeof result === 'string' && result.length > 0,
        "dts2cpp_convert_func_0109 convert output non-empty");
      assert.strictEqual(result,
        "std::function<std::any(std::any, std::any)>",
  ...
  test('dts2cpp_convert_func_0114', () => {
    try {
      ...
      assert.ok(typeof result === 'string' && result.length > 0,
        "dts2cpp_convert_func_0114 convert output non-empty");
      assert.strictEqual(result,
        "std::function<std::any(std::any, double)>",
        "dts2cpp_convert_func_0114 convert output");
    } catch (err) {
