...
suite('Stability_DTS2CPP_CONVERT_FUNC_Part04', function() {
  ...
  test('dts2cpp_convert_func_0005', () => {
    try {
      ...
      assert.ok(typeof result === 'string' && result.length > 0,
        "dts2cpp_convert_func_0005 convert output non-empty");
  ...
  test('dts2cpp_convert_func_0010', () => {
    try {
      ...
      assert.ok(typeof result === 'string' && result.length > 0,
        "dts2cpp_convert_func_0010 convert output non-empty");
  ...
  test('dts2cpp_convert_func_0015', () => {
    try {
      ...
      assert.ok(typeof result === 'string' && result.length > 0,
        "dts2cpp_convert_func_0015 convert output non-empty");
      assert.strictEqual(result,
  ...
  test('dts2cpp_convert_func_0020', () => {
    try {
      ...
      assert.ok(typeof result === 'string' && result.length > 0,
        "dts2cpp_convert_func_0020 convert output non-empty");
      assert.strictEqual(result,
        "std::function<std::any(std::any, double)>",
        "dts2cpp_convert_func_0020 convert output");
    } catch (err) {
  ...
  test('dts2cpp_convert_func_0025', () => {
    try {
      ...
      assert.ok(typeof result === 'string' && result.length > 0,
        "dts2cpp_convert_func_0025 convert output non-empty");
      assert.strictEqual(result,
        "std::function<std::any(std::any, std::string)>",
  ...
  test('dts2cpp_convert_func_0030', () => {
    try {
      ...
      assert.ok(typeof result === 'string' && result.length > 0,
        "dts2cpp_convert_func_0030 convert output non-empty");
  ...
  test('dts2cpp_convert_func_0035', () => {
    try {
      ...
      assert.ok(typeof result === 'string' && result.length > 0,
        "dts2cpp_convert_func_0035 convert output non-empty");
      assert.strictEqual(result,
        "std::function<std::any(double, std::any)>",
        "dts2cpp_convert_func_0035 convert output");
    } catch (err) {
  ...
  test('dts2cpp_convert_func_0040', () => {
    try {
      ...
      assert.ok(typeof result === 'string' && result.length > 0,
        "dts2cpp_convert_func_0040 convert output non-empty");
      assert.strictEqual(result,
        "std::function<std::any(double, std::any)>",
        "dts2cpp_convert_func_0040 convert output");
    } catch (err) {
  ...
  test('dts2cpp_convert_func_0045', () => {
    try {
      ...
      assert.ok(typeof result === 'string' && result.length > 0,
        "dts2cpp_convert_func_0045 convert output non-empty");
  ...
  test('dts2cpp_convert_func_0050', () => {
    try {
      ...
      assert.ok(typeof result === 'string' && result.length > 0,
        "dts2cpp_convert_func_0050 convert output non-empty");
      assert.strictEqual(result,
  ...
  test('dts2cpp_convert_func_0055', () => {
    try {
      ...
      assert.ok(typeof result === 'string' && result.length > 0,
        "dts2cpp_convert_func_0055 convert output non-empty");
  ...
  test('dts2cpp_convert_func_0060', () => {
    try {
      ...
      assert.ok(typeof result === 'string' && result.length > 0,
        "dts2cpp_convert_func_0060 convert output non-empty");
      assert.strictEqual(result,
  ...
  test('dts2cpp_convert_func_0065', () => {
    try {
      ...
      assert.ok(typeof result === 'string' && result.length > 0,
        "dts2cpp_convert_func_0065 convert output non-empty");
      assert.strictEqual(result,
        "std::function<std::any(std::string, std::any)>",
  ...
  test('dts2cpp_convert_func_0070', () => {
    try {
      ...
      assert.ok(typeof result === 'string' && result.length > 0,
        "dts2cpp_convert_func_0070 convert output non-empty");
      assert.strictEqual(result,
  ...
  test('dts2cpp_convert_func_0075', () => {
    try {
      ...
      assert.ok(typeof result === 'string' && result.length > 0,
        "dts2cpp_convert_func_0075 convert output non-empty");
      assert.strictEqual(result,
  ...
  test('dts2cpp_convert_func_0080', () => {
    try {
      ...
      assert.ok(typeof result === 'string' && result.length > 0,
        "dts2cpp_convert_func_0080 convert output non-empty");
      assert.strictEqual(result,
  ...
  test('dts2cpp_convert_func_0085', () => {
    try {
      ...
      assert.ok(typeof result === 'string' && result.length > 0,
        "dts2cpp_convert_func_0085 convert output non-empty");
  ...
  test('dts2cpp_convert_func_0090', () => {
    try {
      ...
      assert.ok(typeof result === 'string' && result.length > 0,
        "dts2cpp_convert_func_0090 convert output non-empty");
  ...
  test('dts2cpp_convert_func_0095', () => {
    try {
      ...
      assert.ok(typeof result === 'string' && result.length > 0,
        "dts2cpp_convert_func_0095 convert output non-empty");
  ...
  test('dts2cpp_convert_func_0100', () => {
    try {
      ...
      assert.ok(typeof result === 'string' && result.length > 0,
        "dts2cpp_convert_func_0100 convert output non-empty");
      assert.strictEqual(result,
  ...
  test('dts2cpp_convert_func_0105', () => {
    try {
      ...
      assert.ok(typeof result === 'string' && result.length > 0,
        "dts2cpp_convert_func_0105 convert output non-empty");
  ...
  test('dts2cpp_convert_func_0110', () => {
    try {
      ...
      assert.ok(typeof result === 'string' && result.length > 0,
        "dts2cpp_convert_func_0110 convert output non-empty");
      assert.strictEqual(result,
        "std::function<std::any(std::any, std::any)>",
