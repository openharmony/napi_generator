...
suite('Stability_DTS2CPP_CONVERT_FUNC_Part06', function() {
  ...
  test('dts2cpp_convert_func_0014', () => {
    try {
      ...
      assert.strictEqual(result, "std::function<void(std::any, std::string)>",
  ...
  test('dts2cpp_convert_func_0059', () => {
    try {
      ...
      assert.strictEqual(result, "std::function<void(double, std::string)>", "dts2cpp_convert_func_0059 convert output");
    } catch (err) {
  ...
  test('dts2cpp_convert_func_0081', () => {
    try {
      ...
      assert.ok(converted.funcs.length >= 1);
      assert.strictEqual(converted.funcs[0].returns, "Promise<void>", "dts2cpp_convert_func_0081 return convert output");
