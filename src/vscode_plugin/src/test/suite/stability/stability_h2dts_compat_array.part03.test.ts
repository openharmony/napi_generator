...
suite('Stability_H2DTS_COMPAT_ARRAY_Part03', function() {
  this.timeout(600000);
  vscode.window.showInformationMessage('Start Stability_H2DTS_COMPAT_ARRAY_Part03.');
  ...
  test('h2dts_compat_array_0001', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const r = parsec.parseFunction(`void compat41(boool p);`);
  ...
  test('h2dts_compat_array_0002', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const r = parsec.parseFunction(`void compat41(intt p);`);
        assert.ok(Array.isArray(r) && r.length >= 1,
  ...
  test('h2dts_compat_array_0003', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const r = parsec.parseFunction(`void compat41(flot p);`);
        assert.ok(Array.isArray(r) && r.length >= 1,
  ...
  test('h2dts_compat_array_0004', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const r = parsec.parseFunction(`namespace ns { void compat41(std::vector<char32_t> p); }`);
        assert.ok(Array.isArray(r) && r.length >= 1,
  ...
  test('h2dts_compat_array_0005', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const r = parsec.parseFunction(`void compat41(bad_type_41 p);`);
        assert.ok(Array.isArray(r) && r.length >= 1,
        ...
        assert.strictEqual(r[0].parameters[0].type, "bad_type_41", "h2dts_compat_array_0005 param type");
      });
      assert.ok(finished, 'compat task must finish without process crash');
    } catch (err) {
  ...
  test('h2dts_compat_array_0006', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const r = parsec.parseFunction(`void compat41(std::vector<char32_t> p);`);
        assert.ok(Array.isArray(r) && r.length >= 1,
  ...
  test('h2dts_compat_array_0007', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const r = parsec.parseFunction(`enum E41 { A, B }; void f(E41 e);`);
        assert.ok(Array.isArray(r) && r.length >= 1,
  ...
  test('h2dts_compat_array_0008', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        ...
        assert.strictEqual(r[0].parameters[0].type, "std:vector<char32_t>", "h2dts_compat_array_0008 param type");
      });
      assert.ok(finished, 'compat task must finish without process crash');
    } catch (err) {
  ...
  test('h2dts_compat_array_0009', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const r = parsec.parseFunction(`void compat42(itn p);`);
        assert.ok(Array.isArray(r) && r.length >= 1,
  ...
  test('h2dts_compat_array_0010', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const r = parsec.parseFunction(`void compat42(doubl p);`);
        assert.ok(Array.isArray(r) && r.length >= 1,
  ...
  test('h2dts_compat_array_0011', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const r = parsec.parseFunction(`void compat42(boool p);`);
        assert.ok(Array.isArray(r) && r.length >= 1,
  ...
  test('h2dts_compat_array_0012', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const r = parsec.parseFunction(`void compat42(intt p);`);
        assert.ok(Array.isArray(r) && r.length >= 1,
  ...
  test('h2dts_compat_array_0013', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const r = parsec.parseFunction(`void compat42(flot p);`);
        assert.ok(Array.isArray(r) && r.length >= 1,
  ...
  test('h2dts_compat_array_0014', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const r = parsec.parseFunction(`namespace ns { void compat42(std::array<int, 10> p); }`);
        assert.ok(Array.isArray(r) && r.length >= 1,
  ...
  test('h2dts_compat_array_0015', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const r = parsec.parseFunction(`void compat42(bad_type_42 p);`);
        assert.ok(Array.isArray(r) && r.length >= 1,
        ...
        assert.strictEqual(r[0].parameters[0].type, "bad_type_42", "h2dts_compat_array_0015 param type");
      });
      assert.ok(finished, 'compat task must finish without process crash');
    } catch (err) {
  ...
  test('h2dts_compat_array_0016', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const r = parsec.parseFunction(`void compat42(std::array<int, 10> p);`);
        assert.ok(Array.isArray(r) && r.length >= 1,
  ...
  test('h2dts_compat_array_0017', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const r = parsec.parseFunction(`enum E42 { A, B }; void f(E42 e);`);
        assert.ok(Array.isArray(r) && r.length >= 1,
  ...
  test('h2dts_compat_array_0018', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        ...
        assert.strictEqual(r[0].parameters[0].type, "std:array<int, 10>", "h2dts_compat_array_0018 param type");
      });
      assert.ok(finished, 'compat task must finish without process crash');
    } catch (err) {
  ...
  test('h2dts_compat_array_0019', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const r = parsec.parseFunction(`void compat43(itn p);`);
        assert.ok(Array.isArray(r) && r.length >= 1,
  ...
  test('h2dts_compat_array_0020', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const r = parsec.parseFunction(`void compat43(doubl p);`);
        assert.ok(Array.isArray(r) && r.length >= 1,
  ...
  test('h2dts_compat_array_0021', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const r = parsec.parseFunction(`void compat43(boool p);`);
        assert.ok(Array.isArray(r) && r.length >= 1,
  ...
  test('h2dts_compat_array_0022', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const r = parsec.parseFunction(`void compat43(intt p);`);
        assert.ok(Array.isArray(r) && r.length >= 1,
  ...
  test('h2dts_compat_array_0023', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const r = parsec.parseFunction(`void compat43(flot p);`);
        assert.ok(Array.isArray(r) && r.length >= 1,
  ...
  test('h2dts_compat_array_0024', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const r = parsec.parseFunction(`namespace ns { void compat43(std::array<size_t, 10> p); }`);
        assert.ok(Array.isArray(r) && r.length >= 1,
  ...
  test('h2dts_compat_array_0025', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const r = parsec.parseFunction(`void compat43(bad_type_43 p);`);
        assert.ok(Array.isArray(r) && r.length >= 1,
        ...
        assert.strictEqual(r[0].parameters[0].type, "bad_type_43", "h2dts_compat_array_0025 param type");
      });
      assert.ok(finished, 'compat task must finish without process crash');
    } catch (err) {
  ...
  test('h2dts_compat_array_0026', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const r = parsec.parseFunction(`void compat43(std::array<size_t, 10> p);`);
        assert.ok(Array.isArray(r) && r.length >= 1,
  ...
  test('h2dts_compat_array_0027', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const r = parsec.parseFunction(`enum E43 { A, B }; void f(E43 e);`);
        assert.ok(Array.isArray(r) && r.length >= 1,
  ...
  test('h2dts_compat_array_0028', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        ...
        assert.strictEqual(r[0].parameters[0].type, "std:array<size_t, 10>", "h2dts_compat_array_0028 param type");
      });
      assert.ok(finished, 'compat task must finish without process crash');
    } catch (err) {
  ...
  test('h2dts_compat_array_0029', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const r = parsec.parseFunction(`void compat44(itn p);`);
        assert.ok(Array.isArray(r) && r.length >= 1,
  ...
  test('h2dts_compat_array_0030', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const r = parsec.parseFunction(`void compat44(doubl p);`);
        assert.ok(Array.isArray(r) && r.length >= 1,
  ...
  test('h2dts_compat_array_0031', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const r = parsec.parseFunction(`void compat44(boool p);`);
        assert.ok(Array.isArray(r) && r.length >= 1,
  ...
  test('h2dts_compat_array_0032', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const r = parsec.parseFunction(`void compat44(intt p);`);
        assert.ok(Array.isArray(r) && r.length >= 1,
  ...
  test('h2dts_compat_array_0033', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const r = parsec.parseFunction(`void compat44(flot p);`);
        assert.ok(Array.isArray(r) && r.length >= 1,
  ...
  test('h2dts_compat_array_0034', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const r = parsec.parseFunction(`namespace ns { void compat44(std::array<double, 10> p); }`);
        assert.ok(Array.isArray(r) && r.length >= 1,
  ...
  test('h2dts_compat_array_0035', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const r = parsec.parseFunction(`void compat44(bad_type_44 p);`);
        assert.ok(Array.isArray(r) && r.length >= 1,
        ...
        assert.strictEqual(r[0].parameters[0].type, "bad_type_44", "h2dts_compat_array_0035 param type");
      });
      assert.ok(finished, 'compat task must finish without process crash');
    } catch (err) {
  ...
  test('h2dts_compat_array_0036', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const r = parsec.parseFunction(`void compat44(std::array<double, 10> p);`);
        assert.ok(Array.isArray(r) && r.length >= 1,
  ...
  test('h2dts_compat_array_0037', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const r = parsec.parseFunction(`enum E44 { A, B }; void f(E44 e);`);
        assert.ok(Array.isArray(r) && r.length >= 1,
  ...
  test('h2dts_compat_array_0038', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        ...
        assert.strictEqual(r[0].parameters[0].type, "std:array<double, 10>", "h2dts_compat_array_0038 param type");
      });
      assert.ok(finished, 'compat task must finish without process crash');
    } catch (err) {
  ...
  test('h2dts_compat_array_0039', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const r = parsec.parseFunction(`void compat45(itn p);`);
        assert.ok(Array.isArray(r) && r.length >= 1,
  ...
  test('h2dts_compat_array_0040', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const r = parsec.parseFunction(`void compat45(doubl p);`);
        assert.ok(Array.isArray(r) && r.length >= 1,
  ...
  test('h2dts_compat_array_0041', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const r = parsec.parseFunction(`void compat45(boool p);`);
        assert.ok(Array.isArray(r) && r.length >= 1,
  ...
  test('h2dts_compat_array_0042', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const r = parsec.parseFunction(`void compat45(intt p);`);
        assert.ok(Array.isArray(r) && r.length >= 1,
  ...
  test('h2dts_compat_array_0043', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const r = parsec.parseFunction(`void compat45(flot p);`);
        assert.ok(Array.isArray(r) && r.length >= 1,
  ...
  test('h2dts_compat_array_0044', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const r = parsec.parseFunction(`namespace ns { void compat45(std::array<float, 10> p); }`);
        assert.ok(Array.isArray(r) && r.length >= 1,
  ...
  test('h2dts_compat_array_0045', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const r = parsec.parseFunction(`void compat45(bad_type_45 p);`);
        assert.ok(Array.isArray(r) && r.length >= 1,
        ...
        assert.strictEqual(r[0].parameters[0].type, "bad_type_45", "h2dts_compat_array_0045 param type");
      });
      assert.ok(finished, 'compat task must finish without process crash');
    } catch (err) {
  ...
  test('h2dts_compat_array_0046', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const r = parsec.parseFunction(`void compat45(std::array<float, 10> p);`);
        assert.ok(Array.isArray(r) && r.length >= 1,
  ...
  test('h2dts_compat_array_0047', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const r = parsec.parseFunction(`enum E45 { A, B }; void f(E45 e);`);
        assert.ok(Array.isArray(r) && r.length >= 1,
  ...
  test('h2dts_compat_array_0048', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        ...
        assert.strictEqual(r[0].parameters[0].type, "std:array<float, 10>", "h2dts_compat_array_0048 param type");
      });
      assert.ok(finished, 'compat task must finish without process crash');
    } catch (err) {
  ...
  test('h2dts_compat_array_0049', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const r = parsec.parseFunction(`void compat46(itn p);`);
        assert.ok(Array.isArray(r) && r.length >= 1,
  ...
  test('h2dts_compat_array_0050', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const r = parsec.parseFunction(`void compat46(doubl p);`);
        assert.ok(Array.isArray(r) && r.length >= 1,
  ...
  test('h2dts_compat_array_0051', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const r = parsec.parseFunction(`void compat46(boool p);`);
        assert.ok(Array.isArray(r) && r.length >= 1,
  ...
  test('h2dts_compat_array_0052', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const r = parsec.parseFunction(`void compat46(intt p);`);
        assert.ok(Array.isArray(r) && r.length >= 1,
  ...
  test('h2dts_compat_array_0053', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const r = parsec.parseFunction(`void compat46(flot p);`);
        assert.ok(Array.isArray(r) && r.length >= 1,
  ...
  test('h2dts_compat_array_0054', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const r = parsec.parseFunction(`namespace ns { void compat46(std::array<long, 10> p); }`);
        assert.ok(Array.isArray(r) && r.length >= 1,
  ...
  test('h2dts_compat_array_0055', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const r = parsec.parseFunction(`void compat46(bad_type_46 p);`);
        assert.ok(Array.isArray(r) && r.length >= 1,
        ...
        assert.strictEqual(r[0].parameters[0].type, "bad_type_46", "h2dts_compat_array_0055 param type");
      });
      assert.ok(finished, 'compat task must finish without process crash');
    } catch (err) {
  ...
  test('h2dts_compat_array_0056', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const r = parsec.parseFunction(`void compat46(std::array<long, 10> p);`);
        assert.ok(Array.isArray(r) && r.length >= 1,
  ...
  test('h2dts_compat_array_0057', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const r = parsec.parseFunction(`enum E46 { A, B }; void f(E46 e);`);
        assert.ok(Array.isArray(r) && r.length >= 1,
  ...
  test('h2dts_compat_array_0058', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        ...
        assert.strictEqual(r[0].parameters[0].type, "std:array<long, 10>", "h2dts_compat_array_0058 param type");
      });
      assert.ok(finished, 'compat task must finish without process crash');
    } catch (err) {
  ...
  test('h2dts_compat_array_0059', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const r = parsec.parseFunction(`void compat47(itn p);`);
        assert.ok(Array.isArray(r) && r.length >= 1,
  ...
  test('h2dts_compat_array_0060', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const r = parsec.parseFunction(`void compat47(doubl p);`);
        assert.ok(Array.isArray(r) && r.length >= 1,
  ...
  test('h2dts_compat_array_0061', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const r = parsec.parseFunction(`void compat47(boool p);`);
        assert.ok(Array.isArray(r) && r.length >= 1,
  ...
  test('h2dts_compat_array_0062', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const r = parsec.parseFunction(`void compat47(intt p);`);
        assert.ok(Array.isArray(r) && r.length >= 1,
  ...
  test('h2dts_compat_array_0063', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const r = parsec.parseFunction(`void compat47(flot p);`);
        assert.ok(Array.isArray(r) && r.length >= 1,
  ...
  test('h2dts_compat_array_0064', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const r = parsec.parseFunction(`namespace ns { void compat47(std::array<short, 10> p); }`);
        assert.ok(Array.isArray(r) && r.length >= 1,
  ...
  test('h2dts_compat_array_0065', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const r = parsec.parseFunction(`void compat47(bad_type_47 p);`);
        assert.ok(Array.isArray(r) && r.length >= 1,
        ...
        assert.strictEqual(r[0].parameters[0].type, "bad_type_47", "h2dts_compat_array_0065 param type");
      });
      assert.ok(finished, 'compat task must finish without process crash');
    } catch (err) {
  ...
  test('h2dts_compat_array_0066', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const r = parsec.parseFunction(`void compat47(std::array<short, 10> p);`);
        assert.ok(Array.isArray(r) && r.length >= 1,
  ...
  test('h2dts_compat_array_0067', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const r = parsec.parseFunction(`enum E47 { A, B }; void f(E47 e);`);
        assert.ok(Array.isArray(r) && r.length >= 1,
  ...
  test('h2dts_compat_array_0068', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        ...
        assert.strictEqual(r[0].parameters[0].type, "std:array<short, 10>", "h2dts_compat_array_0068 param type");
      });
      assert.ok(finished, 'compat task must finish without process crash');
    } catch (err) {
  ...
  test('h2dts_compat_array_0069', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const r = parsec.parseFunction(`void compat48(itn p);`);
        assert.ok(Array.isArray(r) && r.length >= 1,
  ...
  test('h2dts_compat_array_0070', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const r = parsec.parseFunction(`void compat48(doubl p);`);
        assert.ok(Array.isArray(r) && r.length >= 1,
  ...
  test('h2dts_compat_array_0071', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const r = parsec.parseFunction(`void compat48(boool p);`);
        assert.ok(Array.isArray(r) && r.length >= 1,
  ...
  test('h2dts_compat_array_0072', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const r = parsec.parseFunction(`void compat48(intt p);`);
        assert.ok(Array.isArray(r) && r.length >= 1,
  ...
  test('h2dts_compat_array_0073', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const r = parsec.parseFunction(`void compat48(flot p);`);
        assert.ok(Array.isArray(r) && r.length >= 1,
  ...
  test('h2dts_compat_array_0074', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const r = parsec.parseFunction(`namespace ns { void compat48(std::array<uint8_t, 10> p); }`);
        assert.ok(Array.isArray(r) && r.length >= 1,
  ...
  test('h2dts_compat_array_0075', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const r = parsec.parseFunction(`void compat48(bad_type_48 p);`);
        assert.ok(Array.isArray(r) && r.length >= 1,
        ...
        assert.strictEqual(r[0].parameters[0].type, "bad_type_48", "h2dts_compat_array_0075 param type");
      });
      assert.ok(finished, 'compat task must finish without process crash');
    } catch (err) {
  ...
  test('h2dts_compat_array_0076', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const r = parsec.parseFunction(`void compat48(std::array<uint8_t, 10> p);`);
        assert.ok(Array.isArray(r) && r.length >= 1,
  ...
  test('h2dts_compat_array_0077', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const r = parsec.parseFunction(`enum E48 { A, B }; void f(E48 e);`);
        assert.ok(Array.isArray(r) && r.length >= 1,
  ...
  test('h2dts_compat_array_0078', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        ...
        assert.strictEqual(r[0].parameters[0].type, "std:array<uint8_t, 10>", "h2dts_compat_array_0078 param type");
      });
      assert.ok(finished, 'compat task must finish without process crash');
    } catch (err) {
  ...
  test('h2dts_compat_array_0079', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const r = parsec.parseFunction(`void compat49(itn p);`);
        assert.ok(Array.isArray(r) && r.length >= 1,
  ...
  test('h2dts_compat_array_0080', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const r = parsec.parseFunction(`void compat49(doubl p);`);
        assert.ok(Array.isArray(r) && r.length >= 1,
  ...
  test('h2dts_compat_array_0081', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const r = parsec.parseFunction(`void compat49(boool p);`);
        assert.ok(Array.isArray(r) && r.length >= 1,
  ...
  test('h2dts_compat_array_0082', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const r = parsec.parseFunction(`void compat49(intt p);`);
        assert.ok(Array.isArray(r) && r.length >= 1,
  ...
  test('h2dts_compat_array_0083', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const r = parsec.parseFunction(`void compat49(flot p);`);
        assert.ok(Array.isArray(r) && r.length >= 1,
  ...
  test('h2dts_compat_array_0084', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const r = parsec.parseFunction(`namespace ns { void compat49(std::array<uint16_t, 10> p); }`);
        assert.ok(Array.isArray(r) && r.length >= 1,
  ...
  test('h2dts_compat_array_0085', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const r = parsec.parseFunction(`void compat49(bad_type_49 p);`);
        assert.ok(Array.isArray(r) && r.length >= 1,
        ...
        assert.strictEqual(r[0].parameters[0].type, "bad_type_49", "h2dts_compat_array_0085 param type");
      });
      assert.ok(finished, 'compat task must finish without process crash');
    } catch (err) {
  ...
  test('h2dts_compat_array_0086', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const r = parsec.parseFunction(`void compat49(std::array<uint16_t, 10> p);`);
        assert.ok(Array.isArray(r) && r.length >= 1,
  ...
  test('h2dts_compat_array_0087', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const r = parsec.parseFunction(`enum E49 { A, B }; void f(E49 e);`);
        assert.ok(Array.isArray(r) && r.length >= 1,
  ...
  test('h2dts_compat_array_0088', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        ...
        assert.strictEqual(r[0].parameters[0].type, "std:array<uint16_t, 10>", "h2dts_compat_array_0088 param type");
      });
      assert.ok(finished, 'compat task must finish without process crash');
    } catch (err) {
  ...
  test('h2dts_compat_array_0089', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const r = parsec.parseFunction(`void compat50(itn p);`);
        assert.ok(Array.isArray(r) && r.length >= 1,
  ...
  test('h2dts_compat_array_0090', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const r = parsec.parseFunction(`void compat50(doubl p);`);
        assert.ok(Array.isArray(r) && r.length >= 1,
  ...
  test('h2dts_compat_array_0091', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const r = parsec.parseFunction(`void compat50(boool p);`);
        assert.ok(Array.isArray(r) && r.length >= 1,
  ...
  test('h2dts_compat_array_0092', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const r = parsec.parseFunction(`void compat50(intt p);`);
        assert.ok(Array.isArray(r) && r.length >= 1,
  ...
  test('h2dts_compat_array_0093', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const r = parsec.parseFunction(`void compat50(flot p);`);
        assert.ok(Array.isArray(r) && r.length >= 1,
  ...
  test('h2dts_compat_array_0094', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const r = parsec.parseFunction(`namespace ns { void compat50(std::array<uint32_t, 10> p); }`);
        assert.ok(Array.isArray(r) && r.length >= 1,
  ...
  test('h2dts_compat_array_0095', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const r = parsec.parseFunction(`void compat50(bad_type_50 p);`);
        assert.ok(Array.isArray(r) && r.length >= 1,
        ...
        assert.strictEqual(r[0].parameters[0].type, "bad_type_50", "h2dts_compat_array_0095 param type");
      });
      assert.ok(finished, 'compat task must finish without process crash');
    } catch (err) {
  ...
  test('h2dts_compat_array_0096', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const r = parsec.parseFunction(`void compat50(std::array<uint32_t, 10> p);`);
        assert.ok(Array.isArray(r) && r.length >= 1,
  ...
  test('h2dts_compat_array_0097', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const r = parsec.parseFunction(`enum E50 { A, B }; void f(E50 e);`);
        assert.ok(Array.isArray(r) && r.length >= 1,
  ...
  test('h2dts_compat_array_0098', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        ...
        assert.strictEqual(r[0].parameters[0].type, "std:array<uint32_t, 10>", "h2dts_compat_array_0098 param type");
      });
      assert.ok(finished, 'compat task must finish without process crash');
    } catch (err) {
  ...
  test('h2dts_compat_array_0099', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const r = parsec.parseFunction(`void compat51(itn p);`);
        assert.ok(Array.isArray(r) && r.length >= 1,
  ...
  test('h2dts_compat_array_0100', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const r = parsec.parseFunction(`void compat51(doubl p);`);
        assert.ok(Array.isArray(r) && r.length >= 1,
  ...
  test('h2dts_compat_array_0101', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const r = parsec.parseFunction(`void compat51(boool p);`);
        assert.ok(Array.isArray(r) && r.length >= 1,
