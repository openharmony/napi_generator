...
suite('Stability_H2DTS_COMPAT_MAP_Part02', function() {
  this.timeout(600000);
  vscode.window.showInformationMessage('Start Stability_H2DTS_COMPAT_MAP_Part02.');
  ...
  test('h2dts_compat_map_0001', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const r = parsec.parseFunction(`void compat570(doubl p);`);
        ...
        assert.strictEqual(r[0].parameters[0].type, "doubl", "h2dts_compat_map_0001 param type");
      });
  ...
  test('h2dts_compat_map_0002', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const r = parsec.parseFunction(`void compat570(boool p);`);
        ...
        assert.strictEqual(r[0].parameters[0].type, "boool", "h2dts_compat_map_0002 param type");
      });
      assert.ok(finished, 'compat task must finish without process crash');
    } catch (err) {
  ...
  test('h2dts_compat_map_0003', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const r = parsec.parseFunction(`void compat570(intt p);`);
        ...
        assert.strictEqual(r[0].parameters[0].type, "intt", "h2dts_compat_map_0003 param type");
      });
      assert.ok(finished, 'compat task must finish without process crash');
    } catch (err) {
  ...
  test('h2dts_compat_map_0004', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const r = parsec.parseFunction(`void compat570(flot p);`);
        ...
        assert.strictEqual(r[0].parameters[0].type, "flot", "h2dts_compat_map_0004 param type");
      });
      assert.ok(finished, 'compat task must finish without process crash');
    } catch (err) {
  ...
  test('h2dts_compat_map_0005', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const r = parsec.parseFunction(`namespace ns { void compat570(std::map<wchar_t, uint16_t> p); }`);
        ...
        assert.strictEqual(converted, "Map<string, number>", "h2dts_compat_map_0005_param convert output");
      });
      assert.ok(finished, 'compat task must finish without process crash');
    } catch (err) {
  ...
  test('h2dts_compat_map_0006', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const r = parsec.parseFunction(`void compat570(bad_type_570 p);`);
        ...
        assert.strictEqual(r[0].parameters[0].type, "bad_type_570", "h2dts_compat_map_0006 param type");
      });
      assert.ok(finished, 'compat task must finish without process crash');
    } catch (err) {
  ...
  test('h2dts_compat_map_0007', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const r = parsec.parseFunction(`void compat570(std::map<wchar_t, uint16_t> p);`);
        ...
        const converted = transTskey2Ckey(r[0].parameters[0].type);
        assert.ok(typeof converted === 'string' && converted.length > 0,
          "h2dts_compat_map_0007_param convert output non-empty");
        assert.strictEqual(converted, "Map<string, number>", "h2dts_compat_map_0007_param convert output");
      });
      assert.ok(finished, 'compat task must finish without process crash');
    } catch (err) {
  ...
  test('h2dts_compat_map_0008', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const r = parsec.parseFunction(`enum E570 { A, B }; void f(E570 e);`);
        ...
        assert.strictEqual(r[0].name, "f", "h2dts_compat_map_0008 func name");
      });
      assert.ok(finished, 'compat task must finish without process crash');
    } catch (err) {
  ...
  test('h2dts_compat_map_0009', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        ...
        assert.strictEqual(r[0].parameters[0].type, "std:map<wchar_t, uint16_t>", "h2dts_compat_map_0009 param type");
      });
      assert.ok(finished, 'compat task must finish without process crash');
    } catch (err) {
  ...
  test('h2dts_compat_map_0010', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const r = parsec.parseFunction(`void compat571(itn p);`);
        ...
        assert.strictEqual(r[0].parameters[0].type, "itn", "h2dts_compat_map_0010 param type");
      });
      assert.ok(finished, 'compat task must finish without process crash');
    } catch (err) {
  ...
  test('h2dts_compat_map_0011', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const r = parsec.parseFunction(`void compat571(doubl p);`);
        ...
        assert.strictEqual(r[0].parameters[0].type, "doubl", "h2dts_compat_map_0011 param type");
      });
      assert.ok(finished, 'compat task must finish without process crash');
    } catch (err) {
  ...
  test('h2dts_compat_map_0012', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const r = parsec.parseFunction(`void compat571(boool p);`);
        ...
        assert.strictEqual(r[0].parameters[0].type, "boool", "h2dts_compat_map_0012 param type");
      });
      assert.ok(finished, 'compat task must finish without process crash');
    } catch (err) {
  ...
  test('h2dts_compat_map_0013', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const r = parsec.parseFunction(`void compat571(intt p);`);
        ...
        assert.strictEqual(r[0].parameters[0].type, "intt", "h2dts_compat_map_0013 param type");
      });
      assert.ok(finished, 'compat task must finish without process crash');
    } catch (err) {
  ...
  test('h2dts_compat_map_0014', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const r = parsec.parseFunction(`void compat571(flot p);`);
        ...
        assert.strictEqual(r[0].parameters[0].type, "flot", "h2dts_compat_map_0014 param type");
      });
      assert.ok(finished, 'compat task must finish without process crash');
    } catch (err) {
  ...
  test('h2dts_compat_map_0015', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const r = parsec.parseFunction(`namespace ns { void compat571(std::map<int, bool> p); }`);
        ...
        assert.strictEqual(converted, "Map<number, boolean>", "h2dts_compat_map_0015_param convert output");
      });
      assert.ok(finished, 'compat task must finish without process crash');
    } catch (err) {
  ...
  test('h2dts_compat_map_0016', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const r = parsec.parseFunction(`void compat571(bad_type_571 p);`);
        ...
        assert.strictEqual(r[0].parameters[0].type, "bad_type_571", "h2dts_compat_map_0016 param type");
      });
      assert.ok(finished, 'compat task must finish without process crash');
    } catch (err) {
  ...
  test('h2dts_compat_map_0017', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const r = parsec.parseFunction(`void compat571(std::map<int, bool> p);`);
        ...
        const converted = transTskey2Ckey(r[0].parameters[0].type);
        assert.ok(typeof converted === 'string' && converted.length > 0,
          "h2dts_compat_map_0017_param convert output non-empty");
        assert.strictEqual(converted, "Map<number, boolean>", "h2dts_compat_map_0017_param convert output");
      });
      assert.ok(finished, 'compat task must finish without process crash');
    } catch (err) {
  ...
  test('h2dts_compat_map_0018', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const r = parsec.parseFunction(`enum E571 { A, B }; void f(E571 e);`);
        ...
        assert.strictEqual(r[0].name, "f", "h2dts_compat_map_0018 func name");
      });
      assert.ok(finished, 'compat task must finish without process crash');
    } catch (err) {
  ...
  test('h2dts_compat_map_0019', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        ...
        assert.strictEqual(r[0].parameters[0].type, "std:map<int, bool>", "h2dts_compat_map_0019 param type");
      });
      assert.ok(finished, 'compat task must finish without process crash');
    } catch (err) {
  ...
  test('h2dts_compat_map_0020', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const r = parsec.parseFunction(`void compat572(itn p);`);
        ...
        assert.strictEqual(r[0].parameters[0].type, "itn", "h2dts_compat_map_0020 param type");
      });
      assert.ok(finished, 'compat task must finish without process crash');
    } catch (err) {
  ...
  test('h2dts_compat_map_0021', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const r = parsec.parseFunction(`void compat572(doubl p);`);
        ...
        assert.strictEqual(r[0].parameters[0].type, "doubl", "h2dts_compat_map_0021 param type");
      });
      assert.ok(finished, 'compat task must finish without process crash');
    } catch (err) {
  ...
  test('h2dts_compat_map_0022', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const r = parsec.parseFunction(`void compat572(boool p);`);
        ...
        assert.strictEqual(r[0].parameters[0].type, "boool", "h2dts_compat_map_0022 param type");
      });
      assert.ok(finished, 'compat task must finish without process crash');
    } catch (err) {
  ...
  test('h2dts_compat_map_0023', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const r = parsec.parseFunction(`void compat572(intt p);`);
        ...
        assert.strictEqual(r[0].parameters[0].type, "intt", "h2dts_compat_map_0023 param type");
      });
      assert.ok(finished, 'compat task must finish without process crash');
    } catch (err) {
  ...
  test('h2dts_compat_map_0024', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const r = parsec.parseFunction(`void compat572(flot p);`);
        ...
        assert.strictEqual(r[0].parameters[0].type, "flot", "h2dts_compat_map_0024 param type");
      });
      assert.ok(finished, 'compat task must finish without process crash');
    } catch (err) {
  ...
  test('h2dts_compat_map_0025', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const r = parsec.parseFunction(`namespace ns { void compat572(std::map<char, bool> p); }`);
        ...
        assert.strictEqual(converted, "Map<string, boolean>", "h2dts_compat_map_0025_param convert output");
      });
      assert.ok(finished, 'compat task must finish without process crash');
    } catch (err) {
  ...
  test('h2dts_compat_map_0026', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const r = parsec.parseFunction(`void compat572(bad_type_572 p);`);
        ...
        assert.strictEqual(r[0].parameters[0].type, "bad_type_572", "h2dts_compat_map_0026 param type");
      });
      assert.ok(finished, 'compat task must finish without process crash');
    } catch (err) {
  ...
  test('h2dts_compat_map_0027', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const r = parsec.parseFunction(`void compat572(std::map<char, bool> p);`);
        ...
        const converted = transTskey2Ckey(r[0].parameters[0].type);
        assert.ok(typeof converted === 'string' && converted.length > 0,
          "h2dts_compat_map_0027_param convert output non-empty");
        assert.strictEqual(converted, "Map<string, boolean>", "h2dts_compat_map_0027_param convert output");
      });
      assert.ok(finished, 'compat task must finish without process crash');
    } catch (err) {
  ...
  test('h2dts_compat_map_0028', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const r = parsec.parseFunction(`enum E572 { A, B }; void f(E572 e);`);
        ...
        assert.strictEqual(r[0].name, "f", "h2dts_compat_map_0028 func name");
      });
      assert.ok(finished, 'compat task must finish without process crash');
    } catch (err) {
  ...
  test('h2dts_compat_map_0029', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        ...
        assert.strictEqual(r[0].parameters[0].type, "std:map<char, bool>", "h2dts_compat_map_0029 param type");
      });
      assert.ok(finished, 'compat task must finish without process crash');
    } catch (err) {
  ...
  test('h2dts_compat_map_0030', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const r = parsec.parseFunction(`void compat573(itn p);`);
        ...
        assert.strictEqual(r[0].parameters[0].type, "itn", "h2dts_compat_map_0030 param type");
      });
      assert.ok(finished, 'compat task must finish without process crash');
    } catch (err) {
  ...
  test('h2dts_compat_map_0031', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const r = parsec.parseFunction(`void compat573(doubl p);`);
        ...
        assert.strictEqual(r[0].parameters[0].type, "doubl", "h2dts_compat_map_0031 param type");
      });
      assert.ok(finished, 'compat task must finish without process crash');
    } catch (err) {
  ...
  test('h2dts_compat_map_0032', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const r = parsec.parseFunction(`void compat573(boool p);`);
        ...
        assert.strictEqual(r[0].parameters[0].type, "boool", "h2dts_compat_map_0032 param type");
      });
      assert.ok(finished, 'compat task must finish without process crash');
    } catch (err) {
  ...
  test('h2dts_compat_map_0033', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const r = parsec.parseFunction(`void compat573(intt p);`);
        ...
        assert.strictEqual(r[0].parameters[0].type, "intt", "h2dts_compat_map_0033 param type");
      });
      assert.ok(finished, 'compat task must finish without process crash');
    } catch (err) {
  ...
  test('h2dts_compat_map_0034', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const r = parsec.parseFunction(`void compat573(flot p);`);
        ...
        assert.strictEqual(r[0].parameters[0].type, "flot", "h2dts_compat_map_0034 param type");
      });
      assert.ok(finished, 'compat task must finish without process crash');
    } catch (err) {
  ...
  test('h2dts_compat_map_0035', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const r = parsec.parseFunction(`namespace ns { void compat573(std::map<int, char> p); }`);
        ...
        assert.strictEqual(converted, "Map<number, string>", "h2dts_compat_map_0035_param convert output");
      });
      assert.ok(finished, 'compat task must finish without process crash');
    } catch (err) {
  ...
  test('h2dts_compat_map_0036', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const r = parsec.parseFunction(`void compat573(bad_type_573 p);`);
        ...
        assert.strictEqual(r[0].parameters[0].type, "bad_type_573", "h2dts_compat_map_0036 param type");
      });
      assert.ok(finished, 'compat task must finish without process crash');
    } catch (err) {
  ...
  test('h2dts_compat_map_0037', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const r = parsec.parseFunction(`void compat573(std::map<int, char> p);`);
        ...
        const converted = transTskey2Ckey(r[0].parameters[0].type);
        assert.ok(typeof converted === 'string' && converted.length > 0,
          "h2dts_compat_map_0037_param convert output non-empty");
        assert.strictEqual(converted, "Map<number, string>", "h2dts_compat_map_0037_param convert output");
      });
      assert.ok(finished, 'compat task must finish without process crash');
    } catch (err) {
  ...
  test('h2dts_compat_map_0038', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const r = parsec.parseFunction(`enum E573 { A, B }; void f(E573 e);`);
        ...
        assert.strictEqual(r[0].name, "f", "h2dts_compat_map_0038 func name");
      });
      assert.ok(finished, 'compat task must finish without process crash');
    } catch (err) {
  ...
  test('h2dts_compat_map_0039', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        ...
        assert.ok(r[0].parameters && r[0].parameters.length >= 1, "h2dts_compat_map_0039 must parse param");
        assert.strictEqual(r[0].parameters[0].type, "std:map<int, char>", "h2dts_compat_map_0039 param type");
      });
      assert.ok(finished, 'compat task must finish without process crash');
    } catch (err) {
  ...
  test('h2dts_compat_map_0040', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const r = parsec.parseFunction(`void compat574(itn p);`);
        ...
        assert.strictEqual(r[0].parameters[0].type, "itn", "h2dts_compat_map_0040 param type");
      });
      assert.ok(finished, 'compat task must finish without process crash');
    } catch (err) {
  ...
  test('h2dts_compat_map_0041', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const r = parsec.parseFunction(`void compat574(doubl p);`);
        ...
        assert.strictEqual(r[0].parameters[0].type, "doubl", "h2dts_compat_map_0041 param type");
      });
      assert.ok(finished, 'compat task must finish without process crash');
    } catch (err) {
  ...
  test('h2dts_compat_map_0042', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const r = parsec.parseFunction(`void compat574(boool p);`);
        ...
        assert.strictEqual(r[0].parameters[0].type, "boool", "h2dts_compat_map_0042 param type");
      });
      assert.ok(finished, 'compat task must finish without process crash');
    } catch (err) {
  ...
  test('h2dts_compat_map_0043', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const r = parsec.parseFunction(`void compat574(intt p);`);
        ...
        assert.strictEqual(r[0].parameters[0].type, "intt", "h2dts_compat_map_0043 param type");
      });
      assert.ok(finished, 'compat task must finish without process crash');
    } catch (err) {
  ...
  test('h2dts_compat_map_0044', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const r = parsec.parseFunction(`void compat574(flot p);`);
        ...
        assert.strictEqual(r[0].parameters[0].type, "flot", "h2dts_compat_map_0044 param type");
      });
      assert.ok(finished, 'compat task must finish without process crash');
    } catch (err) {
  ...
  test('h2dts_compat_map_0045', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const r = parsec.parseFunction(`namespace ns { void compat574(std::map<size_t, char> p); }`);
        ...
        const converted = transTskey2Ckey(r[0].parameters[0].type);
        assert.ok(typeof converted === 'string' && converted.length > 0,
          "h2dts_compat_map_0045_param convert output non-empty");
        assert.strictEqual(converted, "Map<number, string>", "h2dts_compat_map_0045_param convert output");
      });
      assert.ok(finished, 'compat task must finish without process crash');
    } catch (err) {
  ...
  test('h2dts_compat_map_0046', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const r = parsec.parseFunction(`void compat574(bad_type_574 p);`);
        ...
        assert.strictEqual(r[0].parameters[0].type, "bad_type_574", "h2dts_compat_map_0046 param type");
      });
      assert.ok(finished, 'compat task must finish without process crash');
    } catch (err) {
  ...
  test('h2dts_compat_map_0047', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const r = parsec.parseFunction(`void compat574(std::map<size_t, char> p);`);
        ...
        const converted = transTskey2Ckey(r[0].parameters[0].type);
        assert.ok(typeof converted === 'string' && converted.length > 0,
          "h2dts_compat_map_0047_param convert output non-empty");
        assert.strictEqual(converted, "Map<number, string>", "h2dts_compat_map_0047_param convert output");
      });
      assert.ok(finished, 'compat task must finish without process crash');
    } catch (err) {
  ...
  test('h2dts_compat_map_0048', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const r = parsec.parseFunction(`enum E574 { A, B }; void f(E574 e);`);
        ...
        assert.strictEqual(r[0].name, "f", "h2dts_compat_map_0048 func name");
      });
      assert.ok(finished, 'compat task must finish without process crash');
    } catch (err) {
  ...
  test('h2dts_compat_map_0049', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        ...
        assert.ok(r[0].parameters && r[0].parameters.length >= 1, "h2dts_compat_map_0049 must parse param");
        assert.strictEqual(r[0].parameters[0].type, "std:map<size_t, char>", "h2dts_compat_map_0049 param type");
      });
      assert.ok(finished, 'compat task must finish without process crash');
    } catch (err) {
  ...
  test('h2dts_compat_map_0050', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const r = parsec.parseFunction(`void compat575(itn p);`);
        ...
        assert.strictEqual(r[0].parameters[0].type, "itn", "h2dts_compat_map_0050 param type");
      });
      assert.ok(finished, 'compat task must finish without process crash');
    } catch (err) {
  ...
  test('h2dts_compat_map_0051', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const r = parsec.parseFunction(`void compat575(doubl p);`);
        ...
        assert.strictEqual(r[0].parameters[0].type, "doubl", "h2dts_compat_map_0051 param type");
      });
      assert.ok(finished, 'compat task must finish without process crash');
    } catch (err) {
  ...
  test('h2dts_compat_map_0052', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const r = parsec.parseFunction(`void compat575(boool p);`);
        ...
        assert.strictEqual(r[0].parameters[0].type, "boool", "h2dts_compat_map_0052 param type");
      });
      assert.ok(finished, 'compat task must finish without process crash');
    } catch (err) {
  ...
  test('h2dts_compat_map_0053', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const r = parsec.parseFunction(`void compat575(intt p);`);
        ...
        assert.strictEqual(r[0].parameters[0].type, "intt", "h2dts_compat_map_0053 param type");
      });
      assert.ok(finished, 'compat task must finish without process crash');
    } catch (err) {
  ...
  test('h2dts_compat_map_0054', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const r = parsec.parseFunction(`void compat575(flot p);`);
        ...
        assert.strictEqual(r[0].parameters[0].type, "flot", "h2dts_compat_map_0054 param type");
      });
      assert.ok(finished, 'compat task must finish without process crash');
    } catch (err) {
  ...
  test('h2dts_compat_map_0055', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const r = parsec.parseFunction(`namespace ns { void compat575(std::map<unsigned, char> p); }`);
        ...
        const converted = transTskey2Ckey(r[0].parameters[0].type);
        assert.ok(typeof converted === 'string' && converted.length > 0,
          "h2dts_compat_map_0055_param convert output non-empty");
        assert.strictEqual(converted, "Map<number, string>", "h2dts_compat_map_0055_param convert output");
      });
      assert.ok(finished, 'compat task must finish without process crash');
    } catch (err) {
  ...
  test('h2dts_compat_map_0056', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const r = parsec.parseFunction(`void compat575(bad_type_575 p);`);
        ...
        assert.strictEqual(r[0].parameters[0].type, "bad_type_575", "h2dts_compat_map_0056 param type");
      });
      assert.ok(finished, 'compat task must finish without process crash');
    } catch (err) {
  ...
  test('h2dts_compat_map_0057', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const r = parsec.parseFunction(`void compat575(std::map<unsigned, char> p);`);
        ...
        const converted = transTskey2Ckey(r[0].parameters[0].type);
        assert.ok(typeof converted === 'string' && converted.length > 0,
          "h2dts_compat_map_0057_param convert output non-empty");
        assert.strictEqual(converted, "Map<number, string>", "h2dts_compat_map_0057_param convert output");
      });
      assert.ok(finished, 'compat task must finish without process crash');
    } catch (err) {
  ...
  test('h2dts_compat_map_0058', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const r = parsec.parseFunction(`enum E575 { A, B }; void f(E575 e);`);
        ...
        assert.strictEqual(r[0].name, "f", "h2dts_compat_map_0058 func name");
      });
      assert.ok(finished, 'compat task must finish without process crash');
    } catch (err) {
  ...
  test('h2dts_compat_map_0059', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        ...
        assert.ok(r[0].parameters && r[0].parameters.length >= 1, "h2dts_compat_map_0059 must parse param");
        assert.strictEqual(r[0].parameters[0].type, "std:map<unsigned, char>", "h2dts_compat_map_0059 param type");
      });
      assert.ok(finished, 'compat task must finish without process crash');
    } catch (err) {
  ...
  test('h2dts_compat_map_0060', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const r = parsec.parseFunction(`void compat592(itn p);`);
        ...
        assert.strictEqual(r[0].parameters[0].type, "itn", "h2dts_compat_map_0060 param type");
      });
      assert.ok(finished, 'compat task must finish without process crash');
    } catch (err) {
  ...
  test('h2dts_compat_map_0061', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const r = parsec.parseFunction(`void compat592(doubl p);`);
        ...
        assert.strictEqual(r[0].parameters[0].type, "doubl", "h2dts_compat_map_0061 param type");
      });
      assert.ok(finished, 'compat task must finish without process crash');
    } catch (err) {
  ...
  test('h2dts_compat_map_0062', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const r = parsec.parseFunction(`void compat592(boool p);`);
        ...
        assert.strictEqual(r[0].parameters[0].type, "boool", "h2dts_compat_map_0062 param type");
      });
      assert.ok(finished, 'compat task must finish without process crash');
    } catch (err) {
  ...
  test('h2dts_compat_map_0063', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const r = parsec.parseFunction(`void compat592(intt p);`);
        ...
        assert.strictEqual(r[0].parameters[0].type, "intt", "h2dts_compat_map_0063 param type");
      });
      assert.ok(finished, 'compat task must finish without process crash');
    } catch (err) {
  ...
  test('h2dts_compat_map_0064', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const r = parsec.parseFunction(`void compat592(flot p);`);
        ...
        assert.strictEqual(r[0].parameters[0].type, "flot", "h2dts_compat_map_0064 param type");
      });
      assert.ok(finished, 'compat task must finish without process crash');
    } catch (err) {
  ...
  test('h2dts_compat_map_0065', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const r = parsec.parseFunction(`namespace ns { void compat592(std::unordered_map<int, int> p); }`);
        ...
        const converted = transTskey2Ckey(r[0].parameters[0].type);
        assert.ok(typeof converted === 'string' && converted.length > 0,
          "h2dts_compat_map_0065_param convert output non-empty");
        assert.strictEqual(converted, "Map<number, number>", "h2dts_compat_map_0065_param convert output");
      });
      assert.ok(finished, 'compat task must finish without process crash');
    } catch (err) {
  ...
  test('h2dts_compat_map_0066', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const r = parsec.parseFunction(`void compat592(bad_type_592 p);`);
        ...
        assert.strictEqual(r[0].parameters[0].type, "bad_type_592", "h2dts_compat_map_0066 param type");
      });
      assert.ok(finished, 'compat task must finish without process crash');
    } catch (err) {
  ...
  test('h2dts_compat_map_0067', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const r = parsec.parseFunction(`void compat592(std::unordered_map<int, int> p);`);
        ...
        const converted = transTskey2Ckey(r[0].parameters[0].type);
        assert.ok(typeof converted === 'string' && converted.length > 0,
          "h2dts_compat_map_0067_param convert output non-empty");
        assert.strictEqual(converted, "Map<number, number>", "h2dts_compat_map_0067_param convert output");
      });
      assert.ok(finished, 'compat task must finish without process crash');
    } catch (err) {
  ...
  test('h2dts_compat_map_0068', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const r = parsec.parseFunction(`enum E592 { A, B }; void f(E592 e);`);
        ...
        assert.strictEqual(r[0].name, "f", "h2dts_compat_map_0068 func name");
      });
      assert.ok(finished, 'compat task must finish without process crash');
    } catch (err) {
  ...
  test('h2dts_compat_map_0069', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        ...
        assert.ok(r[0].parameters && r[0].parameters.length >= 1, "h2dts_compat_map_0069 must parse param");
        assert.strictEqual(r[0].parameters[0].type, "std:unordered_map<int, int>", "h2dts_compat_map_0069 param type");
      });
      assert.ok(finished, 'compat task must finish without process crash');
    } catch (err) {
  ...
  test('h2dts_compat_map_0070', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const r = parsec.parseFunction(`void compat593(itn p);`);
        ...
        assert.strictEqual(r[0].parameters[0].type, "itn", "h2dts_compat_map_0070 param type");
      });
      assert.ok(finished, 'compat task must finish without process crash');
    } catch (err) {
  ...
  test('h2dts_compat_map_0071', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const r = parsec.parseFunction(`void compat593(doubl p);`);
        ...
        assert.strictEqual(r[0].parameters[0].type, "doubl", "h2dts_compat_map_0071 param type");
      });
      assert.ok(finished, 'compat task must finish without process crash');
    } catch (err) {
  ...
  test('h2dts_compat_map_0072', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const r = parsec.parseFunction(`void compat593(boool p);`);
        ...
        assert.strictEqual(r[0].parameters[0].type, "boool", "h2dts_compat_map_0072 param type");
      });
      assert.ok(finished, 'compat task must finish without process crash');
    } catch (err) {
  ...
  test('h2dts_compat_map_0073', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const r = parsec.parseFunction(`void compat593(intt p);`);
        ...
        assert.strictEqual(r[0].parameters[0].type, "intt", "h2dts_compat_map_0073 param type");
      });
      assert.ok(finished, 'compat task must finish without process crash');
    } catch (err) {
  ...
  test('h2dts_compat_map_0074', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const r = parsec.parseFunction(`void compat593(flot p);`);
        ...
        assert.strictEqual(r[0].parameters[0].type, "flot", "h2dts_compat_map_0074 param type");
      });
      assert.ok(finished, 'compat task must finish without process crash');
    } catch (err) {
  ...
  test('h2dts_compat_map_0075', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const r = parsec.parseFunction(`namespace ns { void compat593(std::unordered_map<char, int> p); }`);
        ...
        const converted = transTskey2Ckey(r[0].parameters[0].type);
        assert.ok(typeof converted === 'string' && converted.length > 0,
          "h2dts_compat_map_0075_param convert output non-empty");
        assert.strictEqual(converted, "Map<string, number>", "h2dts_compat_map_0075_param convert output");
      });
      assert.ok(finished, 'compat task must finish without process crash');
    } catch (err) {
  ...
  test('h2dts_compat_map_0076', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const r = parsec.parseFunction(`void compat593(bad_type_593 p);`);
        ...
        assert.strictEqual(r[0].parameters[0].type, "bad_type_593", "h2dts_compat_map_0076 param type");
      });
      assert.ok(finished, 'compat task must finish without process crash');
    } catch (err) {
  ...
  test('h2dts_compat_map_0077', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const r = parsec.parseFunction(`void compat593(std::unordered_map<char, int> p);`);
        ...
        const converted = transTskey2Ckey(r[0].parameters[0].type);
        assert.ok(typeof converted === 'string' && converted.length > 0,
          "h2dts_compat_map_0077_param convert output non-empty");
        assert.strictEqual(converted, "Map<string, number>", "h2dts_compat_map_0077_param convert output");
      });
      assert.ok(finished, 'compat task must finish without process crash');
    } catch (err) {
  ...
  test('h2dts_compat_map_0078', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const r = parsec.parseFunction(`enum E593 { A, B }; void f(E593 e);`);
        ...
        assert.strictEqual(r[0].name, "f", "h2dts_compat_map_0078 func name");
      });
      assert.ok(finished, 'compat task must finish without process crash');
    } catch (err) {
  ...
  test('h2dts_compat_map_0079', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        ...
        assert.ok(r[0].parameters && r[0].parameters.length >= 1, "h2dts_compat_map_0079 must parse param");
        assert.strictEqual(r[0].parameters[0].type, "std:unordered_map<char, int>", "h2dts_compat_map_0079 param type");
      });
      assert.ok(finished, 'compat task must finish without process crash');
    } catch (err) {
  ...
  test('h2dts_compat_map_0080', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const r = parsec.parseFunction(`void compat594(itn p);`);
        ...
        assert.strictEqual(r[0].parameters[0].type, "itn", "h2dts_compat_map_0080 param type");
      });
      assert.ok(finished, 'compat task must finish without process crash');
    } catch (err) {
  ...
  test('h2dts_compat_map_0081', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const r = parsec.parseFunction(`void compat594(doubl p);`);
        ...
        assert.strictEqual(r[0].parameters[0].type, "doubl", "h2dts_compat_map_0081 param type");
      });
      assert.ok(finished, 'compat task must finish without process crash');
    } catch (err) {
  ...
  test('h2dts_compat_map_0082', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const r = parsec.parseFunction(`void compat594(boool p);`);
        ...
        assert.strictEqual(r[0].parameters[0].type, "boool", "h2dts_compat_map_0082 param type");
      });
      assert.ok(finished, 'compat task must finish without process crash');
    } catch (err) {
  ...
  test('h2dts_compat_map_0083', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const r = parsec.parseFunction(`void compat594(intt p);`);
        ...
        assert.strictEqual(r[0].parameters[0].type, "intt", "h2dts_compat_map_0083 param type");
      });
      assert.ok(finished, 'compat task must finish without process crash');
    } catch (err) {
  ...
  test('h2dts_compat_map_0084', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const r = parsec.parseFunction(`void compat594(flot p);`);
        ...
        assert.strictEqual(r[0].parameters[0].type, "flot", "h2dts_compat_map_0084 param type");
      });
      assert.ok(finished, 'compat task must finish without process crash');
    } catch (err) {
  ...
  test('h2dts_compat_map_0085', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const r = parsec.parseFunction(`namespace ns { void compat594(std::unordered_map<char, size_t> p); }`);
        ...
        const converted = transTskey2Ckey(r[0].parameters[0].type);
        assert.ok(typeof converted === 'string' && converted.length > 0,
          "h2dts_compat_map_0085_param convert output non-empty");
        assert.strictEqual(converted, "Map<string, number>", "h2dts_compat_map_0085_param convert output");
      });
      assert.ok(finished, 'compat task must finish without process crash');
    } catch (err) {
  ...
  test('h2dts_compat_map_0086', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const r = parsec.parseFunction(`void compat594(bad_type_594 p);`);
        ...
        assert.strictEqual(r[0].parameters[0].type, "bad_type_594", "h2dts_compat_map_0086 param type");
      });
      assert.ok(finished, 'compat task must finish without process crash');
    } catch (err) {
  ...
  test('h2dts_compat_map_0087', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const r = parsec.parseFunction(`void compat594(std::unordered_map<char, size_t> p);`);
        ...
        const converted = transTskey2Ckey(r[0].parameters[0].type);
        assert.ok(typeof converted === 'string' && converted.length > 0,
          "h2dts_compat_map_0087_param convert output non-empty");
        assert.strictEqual(converted, "Map<string, number>", "h2dts_compat_map_0087_param convert output");
      });
      assert.ok(finished, 'compat task must finish without process crash');
    } catch (err) {
  ...
  test('h2dts_compat_map_0088', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const r = parsec.parseFunction(`enum E594 { A, B }; void f(E594 e);`);
        ...
        assert.strictEqual(r[0].name, "f", "h2dts_compat_map_0088 func name");
      });
      assert.ok(finished, 'compat task must finish without process crash');
    } catch (err) {
  ...
  test('h2dts_compat_map_0089', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        ...
        assert.ok(r[0].parameters && r[0].parameters.length >= 1, "h2dts_compat_map_0089 must parse param");
        assert.strictEqual(r[0].parameters[0].type, "std:unordered_map<char, size_t>", "h2dts_compat_map_0089 param type");
      });
      assert.ok(finished, 'compat task must finish without process crash');
    } catch (err) {
  ...
  test('h2dts_compat_map_0090', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const r = parsec.parseFunction(`void compat595(itn p);`);
        ...
        assert.strictEqual(r[0].parameters[0].type, "itn", "h2dts_compat_map_0090 param type");
      });
      assert.ok(finished, 'compat task must finish without process crash');
    } catch (err) {
  ...
  test('h2dts_compat_map_0091', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const r = parsec.parseFunction(`void compat595(doubl p);`);
        ...
        assert.strictEqual(r[0].parameters[0].type, "doubl", "h2dts_compat_map_0091 param type");
      });
      assert.ok(finished, 'compat task must finish without process crash');
    } catch (err) {
  ...
  test('h2dts_compat_map_0092', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const r = parsec.parseFunction(`void compat595(boool p);`);
        ...
        assert.strictEqual(r[0].parameters[0].type, "boool", "h2dts_compat_map_0092 param type");
      });
      assert.ok(finished, 'compat task must finish without process crash');
    } catch (err) {
  ...
  test('h2dts_compat_map_0093', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const r = parsec.parseFunction(`void compat595(intt p);`);
        ...
        assert.strictEqual(r[0].parameters[0].type, "intt", "h2dts_compat_map_0093 param type");
      });
      assert.ok(finished, 'compat task must finish without process crash');
    } catch (err) {
  ...
  test('h2dts_compat_map_0094', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const r = parsec.parseFunction(`void compat595(flot p);`);
        ...
        assert.strictEqual(r[0].parameters[0].type, "flot", "h2dts_compat_map_0094 param type");
      });
      assert.ok(finished, 'compat task must finish without process crash');
    } catch (err) {
  ...
  test('h2dts_compat_map_0095', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const r = parsec.parseFunction(`namespace ns { void compat595(std::unordered_map<char, unsigned> p); }`);
        ...
        const converted = transTskey2Ckey(r[0].parameters[0].type);
        assert.ok(typeof converted === 'string' && converted.length > 0,
          "h2dts_compat_map_0095_param convert output non-empty");
        assert.strictEqual(converted, "Map<string, number>", "h2dts_compat_map_0095_param convert output");
      });
      assert.ok(finished, 'compat task must finish without process crash');
    } catch (err) {
  ...
  test('h2dts_compat_map_0096', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const r = parsec.parseFunction(`void compat595(bad_type_595 p);`);
        ...
        assert.strictEqual(r[0].parameters[0].type, "bad_type_595", "h2dts_compat_map_0096 param type");
      });
      assert.ok(finished, 'compat task must finish without process crash');
    } catch (err) {
  ...
  test('h2dts_compat_map_0097', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const r = parsec.parseFunction(`void compat595(std::unordered_map<char, unsigned> p);`);
        ...
        const converted = transTskey2Ckey(r[0].parameters[0].type);
        assert.ok(typeof converted === 'string' && converted.length > 0,
          "h2dts_compat_map_0097_param convert output non-empty");
        assert.strictEqual(converted, "Map<string, number>", "h2dts_compat_map_0097_param convert output");
      });
      assert.ok(finished, 'compat task must finish without process crash');
    } catch (err) {
  ...
  test('h2dts_compat_map_0098', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const r = parsec.parseFunction(`enum E595 { A, B }; void f(E595 e);`);
        ...
        assert.strictEqual(r[0].name, "f", "h2dts_compat_map_0098 func name");
      });
      assert.ok(finished, 'compat task must finish without process crash');
    } catch (err) {
  ...
  test('h2dts_compat_map_0099', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        ...
        assert.ok(r[0].parameters && r[0].parameters.length >= 1, "h2dts_compat_map_0099 must parse param");
        assert.strictEqual(r[0].parameters[0].type, "std:unordered_map<char, unsigned>", "h2dts_compat_map_0099 param type");
      });
      assert.ok(finished, 'compat task must finish without process crash');
    } catch (err) {
  ...
  test('h2dts_compat_map_0100', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const r = parsec.parseFunction(`void compat596(itn p);`);
        ...
        assert.strictEqual(r[0].parameters[0].type, "itn", "h2dts_compat_map_0100 param type");
      });
      assert.ok(finished, 'compat task must finish without process crash');
    } catch (err) {
  ...
  test('h2dts_compat_map_0101', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const r = parsec.parseFunction(`void compat596(doubl p);`);
        ...
        assert.strictEqual(r[0].parameters[0].type, "doubl", "h2dts_compat_map_0101 param type");
      });
      assert.ok(finished, 'compat task must finish without process crash');
    } catch (err) {
