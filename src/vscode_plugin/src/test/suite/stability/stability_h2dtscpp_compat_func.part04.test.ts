...
suite('Stability_H2DTSCPP_COMPAT_FUNC_Part04', function() {
  this.timeout(600000);
  vscode.window.showInformationMessage('Start Stability_H2DTSCPP_COMPAT_FUNC_Part04.');
  ...
  test('h2dtscpp_compat_func_0001', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        ...
        assert.strictEqual(converted.classes[0].variableList[0].type, "InvalidTypeXYZ", "h2dtscpp_compat_func_0001 field type");
      });
  ...
  test('h2dtscpp_compat_func_0002', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const converted = transParseObj({
          enums: [], unions: [], structs: [],
          classes: [{ name: 'C42', alias: '',
            variableList: [{ type: '(p0:boolean,p1:numbr)=>numbr', name: 'v', arraySize: 0, arraySizeList: [] }],
            functionList: []
          }],
          funcs: [], types: []
        });
        ...
        assert.strictEqual(converted.classes[0].variableList[0].type, "std::function<numbr(bool, numbr)>",
    ...
    try {
      const finished = runCompatSafe(() => {
        const converted = transParseObj({
          enums: [], unions: [], structs: [],
          classes: [{ name: 'C42', alias: '',
            variableList: [{ type: '(p0:boolea,p1:number)=>number', name: 'v', arraySize: 0, arraySizeList: [] }],
            functionList: []
          }],
          funcs: [], types: []
        });
        ...
        assert.strictEqual(converted.classes[0].variableList[0].type, "std::function<double(boolea, double)>",
    ...
    try {
      const finished = runCompatSafe(() => {
        const converted = transParseObj({
          enums: [], unions: [], structs: [],
          classes: [{ name: 'C42', alias: '',
            variableList: [{ type: '(p0:boolean,p1:number)=>numbe', name: 'v', arraySize: 0, arraySizeList: [] }],
            functionList: []
          }],
          funcs: [], types: []
        });
        ...
        assert.strictEqual(converted.classes[0].variableList[0].type, "std::function<numbe(bool, double)>",
  ...
  test('h2dtscpp_compat_func_0009', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        ...
        assert.strictEqual(converted.classes[0].variableList[0].type, "std::function<number,(bool, double)>",
          "h2dtscpp_compat_func_0009 field type");
      });
      assert.ok(finished, 'compat task must finish without process crash');
    } catch (err) {
  ...
  test('h2dtscpp_compat_func_0011', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        ...
        assert.strictEqual(converted.classes[0].variableList[0].type, "InvalidTypeXYZ", "h2dtscpp_compat_func_0011 field type");
      });
      assert.ok(finished, 'compat task must finish without process crash');
    } catch (err) {
  ...
  test('h2dtscpp_compat_func_0012', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const converted = transParseObj({
          enums: [], unions: [], structs: [],
          classes: [{ name: 'C43', alias: '',
            variableList: [{ type: '(p0:boolean,p1:boolean)=>numbr', name: 'v', arraySize: 0, arraySizeList: [] }],
            functionList: []
          }],
          funcs: [], types: []
        });
        ...
        assert.strictEqual(converted.classes[0].variableList[0].type, "std::function<numbr(bool, bool)>",
    ...
    try {
      const finished = runCompatSafe(() => {
        const converted = transParseObj({
          enums: [], unions: [], structs: [],
          classes: [{ name: 'C43', alias: '',
            variableList: [{ type: '(p0:boolea,p1:boolea)=>number', name: 'v', arraySize: 0, arraySizeList: [] }],
            functionList: []
          }],
          funcs: [], types: []
        });
        ...
        assert.strictEqual(converted.classes[0].variableList[0].type, "std::function<double(boolea, boolea)>",
    ...
    try {
      const finished = runCompatSafe(() => {
        const converted = transParseObj({
          enums: [], unions: [], structs: [],
          classes: [{ name: 'C43', alias: '',
            variableList: [{ type: '(p0:boolean,p1:boolean)=>numbe', name: 'v', arraySize: 0, arraySizeList: [] }],
            functionList: []
          }],
          funcs: [], types: []
        });
        ...
        assert.strictEqual(converted.classes[0].variableList[0].type, "std::function<numbe(bool, bool)>",
  ...
  test('h2dtscpp_compat_func_0019', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        ...
        assert.strictEqual(converted.classes[0].variableList[0].type, "std::function<number,(bool, bool)>",
          "h2dtscpp_compat_func_0019 field type");
      });
      assert.ok(finished, 'compat task must finish without process crash');
    } catch (err) {
  ...
  test('h2dtscpp_compat_func_0020', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        ...
        assert.strictEqual(converted.classes[0].variableList[0].type, "std::function<double(bool, bool)>",
          "h2dtscpp_compat_func_0020 field type");
      });
      assert.ok(finished, 'compat task must finish without process crash');
    } catch (err) {
  ...
  test('h2dtscpp_compat_func_0021', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        ...
        assert.strictEqual(converted.classes[0].variableList[0].type, "InvalidTypeXYZ", "h2dtscpp_compat_func_0021 field type");
      });
      assert.ok(finished, 'compat task must finish without process crash');
    } catch (err) {
  ...
  test('h2dtscpp_compat_func_0022', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const converted = transParseObj({
          enums: [], unions: [], structs: [],
          classes: [{ name: 'C44', alias: '',
            variableList: [{ type: '(p0:numbr,p1:numbr)=>string', name: 'v', arraySize: 0, arraySizeList: [] }],
            functionList: []
          }],
          funcs: [], types: []
        });
        ...
        assert.strictEqual(converted.classes[0].variableList[0].type, "std::function<std::string(numbr, numbr)>",
    ...
    try {
      const finished = runCompatSafe(() => {
        const converted = transParseObj({
          enums: [], unions: [], structs: [],
          classes: [{ name: 'C44', alias: '',
            variableList: [{ type: '(p0:number,p1:number)=>strng', name: 'v', arraySize: 0, arraySizeList: [] }],
            functionList: []
          }],
          funcs: [], types: []
        });
        ...
        assert.strictEqual(converted.classes[0].variableList[0].type, "std::function<strng(double, double)>",
    ...
    try {
      const finished = runCompatSafe(() => {
        ...
        assert.strictEqual(converted.classes[0].variableList[0].type, "std::function<std::string(double, double)>",
          "h2dtscpp_compat_func_0024 field type");
      });
      assert.ok(finished, 'compat task must finish without process crash');
    } catch (err) {
  ...
  test('h2dtscpp_compat_func_0025', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        ...
        assert.strictEqual(converted.classes[0].variableList[0].type, "std::function<std::string(double, double)>",
          "h2dtscpp_compat_func_0025 field type");
      });
      assert.ok(finished, 'compat task must finish without process crash');
    } catch (err) {
    ...
    try {
      const finished = runCompatSafe(() => {
        const converted = transParseObj({
          enums: [], unions: [], structs: [],
          classes: [{ name: 'C44', alias: '',
            variableList: [{ type: '(p0:number,p1:number)=>strin', name: 'v', arraySize: 0, arraySizeList: [] }],
            functionList: []
          }],
          funcs: [], types: []
        });
        ...
        assert.strictEqual(converted.classes[0].variableList[0].type, "std::function<strin(double, double)>",
  ...
  test('h2dtscpp_compat_func_0029', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        ...
        assert.strictEqual(converted.classes[0].variableList[0].type, "std::function<string,(double, double)>",
          "h2dtscpp_compat_func_0029 field type");
      });
      assert.ok(finished, 'compat task must finish without process crash');
    } catch (err) {
  ...
  test('h2dtscpp_compat_func_0031', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        ...
        assert.strictEqual(converted.classes[0].variableList[0].type, "InvalidTypeXYZ", "h2dtscpp_compat_func_0031 field type");
      });
      assert.ok(finished, 'compat task must finish without process crash');
    } catch (err) {
  ...
  test('h2dtscpp_compat_func_0032', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const converted = transParseObj({
          enums: [], unions: [], structs: [],
          classes: [{ name: 'C45', alias: '',
            variableList: [{ type: '(p0:numbr,p1:boolean)=>string', name: 'v', arraySize: 0, arraySizeList: [] }],
            functionList: []
          }],
          funcs: [], types: []
        });
        ...
        assert.strictEqual(converted.classes[0].variableList[0].type, "std::function<std::string(numbr, bool)>",
    ...
    try {
      const finished = runCompatSafe(() => {
        const converted = transParseObj({
          enums: [], unions: [], structs: [],
          classes: [{ name: 'C45', alias: '',
            variableList: [{ type: '(p0:number,p1:boolean)=>strng', name: 'v', arraySize: 0, arraySizeList: [] }],
            functionList: []
          }],
          funcs: [], types: []
        });
        ...
        assert.strictEqual(converted.classes[0].variableList[0].type, "std::function<strng(double, bool)>",
    ...
    try {
      const finished = runCompatSafe(() => {
        const converted = transParseObj({
          enums: [], unions: [], structs: [],
          classes: [{ name: 'C45', alias: '',
            variableList: [{ type: '(p0:number,p1:boolea)=>string', name: 'v', arraySize: 0, arraySizeList: [] }],
            functionList: []
          }],
          funcs: [], types: []
        });
        ...
        assert.strictEqual(converted.classes[0].variableList[0].type, "std::function<std::string(double, boolea)>",
          "h2dtscpp_compat_func_0034 field type");
      });
      assert.ok(finished, 'compat task must finish without process crash');
    } catch (err) {
    ...
    try {
      const finished = runCompatSafe(() => {
        ...
        assert.strictEqual(converted.classes[0].variableList[0].type, "std::function<std::string(double, bool)>",
          "h2dtscpp_compat_func_0035 field type");
      });
      assert.ok(finished, 'compat task must finish without process crash');
    } catch (err) {
    ...
    try {
      const finished = runCompatSafe(() => {
        const converted = transParseObj({
          enums: [], unions: [], structs: [],
          classes: [{ name: 'C45', alias: '',
            variableList: [{ type: '(p0:number,p1:boolean)=>strin', name: 'v', arraySize: 0, arraySizeList: [] }],
            functionList: []
          }],
          funcs: [], types: []
        });
        ...
        assert.strictEqual(converted.classes[0].variableList[0].type, "std::function<strin(double, bool)>",
  ...
  test('h2dtscpp_compat_func_0039', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        ...
        assert.strictEqual(converted.classes[0].variableList[0].type, "std::function<string,(double, bool)>",
          "h2dtscpp_compat_func_0039 field type");
      });
      assert.ok(finished, 'compat task must finish without process crash');
    } catch (err) {
  ...
  test('h2dtscpp_compat_func_0041', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        ...
        assert.strictEqual(converted.classes[0].variableList[0].type, "InvalidTypeXYZ", "h2dtscpp_compat_func_0041 field type");
      });
      assert.ok(finished, 'compat task must finish without process crash');
    } catch (err) {
    ...
    try {
      const finished = runCompatSafe(() => {
        ...
        assert.strictEqual(converted.classes[0].variableList[0].type,
          "std::function<std::string(std::string, std::string)>", "h2dtscpp_compat_func_0042 field type");
      });
      assert.ok(finished, 'compat task must finish without process crash');
    } catch (err) {
    ...
    try {
      const finished = runCompatSafe(() => {
        const converted = transParseObj({
          enums: [], unions: [], structs: [],
          classes: [{ name: 'C46', alias: '',
            variableList: [{ type: '(p0:strng,p1:strng)=>strng', name: 'v', arraySize: 0, arraySizeList: [] }],
            functionList: []
          }],
          funcs: [], types: []
        });
        ...
        assert.strictEqual(converted.classes[0].variableList[0].type, "std::function<strng(strng, strng)>",
  ...
  test('h2dtscpp_compat_func_0044', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        ...
        assert.strictEqual(converted.classes[0].variableList[0].type,
          "std::function<std::string(std::string, std::string)>", "h2dtscpp_compat_func_0044 field type");
      });
      assert.ok(finished, 'compat task must finish without process crash');
    } catch (err) {
  ...
  test('h2dtscpp_compat_func_0045', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        ...
        assert.strictEqual(converted.classes[0].variableList[0].type,
          "std::function<std::string(std::string, std::string)>", "h2dtscpp_compat_func_0045 field type");
      });
      assert.ok(finished, 'compat task must finish without process crash');
    } catch (err) {
  ...
  test('h2dtscpp_compat_func_0046', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        ...
        assert.strictEqual(converted.classes[0].variableList[0].type,
          "std::function<std::string(std::string, std::string)>", "h2dtscpp_compat_func_0046 field type");
      });
      assert.ok(finished, 'compat task must finish without process crash');
    } catch (err) {
    ...
    try {
      const finished = runCompatSafe(() => {
        const converted = transParseObj({
          enums: [], unions: [], structs: [],
          classes: [{ name: 'C46', alias: '',
            variableList: [{ type: '(p0:string,p1:string)=>strin', name: 'v', arraySize: 0, arraySizeList: [] }],
            functionList: []
          }],
          funcs: [], types: []
        });
        ...
        assert.strictEqual(converted.classes[0].variableList[0].type, "std::function<strin(std::string, std::string)>",
  ...
  test('h2dtscpp_compat_func_0048', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        ...
        assert.strictEqual(converted.classes[0].variableList[0].type,
          "std::function<std::string(std::string, std::string)>", "h2dtscpp_compat_func_0048 field type");
      });
      assert.ok(finished, 'compat task must finish without process crash');
    } catch (err) {
  ...
  test('h2dtscpp_compat_func_0049', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        ...
        assert.strictEqual(converted.classes[0].variableList[0].type, "std::function<string,(std::string, std::string)>",
          "h2dtscpp_compat_func_0049 field type");
      });
      assert.ok(finished, 'compat task must finish without process crash');
    } catch (err) {
  ...
  test('h2dtscpp_compat_func_0050', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        ...
        assert.strictEqual(converted.classes[0].variableList[0].type,
          "std::function<std::string(std::string, std::string)>", "h2dtscpp_compat_func_0050 field type");
      });
      assert.ok(finished, 'compat task must finish without process crash');
    } catch (err) {
  ...
  test('h2dtscpp_compat_func_0051', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        ...
        assert.strictEqual(converted.classes[0].variableList[0].type, "InvalidTypeXYZ", "h2dtscpp_compat_func_0051 field type");
      });
      assert.ok(finished, 'compat task must finish without process crash');
    } catch (err) {
  ...
  test('h2dtscpp_compat_func_0052', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const converted = transParseObj({
          enums: [], unions: [], structs: [],
          classes: [{ name: 'C47', alias: '',
            variableList: [{ type: '(p0:boolean,p1:numbr)=>string', name: 'v', arraySize: 0, arraySizeList: [] }],
            functionList: []
          }],
          funcs: [], types: []
        });
        ...
        assert.strictEqual(converted.classes[0].variableList[0].type, "std::function<std::string(bool, numbr)>",
          "h2dtscpp_compat_func_0052 field type");
      });
      assert.ok(finished, 'compat task must finish without process crash');
    } catch (err) {
    ...
    try {
      const finished = runCompatSafe(() => {
        const converted = transParseObj({
          enums: [], unions: [], structs: [],
          classes: [{ name: 'C47', alias: '',
            variableList: [{ type: '(p0:boolean,p1:number)=>strng', name: 'v', arraySize: 0, arraySizeList: [] }],
            functionList: []
          }],
          funcs: [], types: []
        });
        ...
        assert.strictEqual(converted.classes[0].variableList[0].type, "std::function<strng(bool, double)>",
          "h2dtscpp_compat_func_0053 field type");
      });
      assert.ok(finished, 'compat task must finish without process crash');
    } catch (err) {
    ...
    try {
      const finished = runCompatSafe(() => {
        const converted = transParseObj({
          enums: [], unions: [], structs: [],
          classes: [{ name: 'C47', alias: '',
            variableList: [{ type: '(p0:boolea,p1:number)=>string', name: 'v', arraySize: 0, arraySizeList: [] }],
            functionList: []
          }],
          funcs: [], types: []
        });
        ...
        assert.strictEqual(converted.classes[0].variableList[0].type, "std::function<std::string(boolea, double)>",
          "h2dtscpp_compat_func_0054 field type");
      });
      assert.ok(finished, 'compat task must finish without process crash');
    } catch (err) {
    ...
    try {
      const finished = runCompatSafe(() => {
        ...
        assert.strictEqual(converted.classes[0].variableList[0].type, "std::function<std::string(bool, double)>",
          "h2dtscpp_compat_func_0055 field type");
      });
      assert.ok(finished, 'compat task must finish without process crash');
    } catch (err) {
  ...
  test('h2dtscpp_compat_func_0056', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        ...
        assert.strictEqual(converted.classes[0].variableList[0].type, "std::function<std::string(bool, double)>",
          "h2dtscpp_compat_func_0056 field type");
      });
      assert.ok(finished, 'compat task must finish without process crash');
    } catch (err) {
    ...
    try {
      const finished = runCompatSafe(() => {
        const converted = transParseObj({
          enums: [], unions: [], structs: [],
          classes: [{ name: 'C47', alias: '',
            variableList: [{ type: '(p0:boolean,p1:number)=>strin', name: 'v', arraySize: 0, arraySizeList: [] }],
            functionList: []
          }],
          funcs: [], types: []
        });
        ...
        assert.strictEqual(converted.classes[0].variableList[0].type, "std::function<strin(bool, double)>",
          "h2dtscpp_compat_func_0057 field type");
      });
      assert.ok(finished, 'compat task must finish without process crash');
    } catch (err) {
  ...
  test('h2dtscpp_compat_func_0058', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        ...
        assert.strictEqual(converted.classes[0].variableList[0].type, "std::function<std::string(bool, double)>",
          "h2dtscpp_compat_func_0058 field type");
      });
      assert.ok(finished, 'compat task must finish without process crash');
    } catch (err) {
  ...
  test('h2dtscpp_compat_func_0059', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        ...
        assert.strictEqual(converted.classes[0].variableList[0].type, "std::function<string,(bool, double)>",
          "h2dtscpp_compat_func_0059 field type");
      });
      assert.ok(finished, 'compat task must finish without process crash');
    } catch (err) {
  ...
  test('h2dtscpp_compat_func_0061', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        ...
        assert.strictEqual(converted.classes[0].variableList[0].type, "InvalidTypeXYZ", "h2dtscpp_compat_func_0061 field type");
      });
      assert.ok(finished, 'compat task must finish without process crash');
    } catch (err) {
    ...
    try {
      const finished = runCompatSafe(() => {
        const converted = transParseObj({
          enums: [], unions: [], structs: [],
          classes: [{ name: 'C48', alias: '',
            variableList: [{ type: '(p0:boolean,p1:boolean)=>strng', name: 'v', arraySize: 0, arraySizeList: [] }],
            functionList: []
          }],
          funcs: [], types: []
        });
        ...
        assert.strictEqual(converted.classes[0].variableList[0].type, "std::function<strng(bool, bool)>",
    ...
    try {
      const finished = runCompatSafe(() => {
        const converted = transParseObj({
          enums: [], unions: [], structs: [],
          classes: [{ name: 'C48', alias: '',
            variableList: [{ type: '(p0:boolea,p1:boolea)=>string', name: 'v', arraySize: 0, arraySizeList: [] }],
            functionList: []
          }],
          funcs: [], types: []
        });
        ...
        assert.strictEqual(converted.classes[0].variableList[0].type, "std::function<std::string(boolea, boolea)>",
    ...
    try {
      const finished = runCompatSafe(() => {
        const converted = transParseObj({
          enums: [], unions: [], structs: [],
          classes: [{ name: 'C48', alias: '',
            variableList: [{ type: '(p0:boolean,p1:boolean)=>strin', name: 'v', arraySize: 0, arraySizeList: [] }],
            functionList: []
          }],
          funcs: [], types: []
        });
        ...
        assert.strictEqual(converted.classes[0].variableList[0].type, "std::function<strin(bool, bool)>",
  ...
  test('h2dtscpp_compat_func_0069', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        ...
        assert.strictEqual(converted.classes[0].variableList[0].type, "std::function<string,(bool, bool)>",
          "h2dtscpp_compat_func_0069 field type");
      });
      assert.ok(finished, 'compat task must finish without process crash');
    } catch (err) {
  ...
  test('h2dtscpp_compat_func_0070', function() {
    this.timeout(15000);
    try {
      const finished = runCompatSafe(() => {
        const converted = transParseObj({
        ...
        assert.ok(converted !== undefined && converted !== null && typeof converted === 'object',
          "h2dtscpp_compat_func_0070 convert result must be object");
        assert.ok(converted.classes && converted.classes.length >= 1, "h2dtscpp_compat_func_0070 must have class");
        assert.ok(converted.classes[0].variableList && converted.classes[0].variableList.length >= 1,
          "h2dtscpp_compat_func_0070 must have field");
        assert.strictEqual(converted.classes[0].variableList[0].type, "std::function<std::string(bool, bool)>",
          "h2dtscpp_compat_func_0070 field type");
      });
      assert.ok(finished, 'compat task must finish without process crash');
    } catch (err) {
      assert.fail(`h2dtscpp_compat_func_0070 execution error: ${String(err)}`);
    }
  });

  test('h2dtscpp_compat_func_0071', function() {
    this.timeout(15000);
    try {
      const finished = runCompatSafe(() => {
        const converted = transParseObj({
        ...
        assert.ok(converted !== undefined && converted !== null && typeof converted === 'object',
          "h2dtscpp_compat_func_0071 convert result must be object");
        assert.ok(converted.classes && converted.classes.length >= 1, "h2dtscpp_compat_func_0071 must have class");
        assert.ok(converted.classes[0].variableList && converted.classes[0].variableList.length >= 1,
          "h2dtscpp_compat_func_0071 must have field");
        assert.strictEqual(converted.classes[0].variableList[0].type, "InvalidTypeXYZ", "h2dtscpp_compat_func_0071 field type");
      });
      assert.ok(finished, 'compat task must finish without process crash');
    } catch (err) {
      assert.fail(`h2dtscpp_compat_func_0071 execution error: ${String(err)}`);
    }
  });

  test('h2dtscpp_compat_func_0072', function() {
    this.timeout(15000);
    try {
      const finished = runCompatSafe(() => {
        const converted = transParseObj({
          enums: [], unions: [], structs: [],
          classes: [{ name: 'C49', alias: '',
            variableList: [{ type: '(p0:numbr,p1:numbr)=>boolean', name: 'v', arraySize: 0, arraySizeList: [] }],
            functionList: []
          }],
          funcs: [], types: []
        });
        assert.ok(converted !== undefined && converted !== null && typeof converted === 'object',
          "h2dtscpp_compat_func_0072 convert result must be object");
        assert.ok(converted.classes && converted.classes.length >= 1, "h2dtscpp_compat_func_0072 must have class");
        assert.ok(converted.classes[0].variableList && converted.classes[0].variableList.length >= 1,
          "h2dtscpp_compat_func_0072 must have field");
        assert.strictEqual(converted.classes[0].variableList[0].type, "std::function<bool(numbr, numbr)>",
          "h2dtscpp_compat_func_0072 field type");
      });
      assert.ok(finished, 'compat task must finish without process crash');
    } catch (err) {
      assert.fail(`h2dtscpp_compat_func_0072 execution error: ${String(err)}`);
    }
  });

  test('h2dtscpp_compat_func_0073', function() {
    this.timeout(15000);
    try {
      const finished = runCompatSafe(() => {
        const converted = transParseObj({
        ...
        assert.ok(converted !== undefined && converted !== null && typeof converted === 'object',
          "h2dtscpp_compat_func_0073 convert result must be object");
        assert.ok(converted.classes && converted.classes.length >= 1, "h2dtscpp_compat_func_0073 must have class");
        assert.ok(converted.classes[0].variableList && converted.classes[0].variableList.length >= 1,
          "h2dtscpp_compat_func_0073 must have field");
        assert.strictEqual(converted.classes[0].variableList[0].type, "std::function<bool(double, double)>",
          "h2dtscpp_compat_func_0073 field type");
      });
      assert.ok(finished, 'compat task must finish without process crash');
    } catch (err) {
      assert.fail(`h2dtscpp_compat_func_0073 execution error: ${String(err)}`);
    }
  });
});
