...
suite('Stability_H2DTSCPP_COMPAT_FUNC_Part08', function() {
  this.timeout(600000);
  vscode.window.showInformationMessage('Start Stability_H2DTSCPP_COMPAT_FUNC_Part08.');
    ...
    try {
      const finished = runCompatSafe(() => {
        const converted = transParseObj({
          enums: [], unions: [], structs: [],
          classes: [{ name: 'C83', alias: '',
            variableList: [{ type: 'CallbackArrayobject>>', name: 'v', arraySize: 0, arraySizeList: [] }],
            functionList: []
          }],
          funcs: [], types: []
        });
        ...
        assert.strictEqual(converted.classes[0].variableList[0].type, "CallbackArrayobject>>",
  ...
  test('h2dtscpp_compat_func_0010', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const converted = transParseObj({
          enums: [], unions: [], structs: [],
          classes: [{ name: 'C84', alias: '',
            variableList: [{ type: '(p0:object)=>any', name: 'v', arraySize: 0, arraySizeList: [] }],
            functionList: []
          }],
          funcs: [], types: []
        });
    ...
    try {
      const finished = runCompatSafe(() => {
        const converted = transParseObj({
          enums: [], unions: [], structs: [],
          classes: [{ name: 'C84', alias: '',
            variableList: [{ type: '(p0:object)=>an', name: 'v', arraySize: 0, arraySizeList: [] }],
            functionList: []
          }],
          funcs: [], types: []
        });
  ...
  test('h2dtscpp_compat_func_0020', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const converted = transParseObj({
          enums: [], unions: [], structs: [],
          classes: [{ name: 'C85', alias: '',
            variableList: [{ type: '(p0:numbr)=>any', name: 'v', arraySize: 0, arraySizeList: [] }],
            functionList: []
          }],
          funcs: [], types: []
        });
        ...
        assert.strictEqual(converted.classes[0].variableList[0].type, "std::function<std::any(numbr)>",
    ...
    try {
      const finished = runCompatSafe(() => {
        const converted = transParseObj({
          enums: [], unions: [], structs: [],
          classes: [{ name: 'C85', alias: '',
            variableList: [{ type: '(p0:number)=>any', name: 'v', arraySize: 0, arraySizeList: [] }],
            functionList: []
          }],
          funcs: [], types: []
        });
    ...
    try {
      const finished = runCompatSafe(() => {
        const converted = transParseObj({
          enums: [], unions: [], structs: [],
          classes: [{ name: 'C85', alias: '',
            variableList: [{ type: '(p0:number)=>an', name: 'v', arraySize: 0, arraySizeList: [] }],
            functionList: []
          }],
          funcs: [], types: []
        });
        ...
        assert.strictEqual(converted.classes[0].variableList[0].type, "std::function<an(double)>",
  ...
  test('h2dtscpp_compat_func_0027', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        ...
        assert.strictEqual(converted.classes[0].variableList[0].type, "std::function<any,(double)>",
  ...
  test('h2dtscpp_compat_func_0030', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const converted = transParseObj({
          enums: [], unions: [], structs: [],
          classes: [{ name: 'C86', alias: '',
            variableList: [{ type: '(p0:string)=>any', name: 'v', arraySize: 0, arraySizeList: [] }],
            functionList: []
          }],
          funcs: [], types: []
        });
    ...
    try {
      const finished = runCompatSafe(() => {
        const converted = transParseObj({
          enums: [], unions: [], structs: [],
          classes: [{ name: 'C86', alias: '',
            variableList: [{ type: '(p0:strng)=>any', name: 'v', arraySize: 0, arraySizeList: [] }],
            functionList: []
          }],
          funcs: [], types: []
        });
        ...
        assert.strictEqual(converted.classes[0].variableList[0].type, "std::function<std::any(strng)>",
    ...
    try {
      const finished = runCompatSafe(() => {
        const converted = transParseObj({
          enums: [], unions: [], structs: [],
          classes: [{ name: 'C86', alias: '',
            variableList: [{ type: '(p0:string)=>an', name: 'v', arraySize: 0, arraySizeList: [] }],
            functionList: []
          }],
          funcs: [], types: []
        });
        ...
        assert.strictEqual(converted.classes[0].variableList[0].type, "std::function<an(std::string)>",
  ...
  test('h2dtscpp_compat_func_0037', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        ...
        assert.strictEqual(converted.classes[0].variableList[0].type, "std::function<any,(std::string)>",
  ...
  test('h2dtscpp_compat_func_0040', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const converted = transParseObj({
          enums: [], unions: [], structs: [],
          classes: [{ name: 'C87', alias: '',
            variableList: [{ type: '(p0:boolean)=>any', name: 'v', arraySize: 0, arraySizeList: [] }],
            functionList: []
          }],
          funcs: [], types: []
        });
    ...
    try {
      const finished = runCompatSafe(() => {
        const converted = transParseObj({
          enums: [], unions: [], structs: [],
          classes: [{ name: 'C87', alias: '',
            variableList: [{ type: '(p0:boolea)=>any', name: 'v', arraySize: 0, arraySizeList: [] }],
            functionList: []
          }],
          funcs: [], types: []
        });
    ...
    try {
      const finished = runCompatSafe(() => {
        const converted = transParseObj({
          enums: [], unions: [], structs: [],
          classes: [{ name: 'C87', alias: '',
            variableList: [{ type: '(p0:boolean)=>an', name: 'v', arraySize: 0, arraySizeList: [] }],
            functionList: []
          }],
          funcs: [], types: []
        });
        ...
        assert.strictEqual(converted.classes[0].variableList[0].type, "std::function<an(bool)>",
  ...
  test('h2dtscpp_compat_func_0047', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        ...
        assert.strictEqual(converted.classes[0].variableList[0].type, "std::function<any,(bool)>",
  ...
  test('h2dtscpp_compat_func_0050', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const converted = transParseObj({
          enums: [], unions: [], structs: [],
          classes: [{ name: 'C88', alias: '',
            variableList: [{ type: '(p0:any)=>object', name: 'v', arraySize: 0, arraySizeList: [] }],
            functionList: []
          }],
          funcs: [], types: []
        });
    ...
    try {
      const finished = runCompatSafe(() => {
        const converted = transParseObj({
          enums: [], unions: [], structs: [],
          classes: [{ name: 'C88', alias: '',
            variableList: [{ type: '(p0:any)=>objec', name: 'v', arraySize: 0, arraySizeList: [] }],
            functionList: []
          }],
          funcs: [], types: []
        });
  ...
  test('h2dtscpp_compat_func_0060', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const converted = transParseObj({
          enums: [], unions: [], structs: [],
          classes: [{ name: 'C89', alias: '',
            variableList: [{ type: '(p0:numbr)=>object', name: 'v', arraySize: 0, arraySizeList: [] }],
            functionList: []
          }],
          funcs: [], types: []
        });
    ...
    try {
      const finished = runCompatSafe(() => {
        const converted = transParseObj({
          enums: [], unions: [], structs: [],
          classes: [{ name: 'C89', alias: '',
            variableList: [{ type: '(p0:number)=>object', name: 'v', arraySize: 0, arraySizeList: [] }],
            functionList: []
          }],
          funcs: [], types: []
        });
    ...
    try {
      const finished = runCompatSafe(() => {
        const converted = transParseObj({
          enums: [], unions: [], structs: [],
          classes: [{ name: 'C89', alias: '',
            variableList: [{ type: '(p0:number)=>objec', name: 'v', arraySize: 0, arraySizeList: [] }],
            functionList: []
          }],
          funcs: [], types: []
        });
        ...
        assert.strictEqual(converted.classes[0].variableList[0].type, "std::function<objec(double)>",
  ...
  test('h2dtscpp_compat_func_0067', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        ...
        assert.strictEqual(converted.classes[0].variableList[0].type, "std::function<object,(double)>",
    ...
    try {
      const finished = runCompatSafe(() => {
        const converted = transParseObj({
          enums: [], unions: [], structs: [],
          classes: [{ name: 'C90', alias: '',
            variableList: [{ type: '(p0:strng)=>object', name: 'v', arraySize: 0, arraySizeList: [] }],
            functionList: []
          }],
          funcs: [], types: []
        });
