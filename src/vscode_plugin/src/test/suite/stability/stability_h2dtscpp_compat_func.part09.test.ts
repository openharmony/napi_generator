...
suite('Stability_H2DTSCPP_COMPAT_FUNC_Part09', function() {
  this.timeout(600000);
  vscode.window.showInformationMessage('Start Stability_H2DTSCPP_COMPAT_FUNC_Part09.');
    ...
    try {
      const finished = runCompatSafe(() => {
        const converted = transParseObj({
          ...
          classes: [{ name: 'C90', alias: '',
            variableList: [{ type: '(p0:string)=>object', name: 'v', arraySize: 0, arraySizeList: [] }],
            functionList: []
          }],
          funcs: [], types: []
        });
    ...
    try {
      const finished = runCompatSafe(() => {
        const converted = transParseObj({
          enums: [], unions: [], structs: [],
          classes: [{ name: 'C90', alias: '',
            variableList: [{ type: '(p0:string)=>objec', name: 'v', arraySize: 0, arraySizeList: [] }],
            functionList: []
          }],
          funcs: [], types: []
        });
        ...
        assert.strictEqual(converted.classes[0].variableList[0].type, "std::function<objec(std::string)>",
  ...
  test('h2dtscpp_compat_func_0004', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        ...
        assert.strictEqual(converted.classes[0].variableList[0].type, "std::function<object,(std::string)>",
  ...
  test('h2dtscpp_compat_func_0006', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        ...
        assert.strictEqual(converted.classes[0].variableList[0].type, "InvalidTypeXYZ", "h2dtscpp_compat_func_0006 field type");
      });
      assert.ok(finished, 'compat task must finish without process crash');
    } catch (err) {
  ...
  test('h2dtscpp_compat_func_0007', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const converted = transParseObj({
          enums: [], unions: [], structs: [],
          classes: [{ name: 'C91', alias: '',
            variableList: [{ type: '(p0:boolean)=>object', name: 'v', arraySize: 0, arraySizeList: [] }],
            functionList: []
          }],
          funcs: [], types: []
        });
    ...
    try {
      const finished = runCompatSafe(() => {
        const converted = transParseObj({
          enums: [], unions: [], structs: [],
          classes: [{ name: 'C91', alias: '',
            variableList: [{ type: '(p0:boolea)=>object', name: 'v', arraySize: 0, arraySizeList: [] }],
            functionList: []
          }],
          funcs: [], types: []
        });
        ...
        assert.strictEqual(converted.classes[0].variableList[0].type, "std::function<std::any(boolea)>",
    ...
    try {
      const finished = runCompatSafe(() => {
        const converted = transParseObj({
          enums: [], unions: [], structs: [],
          classes: [{ name: 'C91', alias: '',
            variableList: [{ type: '(p0:boolean)=>objec', name: 'v', arraySize: 0, arraySizeList: [] }],
            functionList: []
          }],
          funcs: [], types: []
        });
        ...
        assert.strictEqual(converted.classes[0].variableList[0].type, "std::function<objec(bool)>",
  ...
  test('h2dtscpp_compat_func_0014', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        ...
        assert.strictEqual(converted.classes[0].variableList[0].type, "std::function<object,(bool)>",
  ...
  test('h2dtscpp_compat_func_0016', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        ...
        assert.strictEqual(converted.classes[0].variableList[0].type, "InvalidTypeXYZ", "h2dtscpp_compat_func_0016 field type");
      });
      assert.ok(finished, 'compat task must finish without process crash');
    } catch (err) {
  ...
  test('h2dtscpp_compat_func_0017', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const converted = transParseObj({
          enums: [], unions: [], structs: [],
          classes: [{ name: 'C92', alias: '',
            variableList: [{ type: '(p0:any)=>void', name: 'v', arraySize: 0, arraySizeList: [] }],
            functionList: []
          }],
          funcs: [], types: []
        });
    ...
    try {
      const finished = runCompatSafe(() => {
        const converted = transParseObj({
          enums: [], unions: [], structs: [],
          classes: [{ name: 'C92', alias: '',
            variableList: [{ type: '(p0:any)=>voi', name: 'v', arraySize: 0, arraySizeList: [] }],
            functionList: []
          }],
          funcs: [], types: []
        });
        ...
        assert.strictEqual(converted.classes[0].variableList[0].type, "std::function<voi(std::any)>",
  ...
  test('h2dtscpp_compat_func_0026', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        ...
        assert.strictEqual(converted.classes[0].variableList[0].type, "InvalidTypeXYZ", "h2dtscpp_compat_func_0026 field type");
      });
      assert.ok(finished, 'compat task must finish without process crash');
    } catch (err) {
  ...
  test('h2dtscpp_compat_func_0027', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const converted = transParseObj({
          enums: [], unions: [], structs: [],
          classes: [{ name: 'C93', alias: '',
            variableList: [{ type: '(p0:object)=>void', name: 'v', arraySize: 0, arraySizeList: [] }],
            functionList: []
          }],
          funcs: [], types: []
        });
    ...
    try {
      const finished = runCompatSafe(() => {
        const converted = transParseObj({
          enums: [], unions: [], structs: [],
          classes: [{ name: 'C93', alias: '',
            variableList: [{ type: '(p0:object)=>voi', name: 'v', arraySize: 0, arraySizeList: [] }],
            functionList: []
          }],
          funcs: [], types: []
        });
  ...
  test('h2dtscpp_compat_func_0036', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        ...
        assert.strictEqual(converted.classes[0].variableList[0].type, "InvalidTypeXYZ", "h2dtscpp_compat_func_0036 field type");
      });
      assert.ok(finished, 'compat task must finish without process crash');
    } catch (err) {
  ...
  test('h2dtscpp_compat_func_0037', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const converted = transParseObj({
          enums: [], unions: [], structs: [],
          classes: [{ name: 'C94', alias: '',
            variableList: [{ type: '(p0:any)=>numbr', name: 'v', arraySize: 0, arraySizeList: [] }],
            functionList: []
          }],
          funcs: [], types: []
        });
        ...
        assert.strictEqual(converted.classes[0].variableList[0].type, "std::function<numbr(std::any)>",
    ...
    try {
      const finished = runCompatSafe(() => {
        const converted = transParseObj({
          enums: [], unions: [], structs: [],
          classes: [{ name: 'C94', alias: '',
            variableList: [{ type: '(p0:any)=>number', name: 'v', arraySize: 0, arraySizeList: [] }],
            functionList: []
          }],
          funcs: [], types: []
        });
    ...
    try {
      const finished = runCompatSafe(() => {
        const converted = transParseObj({
          enums: [], unions: [], structs: [],
          classes: [{ name: 'C94', alias: '',
            variableList: [{ type: '(p0:any)=>numbe', name: 'v', arraySize: 0, arraySizeList: [] }],
            functionList: []
          }],
          funcs: [], types: []
        });
        ...
        assert.strictEqual(converted.classes[0].variableList[0].type, "std::function<numbe(std::any)>",
  ...
  test('h2dtscpp_compat_func_0044', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        ...
        assert.strictEqual(converted.classes[0].variableList[0].type, "std::function<number,(std::any)>",
  ...
  test('h2dtscpp_compat_func_0046', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        ...
        assert.strictEqual(converted.classes[0].variableList[0].type, "InvalidTypeXYZ", "h2dtscpp_compat_func_0046 field type");
      });
      assert.ok(finished, 'compat task must finish without process crash');
    } catch (err) {
  ...
  test('h2dtscpp_compat_func_0047', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const converted = transParseObj({
          enums: [], unions: [], structs: [],
          classes: [{ name: 'C95', alias: '',
            variableList: [{ type: '(p0:object)=>numbr', name: 'v', arraySize: 0, arraySizeList: [] }],
            functionList: []
          }],
          funcs: [], types: []
        });
    ...
    try {
      const finished = runCompatSafe(() => {
        const converted = transParseObj({
          enums: [], unions: [], structs: [],
          classes: [{ name: 'C95', alias: '',
            variableList: [{ type: '(p0:object)=>number', name: 'v', arraySize: 0, arraySizeList: [] }],
            functionList: []
          }],
          funcs: [], types: []
        });
    ...
    try {
      const finished = runCompatSafe(() => {
        const converted = transParseObj({
          enums: [], unions: [], structs: [],
          classes: [{ name: 'C95', alias: '',
            variableList: [{ type: '(p0:object)=>numbe', name: 'v', arraySize: 0, arraySizeList: [] }],
            functionList: []
          }],
          funcs: [], types: []
        });
  ...
  test('h2dtscpp_compat_func_0056', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        ...
        assert.strictEqual(converted.classes[0].variableList[0].type, "InvalidTypeXYZ", "h2dtscpp_compat_func_0056 field type");
      });
      assert.ok(finished, 'compat task must finish without process crash');
    } catch (err) {
  ...
  test('h2dtscpp_compat_func_0057', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const converted = transParseObj({
          enums: [], unions: [], structs: [],
          classes: [{ name: 'C96', alias: '',
            variableList: [{ type: '(p0:any)=>string', name: 'v', arraySize: 0, arraySizeList: [] }],
            functionList: []
          }],
          funcs: [], types: []
        });
    ...
    try {
      const finished = runCompatSafe(() => {
        const converted = transParseObj({
          enums: [], unions: [], structs: [],
          classes: [{ name: 'C96', alias: '',
            variableList: [{ type: '(p0:any)=>strng', name: 'v', arraySize: 0, arraySizeList: [] }],
            functionList: []
          }],
          funcs: [], types: []
        });
        ...
        assert.strictEqual(converted.classes[0].variableList[0].type, "std::function<strng(std::any)>",
    ...
    try {
      const finished = runCompatSafe(() => {
        const converted = transParseObj({
          enums: [], unions: [], structs: [],
          classes: [{ name: 'C96', alias: '',
            variableList: [{ type: '(p0:any)=>strin', name: 'v', arraySize: 0, arraySizeList: [] }],
            functionList: []
          }],
          funcs: [], types: []
        });
        ...
        assert.strictEqual(converted.classes[0].variableList[0].type, "std::function<strin(std::any)>",
  ...
  test('h2dtscpp_compat_func_0066', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        ...
        assert.strictEqual(converted.classes[0].variableList[0].type, "InvalidTypeXYZ", "h2dtscpp_compat_func_0066 field type");
      });
      assert.ok(finished, 'compat task must finish without process crash');
    } catch (err) {
    ...
    try {
      const finished = runCompatSafe(() => {
        const converted = transParseObj({
          enums: [], unions: [], structs: [],
          classes: [{ name: 'C97', alias: '',
            variableList: [{ type: '(p0:object)=>strng', name: 'v', arraySize: 0, arraySizeList: [] }],
            functionList: []
          }],
          funcs: [], types: []
        });
    ...
    try {
      const finished = runCompatSafe(() => {
        const converted = transParseObj({
          enums: [], unions: [], structs: [],
          classes: [{ name: 'C97', alias: '',
            variableList: [{ type: '(p0:object)=>strin', name: 'v', arraySize: 0, arraySizeList: [] }],
            functionList: []
          }],
          funcs: [], types: []
        });
