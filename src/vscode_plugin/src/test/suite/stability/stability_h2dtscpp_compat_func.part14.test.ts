...
suite('Stability_H2DTSCPP_COMPAT_FUNC_Part14', function() {
  this.timeout(600000);
  vscode.window.showInformationMessage('Start Stability_H2DTSCPP_COMPAT_FUNC_Part14.');
  ...
  test('h2dtscpp_compat_func_0002', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const converted = transParseObj({
          enums: [], unions: [], structs: [],
          classes: [{ name: 'C127', alias: '',
            variableList: [{ type: '(p0:object,p1:object)=>object', name: 'v', arraySize: 0, arraySizeList: [] }],
            functionList: []
          }],
          funcs: [], types: []
        });
    ...
    try {
      const finished = runCompatSafe(() => {
        const converted = transParseObj({
          enums: [], unions: [], structs: [],
          classes: [{ name: 'C127', alias: '',
            variableList: [{ type: '(p0:object,p1:object)=>objec', name: 'v', arraySize: 0, arraySizeList: [] }],
            functionList: []
          }],
          funcs: [], types: []
        });
        ...
        assert.strictEqual(converted.classes[0].variableList[0].type, "std::function<objec(std::any, std::any)>",
  ...
  test('h2dtscpp_compat_func_0009', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        ...
        assert.strictEqual(converted.classes[0].variableList[0].type, "std::function<object,(std::any, std::any)>",
  ...
  test('h2dtscpp_compat_func_0012', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const converted = transParseObj({
          enums: [], unions: [], structs: [],
          classes: [{ name: 'C128', alias: '',
            variableList: [{ type: '(p0:object,p1:numbr)=>object', name: 'v', arraySize: 0, arraySizeList: [] }],
            functionList: []
          }],
          funcs: [], types: []
        });
        ...
        assert.strictEqual(converted.classes[0].variableList[0].type, "std::function<std::any(std::any, numbr)>",
    ...
    try {
      const finished = runCompatSafe(() => {
        const converted = transParseObj({
          enums: [], unions: [], structs: [],
          classes: [{ name: 'C128', alias: '',
            variableList: [{ type: '(p0:object,p1:number)=>object', name: 'v', arraySize: 0, arraySizeList: [] }],
            functionList: []
          }],
          funcs: [], types: []
        });
    ...
    try {
      const finished = runCompatSafe(() => {
        const converted = transParseObj({
          enums: [], unions: [], structs: [],
          classes: [{ name: 'C128', alias: '',
            variableList: [{ type: '(p0:object,p1:number)=>objec', name: 'v', arraySize: 0, arraySizeList: [] }],
            functionList: []
          }],
          funcs: [], types: []
        });
        ...
        assert.strictEqual(converted.classes[0].variableList[0].type, "std::function<objec(std::any, double)>",
  ...
  test('h2dtscpp_compat_func_0019', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        ...
        assert.strictEqual(converted.classes[0].variableList[0].type, "std::function<object,(std::any, double)>",
  ...
  test('h2dtscpp_compat_func_0022', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const converted = transParseObj({
          enums: [], unions: [], structs: [],
          classes: [{ name: 'C129', alias: '',
            variableList: [{ type: '(p0:object,p1:string)=>object', name: 'v', arraySize: 0, arraySizeList: [] }],
            functionList: []
          }],
          funcs: [], types: []
        });
    ...
    try {
      const finished = runCompatSafe(() => {
        const converted = transParseObj({
          enums: [], unions: [], structs: [],
          classes: [{ name: 'C129', alias: '',
            variableList: [{ type: '(p0:object,p1:strng)=>object', name: 'v', arraySize: 0, arraySizeList: [] }],
            functionList: []
          }],
          funcs: [], types: []
        });
    ...
    try {
      const finished = runCompatSafe(() => {
        const converted = transParseObj({
          enums: [], unions: [], structs: [],
          classes: [{ name: 'C129', alias: '',
            variableList: [{ type: '(p0:object,p1:string)=>objec', name: 'v', arraySize: 0, arraySizeList: [] }],
            functionList: []
          }],
          funcs: [], types: []
        });
        ...
        assert.strictEqual(converted.classes[0].variableList[0].type, "std::function<objec(std::any, std::string)>",
  ...
  test('h2dtscpp_compat_func_0029', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        ...
        assert.strictEqual(converted.classes[0].variableList[0].type, "std::function<object,(std::any, std::string)>",
  ...
  test('h2dtscpp_compat_func_0032', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const converted = transParseObj({
          enums: [], unions: [], structs: [],
          classes: [{ name: 'C130', alias: '',
            variableList: [{ type: '(p0:object,p1:boolean)=>object', name: 'v', arraySize: 0, arraySizeList: [] }],
            functionList: []
          }],
          funcs: [], types: []
        });
    ...
    try {
      const finished = runCompatSafe(() => {
        const converted = transParseObj({
          enums: [], unions: [], structs: [],
          classes: [{ name: 'C130', alias: '',
            variableList: [{ type: '(p0:object,p1:boolea)=>object', name: 'v', arraySize: 0, arraySizeList: [] }],
            functionList: []
          }],
          funcs: [], types: []
        });
    ...
    try {
      const finished = runCompatSafe(() => {
        const converted = transParseObj({
          enums: [], unions: [], structs: [],
          classes: [{ name: 'C130', alias: '',
            variableList: [{ type: '(p0:object,p1:boolean)=>objec', name: 'v', arraySize: 0, arraySizeList: [] }],
            functionList: []
          }],
          funcs: [], types: []
        });
        ...
        assert.strictEqual(converted.classes[0].variableList[0].type, "std::function<objec(std::any, bool)>",
  ...
  test('h2dtscpp_compat_func_0039', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        ...
        assert.strictEqual(converted.classes[0].variableList[0].type, "std::function<object,(std::any, bool)>",
  ...
  test('h2dtscpp_compat_func_0042', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const converted = transParseObj({
          enums: [], unions: [], structs: [],
          classes: [{ name: 'C131', alias: '',
            variableList: [{ type: '(p0:numbr,p1:any)=>object', name: 'v', arraySize: 0, arraySizeList: [] }],
            functionList: []
          }],
          funcs: [], types: []
        });
    ...
    try {
      const finished = runCompatSafe(() => {
        const converted = transParseObj({
          enums: [], unions: [], structs: [],
          classes: [{ name: 'C131', alias: '',
            variableList: [{ type: '(p0:number,p1:any)=>object', name: 'v', arraySize: 0, arraySizeList: [] }],
            functionList: []
          }],
          funcs: [], types: []
        });
    ...
    try {
      const finished = runCompatSafe(() => {
        const converted = transParseObj({
          enums: [], unions: [], structs: [],
          classes: [{ name: 'C131', alias: '',
            variableList: [{ type: '(p0:number,p1:any)=>objec', name: 'v', arraySize: 0, arraySizeList: [] }],
            functionList: []
          }],
          funcs: [], types: []
        });
        ...
        assert.strictEqual(converted.classes[0].variableList[0].type, "std::function<objec(double, std::any)>",
  ...
  test('h2dtscpp_compat_func_0049', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        ...
        assert.strictEqual(converted.classes[0].variableList[0].type, "std::function<object,(double, std::any)>",
  ...
  test('h2dtscpp_compat_func_0052', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const converted = transParseObj({
          enums: [], unions: [], structs: [],
          classes: [{ name: 'C132', alias: '',
            variableList: [{ type: '(p0:numbr,p1:object)=>object', name: 'v', arraySize: 0, arraySizeList: [] }],
            functionList: []
          }],
          funcs: [], types: []
        });
    ...
    try {
      const finished = runCompatSafe(() => {
        const converted = transParseObj({
          enums: [], unions: [], structs: [],
          classes: [{ name: 'C132', alias: '',
            variableList: [{ type: '(p0:number,p1:object)=>object', name: 'v', arraySize: 0, arraySizeList: [] }],
            functionList: []
          }],
          funcs: [], types: []
        });
    ...
    try {
      const finished = runCompatSafe(() => {
        const converted = transParseObj({
          enums: [], unions: [], structs: [],
          classes: [{ name: 'C132', alias: '',
            variableList: [{ type: '(p0:number,p1:object)=>objec', name: 'v', arraySize: 0, arraySizeList: [] }],
            functionList: []
          }],
          funcs: [], types: []
        });
  ...
  test('h2dtscpp_compat_func_0062', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const converted = transParseObj({
          enums: [], unions: [], structs: [],
          classes: [{ name: 'C133', alias: '',
            variableList: [{ type: '(p0:numbr,p1:numbr)=>object', name: 'v', arraySize: 0, arraySizeList: [] }],
            functionList: []
          }],
          funcs: [], types: []
        });
    ...
    try {
      const finished = runCompatSafe(() => {
        const converted = transParseObj({
          enums: [], unions: [], structs: [],
          classes: [{ name: 'C133', alias: '',
            variableList: [{ type: '(p0:number,p1:number)=>object', name: 'v', arraySize: 0, arraySizeList: [] }],
            functionList: []
          }],
          funcs: [], types: []
        });
    ...
    try {
      const finished = runCompatSafe(() => {
        const converted = transParseObj({
          enums: [], unions: [], structs: [],
          classes: [{ name: 'C133', alias: '',
            variableList: [{ type: '(p0:number,p1:number)=>objec', name: 'v', arraySize: 0, arraySizeList: [] }],
            functionList: []
          }],
          funcs: [], types: []
        });
        ...
        assert.strictEqual(converted.classes[0].variableList[0].type, "std::function<objec(double, double)>",
  ...
  test('h2dtscpp_compat_func_0069', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        ...
        assert.strictEqual(converted.classes[0].variableList[0].type, "std::function<object,(double, double)>",
      ...
      const finished = runCompatSafe(() => {
        const converted = transParseObj({
          ...
          classes: [{ name: 'C134', alias: '',
            variableList: [{ type: '(p0:numbr,p1:string)=>object', name: 'v', arraySize: 0, arraySizeList: [] }],
            functionList: []
          }],
          funcs: [], types: []
        });
    ...
    try {
      const finished = runCompatSafe(() => {
        const converted = transParseObj({
          enums: [], unions: [], structs: [],
          classes: [{ name: 'C134', alias: '',
            variableList: [{ type: '(p0:number,p1:strng)=>object', name: 'v', arraySize: 0, arraySizeList: [] }],
            functionList: []
          }],
          funcs: [], types: []
        });
