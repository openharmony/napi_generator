...
suite('Stability_H2DTSCPP_COMPAT_FUNC_Part17', function() {
  this.timeout(600000);
  vscode.window.showInformationMessage('Start Stability_H2DTSCPP_COMPAT_FUNC_Part17.');
  ...
  test('h2dtscpp_compat_func_0003', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const converted = transParseObj({
          enums: [], unions: [], structs: [],
          classes: [{ name: 'C149', alias: '',
            variableList: [{ type: '(p0:any,p1:boolean)=>void', name: 'v', arraySize: 0, arraySizeList: [] }],
            functionList: []
          }],
          funcs: [], types: []
        });
    ...
    try {
      const finished = runCompatSafe(() => {
        const converted = transParseObj({
          enums: [], unions: [], structs: [],
          classes: [{ name: 'C149', alias: '',
            variableList: [{ type: '(p0:any,p1:boolea)=>void', name: 'v', arraySize: 0, arraySizeList: [] }],
            functionList: []
          }],
          funcs: [], types: []
        });
        ...
        assert.strictEqual(converted.classes[0].variableList[0].type, "std::function<void(std::any, boolea)>",
    ...
    try {
      const finished = runCompatSafe(() => {
        const converted = transParseObj({
          enums: [], unions: [], structs: [],
          classes: [{ name: 'C149', alias: '',
            variableList: [{ type: '(p0:any,p1:boolean)=>voi', name: 'v', arraySize: 0, arraySizeList: [] }],
            functionList: []
          }],
          funcs: [], types: []
        });
        ...
        assert.strictEqual(converted.classes[0].variableList[0].type, "std::function<voi(std::any, bool)>",
  ...
  test('h2dtscpp_compat_func_0013', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const converted = transParseObj({
          enums: [], unions: [], structs: [],
          classes: [{ name: 'C150', alias: '',
            variableList: [{ type: '(p0:object,p1:any)=>void', name: 'v', arraySize: 0, arraySizeList: [] }],
            functionList: []
          }],
          funcs: [], types: []
        });
    ...
    try {
      const finished = runCompatSafe(() => {
        const converted = transParseObj({
          enums: [], unions: [], structs: [],
          classes: [{ name: 'C150', alias: '',
            variableList: [{ type: '(p0:object,p1:any)=>voi', name: 'v', arraySize: 0, arraySizeList: [] }],
            functionList: []
          }],
          funcs: [], types: []
        });
  ...
  test('h2dtscpp_compat_func_0023', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const converted = transParseObj({
          enums: [], unions: [], structs: [],
          classes: [{ name: 'C151', alias: '',
            variableList: [{ type: '(p0:object,p1:object)=>void', name: 'v', arraySize: 0, arraySizeList: [] }],
            functionList: []
          }],
          funcs: [], types: []
        });
    ...
    try {
      const finished = runCompatSafe(() => {
        const converted = transParseObj({
          enums: [], unions: [], structs: [],
          classes: [{ name: 'C151', alias: '',
            variableList: [{ type: '(p0:object,p1:object)=>voi', name: 'v', arraySize: 0, arraySizeList: [] }],
            functionList: []
          }],
          funcs: [], types: []
        });
  ...
  test('h2dtscpp_compat_func_0033', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const converted = transParseObj({
          enums: [], unions: [], structs: [],
          classes: [{ name: 'C152', alias: '',
            variableList: [{ type: '(p0:object,p1:numbr)=>void', name: 'v', arraySize: 0, arraySizeList: [] }],
            functionList: []
          }],
          funcs: [], types: []
        });
    ...
    try {
      const finished = runCompatSafe(() => {
        const converted = transParseObj({
          enums: [], unions: [], structs: [],
          classes: [{ name: 'C152', alias: '',
            variableList: [{ type: '(p0:object,p1:number)=>void', name: 'v', arraySize: 0, arraySizeList: [] }],
            functionList: []
          }],
          funcs: [], types: []
        });
    ...
    try {
      const finished = runCompatSafe(() => {
        const converted = transParseObj({
          enums: [], unions: [], structs: [],
          classes: [{ name: 'C152', alias: '',
            variableList: [{ type: '(p0:object,p1:number)=>voi', name: 'v', arraySize: 0, arraySizeList: [] }],
            functionList: []
          }],
          funcs: [], types: []
        });
  ...
  test('h2dtscpp_compat_func_0043', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const converted = transParseObj({
          enums: [], unions: [], structs: [],
          classes: [{ name: 'C153', alias: '',
            variableList: [{ type: '(p0:object,p1:string)=>void', name: 'v', arraySize: 0, arraySizeList: [] }],
            functionList: []
          }],
          funcs: [], types: []
        });
    ...
    try {
      const finished = runCompatSafe(() => {
        const converted = transParseObj({
          enums: [], unions: [], structs: [],
          classes: [{ name: 'C153', alias: '',
            variableList: [{ type: '(p0:object,p1:strng)=>void', name: 'v', arraySize: 0, arraySizeList: [] }],
            functionList: []
          }],
          funcs: [], types: []
        });
    ...
    try {
      const finished = runCompatSafe(() => {
        const converted = transParseObj({
          enums: [], unions: [], structs: [],
          classes: [{ name: 'C153', alias: '',
            variableList: [{ type: '(p0:object,p1:string)=>voi', name: 'v', arraySize: 0, arraySizeList: [] }],
            functionList: []
          }],
          funcs: [], types: []
        });
  ...
  test('h2dtscpp_compat_func_0053', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const converted = transParseObj({
          enums: [], unions: [], structs: [],
          classes: [{ name: 'C154', alias: '',
            variableList: [{ type: '(p0:object,p1:boolean)=>void', name: 'v', arraySize: 0, arraySizeList: [] }],
            functionList: []
          }],
          funcs: [], types: []
        });
    ...
    try {
      const finished = runCompatSafe(() => {
        const converted = transParseObj({
          enums: [], unions: [], structs: [],
          classes: [{ name: 'C154', alias: '',
            variableList: [{ type: '(p0:object,p1:boolea)=>void', name: 'v', arraySize: 0, arraySizeList: [] }],
            functionList: []
          }],
          funcs: [], types: []
        });
    ...
    try {
      const finished = runCompatSafe(() => {
        const converted = transParseObj({
          enums: [], unions: [], structs: [],
          classes: [{ name: 'C154', alias: '',
            variableList: [{ type: '(p0:object,p1:boolean)=>voi', name: 'v', arraySize: 0, arraySizeList: [] }],
            functionList: []
          }],
          funcs: [], types: []
        });
  ...
  test('h2dtscpp_compat_func_0063', function() {
    ...
    try {
      const finished = runCompatSafe(() => {
        const converted = transParseObj({
          enums: [], unions: [], structs: [],
          classes: [{ name: 'C155', alias: '',
            variableList: [{ type: '(p0:numbr,p1:any)=>void', name: 'v', arraySize: 0, arraySizeList: [] }],
            functionList: []
          }],
          funcs: [], types: []
        });
        ...
        assert.strictEqual(converted.classes[0].variableList[0].type, "std::function<void(numbr, std::any)>",
    ...
    try {
      const finished = runCompatSafe(() => {
        const converted = transParseObj({
          enums: [], unions: [], structs: [],
          classes: [{ name: 'C155', alias: '',
            variableList: [{ type: '(p0:number,p1:any)=>void', name: 'v', arraySize: 0, arraySizeList: [] }],
            functionList: []
          }],
          funcs: [], types: []
        });
    ...
    try {
      const finished = runCompatSafe(() => {
        const converted = transParseObj({
          enums: [], unions: [], structs: [],
          classes: [{ name: 'C155', alias: '',
            variableList: [{ type: '(p0:number,p1:any)=>voi', name: 'v', arraySize: 0, arraySizeList: [] }],
            functionList: []
          }],
          funcs: [], types: []
        });
      ...
      const finished = runCompatSafe(() => {
        const converted = transParseObj({
          ...
          classes: [{ name: 'C156', alias: '',
            variableList: [{ type: '(p0:numbr,p1:object)=>void', name: 'v', arraySize: 0, arraySizeList: [] }],
            functionList: []
          }],
          funcs: [], types: []
        });
