...
describe('[]', function () {
    ...
    // 测试：function fun5(v1: number[], v2: Test[]): string[];
    ...
    // 测试：function fun21(v: string, v1: Entry[]): Entry[];
