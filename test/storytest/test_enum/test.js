...
describe('enum', function () {
    // 测试：function fun1(v0: string, v1: GrantStatus): GrantStatus;
    ...
    // 测试：function fun5(V0: string, callback: Callback<LaunchReason>): void;
    ...
    // 测试：function fun6(v0: string, callback: AsyncCallback<GrantStatus>): void;
    ...
    // 测试：function fun6(v0: string): Promise<GrantStatus>;
