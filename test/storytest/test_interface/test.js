...
describe('Interface', function () {
    ...
    // 测试：fun2(numcc: Array<number>, mancc: Human): Human;
    ...
    // 测试：fun3: (v: number, v1: string, v2: boolean) => boolean;
    ...
    // 测试：fun4: (mancc: Map<string, string>,v?: string) => Array<number>;
...
describe('Interface', function () {
    ...
    // 测试：fun5: (data: Array<Human>) => Human;
    ...
    // 测试：fun6: (v: string[], v1: { [key: string]: boolean }) => string[];
    ...
    */
    ...
    /* 测试：fun13(v: TestEnumString): string;
...
describe('Interface', function () {
    // 测试：fun16(v1: number, v2: string, v3: boolean);
