...
describe('string case', function () {
    ...
    // 测试：function fun2(v1: string, v2: string[]): string[];
    it('test fun2', function () {
        let ret = test.fun2('18', ['18', '20']);
        assert.deepStrictEqual(ret, []);
    });

    // 测试：function fun3(v1: Array<string>, v2: string): Array<string>;
    it('test fun3', function () {
        let ret = test.fun3(['18', '20'], '20');
        assert.deepStrictEqual(ret, []);
    });

    // 测试：function fun4(v: { [key: string]: string }): string;
    it('test fun4', function () {
        let ret = test.fun4({ 'isTrue': '18', 'isExit': '20' });
        assert.deepStrictEqual(ret, '');
    });

    // 测试：function fun5(v1: Map<string, string>, v2: string): string;
    ...
    // 测试：function fun6(v1: string, callback: AsyncCallback<string>): void;
    it('test fun6_callback', function () {
        test.fun6('15', asynFun1);
        test.fun6('15').then(def1);
    });
    // 测试：function fun6(v1: string): Promise<string>;
...
describe('string case part2', function () {
    ...
    // 测试：function fun8(v1: string, callback: AsyncCallback<string[]>): void;
    it('test fun8_AsyncCallback', function () {
        test.fun8('funTest', asynFun8);
        test.fun8('funTest').then(def8);
    });
    // 测试：function fun8(v1: string): Promise<string[]>;
...
describe('string case part3', function () {
    ...
    // 测试：function fun9(v1: string, callback: Callback<string>): void;
    ...
    // 测试：function fun11(v: string, v1: string, v2: string): void;
    ...
    // 测试：function fun13(v: number, v1: string, v2: string): void;
    it('test fun13', function () {
        test.fun13(15, 'bb', 'cc');
    });

    // 测试：function fun14(v: string, v1: string, v2: number): void;
